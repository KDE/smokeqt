...
my $solidheaderlist = "@CMAKE_CURRENT_SOURCE_DIR@/solid_header_list";
my $solidheaderlistpath = "$here/$solidheaderlist";
...
$solidheaderlistpath = $solidheaderlist if $solidheaderlist =~ /^\//;
...
open(HEADERS, $solidheaderlistpath) or die "Couldn't open $solidheaderlistpath: $!\n";
map { chomp ; $kdeincludes{$_} = 1 unless /^\s*#/ } <HEADERS>;
close HEADERS;
