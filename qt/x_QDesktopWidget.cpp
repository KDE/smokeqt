...
public:
	...
	int xret = this->QDesktopWidget::screenNumber((QWidget*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
	...
	int xret = this->QDesktopWidget::screenNumber(*(const QPoint *)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_7(xargs *x) {
	// screen(int)
	QWidget* xret = this->QDesktopWidget::screen((int)x[1].x_int);
	x[0].x_voidp = (void*)xret;
    }
    void x_8(xargs *x) {
	// screen()
	...
	// screenGeometry(int)
	const QRect& xret = this->QDesktopWidget::screenGeometry((int)x[1].x_int);
	x[0].x_voidp = (void*)&xret;
    }
...
void xcall_QDesktopWidget(xargs *x, void *s, int xi) {
    x_QDesktopWidget *xself = (x_QDesktopWidget*)s;
    switch(xi) {
	case 0: x_QDesktopWidget::x_0(x);	break;
