...
public:
	...
	x_QCheckListItem* xret = new x_QCheckListItem((QCheckListItem*)x[1].s_voidp,*(const QString *)x[2].s_voidp,(QCheckListItem::Type)x[3].s_enum);
	...
	x_QCheckListItem* xret = new x_QCheckListItem((QListViewItem*)x[1].s_voidp,*(const QString *)x[2].s_voidp,(QCheckListItem::Type)x[3].s_enum);
	x[0].s_class = (void*)xret;
    }
	...
	x_QCheckListItem* xret = new x_QCheckListItem((QListView*)x[1].s_voidp,*(const QString *)x[2].s_voidp,(QCheckListItem::Type)x[3].s_enum);
	x[0].s_class = (void*)xret;
    }
