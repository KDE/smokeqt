...
public:
	...
	x_QRadioButton* xret = new x_QRadioButton((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	...
	x_QRadioButton* xret = new x_QRadioButton(*(const QString *)x[1].s_class,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QRadioButton* xret = new x_QRadioButton(*(const QString *)x[1].s_class,(QWidget*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
