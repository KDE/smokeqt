...
public:
	...
	x_QRadioButton* xret = new x_QRadioButton((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QRadioButton* xret = new x_QRadioButton((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QRadioButton* xret = new x_QRadioButton(*(const QString *)x[1].s_voidp,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QRadioButton* xret = new x_QRadioButton(*(const QString *)x[1].s_voidp,(QWidget*)x[2].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	bool xret = this->QRadioButton::hitButton(*(const QPoint *)x[1].s_voidp);
	x[0].s_bool = xret;
    }
    void x_8(Smoke::Stack x) {
	// drawButton(QPainter*)
	this->QRadioButton::drawButton((QPainter*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_9(Smoke::Stack x) {
	// drawButtonLabel(QPainter*)
	this->QRadioButton::drawButtonLabel((QPainter*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QRadioButton::resizeEvent((QResizeEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(6368, (void*)this, x)) return;
	this->QRadioButton::drawButton(x1);
    }
    virtual void drawButtonLabel(QPainter* x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(6369, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->callMethod(6367, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(6371, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(6366, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6365, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6370, (void*)this, x)) return;
	this->QRadioButton::updateMask();
    }
