...
public:
	...
	x_QRadioButton* xret = new x_QRadioButton((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QRadioButton* xret = new x_QRadioButton((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QRadioButton* xret = new x_QRadioButton(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QRadioButton* xret = new x_QRadioButton(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_6(xargs *x) {
	// setChecked(bool)
	this->QRadioButton::setChecked((bool)x[1].x_bool);
    }
    void x_7(xargs *x) const {
	// hitButton(const QPoint&)
	bool xret = this->QRadioButton::hitButton(*(const QPoint *)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_8(xargs *x) {
	// drawButton(QPainter*)
	this->QRadioButton::drawButton((QPainter*)x[1].x_voidp);
    }
    void x_9(xargs *x) {
	// drawButtonLabel(QPainter*)
	this->QRadioButton::drawButtonLabel((QPainter*)x[1].x_voidp);
    }
    void x_10(xargs *x) {
	// updateMask()
	...
	this->QRadioButton::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 6332, x)) return;
	this->QRadioButton::drawButton(x1);
    }
    virtual void drawButtonLabel(QPainter* x1) {
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 6333, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 6331, x)) return (bool)x[0].x_bool;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 6335, x)) return;
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 6330, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 6329, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	xargs x[1];
	if(call_method((void*)this, 6334, x)) return;
	this->QRadioButton::updateMask();
    }
...
void xcall_QRadioButton(xargs *x, void *s, int xi) {
    x_QRadioButton *xself = (x_QRadioButton*)s;
    switch(xi) {
	case 0: x_QRadioButton::x_0(x);	break;
	case 1: x_QRadioButton::x_1(x);	break;
	case 2: x_QRadioButton::x_2(x);	break;
	case 3: x_QRadioButton::x_3(x);	break;
