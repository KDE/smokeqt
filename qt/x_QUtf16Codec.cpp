...
public:
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(10144, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11053, (void*)this, x)) return (QTextEncoder*)x[0].s_class;
    ...
    ~x_QUtf16Codec() { qt_Smoke->binding->deleted(345, (void*)this); }
};
