...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11025, (void*)this, x)) return (QTextDecoder*)x[0].s_class;
	return this->QUtf16Codec::makeDecoder();
    }
    virtual QTextEncoder* makeEncoder() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11026, (void*)this, x)) return (QTextEncoder*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11024, (void*)this, x)) return (const char*)x[0].s_class;
