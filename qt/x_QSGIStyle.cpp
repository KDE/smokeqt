...
public:
	...
	this->QSGIStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].s_enum,(QPainter*)x[2].s_voidp,*(const QRect *)x[3].s_voidp,*(const QColorGroup *)x[4].s_voidp,(QStyle::SFlags)x[5].s_int,*(const QStyleOption *)x[6].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_7(Smoke::Stack x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QSGIStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].s_enum,(QPainter*)x[2].s_voidp,*(const QRect *)x[3].s_voidp,*(const QColorGroup *)x[4].s_voidp,(QStyle::SFlags)x[5].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_8(Smoke::Stack x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&)
	this->QSGIStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].s_enum,(QPainter*)x[2].s_voidp,*(const QRect *)x[3].s_voidp,*(const QColorGroup *)x[4].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QSGIStyle::drawControl((QStyle::ControlElement)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,*(const QStyleOption *)x[7].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_10(Smoke::Stack x) const {
	// drawControl(QStyle::ControlElement, QPainter*, const QWidget*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QSGIStyle::drawControl((QStyle::ControlElement)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_11(Smoke::Stack x) const {
	// drawControl(QStyle::ControlElement, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QSGIStyle::drawControl((QStyle::ControlElement)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QSGIStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,(QStyle::SCFlags)x[7].s_int,(QStyle::SCFlags)x[8].s_int,*(const QStyleOption *)x[9].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QSGIStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,(QStyle::SCFlags)x[7].s_int,(QStyle::SCFlags)x[8].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QSGIStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,(QStyle::SCFlags)x[7].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_15(Smoke::Stack x) const {
	// drawComplexControl(QStyle::ComplexControl, QPainter*, const QWidget*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QSGIStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_16(Smoke::Stack x) const {
	// drawComplexControl(QStyle::ComplexControl, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QSGIStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_17(Smoke::Stack x) const {
	// pixelMetric(QStyle::PixelMetric, const QWidget*)
	int xret = this->QSGIStyle::pixelMetric((QStyle::PixelMetric)x[1].s_enum,(const QWidget*)x[2].s_voidp);
	x[0].s_int = xret;
    }
	...
	QSize xret = this->QSGIStyle::sizeFromContents((QStyle::ContentsType)x[1].s_enum,(const QWidget*)x[2].s_voidp,*(const QSize *)x[3].s_voidp,*(const QStyleOption *)x[4].s_voidp);
	x[0].s_class = (void*)new QSize(xret);
    }
    void x_20(Smoke::Stack x) const {
	// sizeFromContents(QStyle::ContentsType, const QWidget*, const QSize&)
	QSize xret = this->QSGIStyle::sizeFromContents((QStyle::ContentsType)x[1].s_enum,(const QWidget*)x[2].s_voidp,*(const QSize *)x[3].s_voidp);
	x[0].s_class = (void*)new QSize(xret);
    }
    void x_21(Smoke::Stack x) const {
	// subRect(QStyle::SubRect, const QWidget*)
	QRect xret = this->QSGIStyle::subRect((QStyle::SubRect)x[1].s_enum,(const QWidget*)x[2].s_voidp);
	x[0].s_class = (void*)new QRect(xret);
    }
    void x_22(Smoke::Stack x) const {
	// querySubControlMetrics(QStyle::ComplexControl, const QWidget*, QStyle::SubControl, const QStyleOption&)
	QRect xret = this->QSGIStyle::querySubControlMetrics((QStyle::ComplexControl)x[1].s_enum,(const QWidget*)x[2].s_voidp,(QStyle::SubControl)x[3].s_enum,*(const QStyleOption *)x[4].s_voidp);
	x[0].s_class = (void*)new QRect(xret);
    }
    void x_23(Smoke::Stack x) const {
	// querySubControlMetrics(QStyle::ComplexControl, const QWidget*, QStyle::SubControl)
	QRect xret = this->QSGIStyle::querySubControlMetrics((QStyle::ComplexControl)x[1].s_enum,(const QWidget*)x[2].s_voidp,(QStyle::SubControl)x[3].s_enum);
	x[0].s_class = (void*)new QRect(xret);
    }
