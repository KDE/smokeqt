...
public:
	...
	x_QSocketDevice* xret = new x_QSocketDevice(*(QSocketDevice::Type *)x[1].s_class);
	...
	x_QSocketDevice* xret = new x_QSocketDevice((int)x[1].s_int,*(QSocketDevice::Type *)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x[0].s_class = (void*)new QSocketDevice::Type(xret);
    }
	...
	// at(QIODevice::Offset)
	bool xret = this->QSocketDevice::at(*(QIODevice::Offset *)x[1].s_class);
	x[0].s_bool = (bool)xret;
    }
	...
	bool xret = this->QSocketDevice::connect(*(const QHostAddress *)x[1].s_class,*(Q_UINT16 *)x[2].s_class);
	x[0].s_bool = (bool)xret;
    }
    void x_35(Smoke::Stack x) {
	// bind(const QHostAddress&, Q_UINT16)
	bool xret = this->QSocketDevice::bind(*(const QHostAddress *)x[1].s_class,*(Q_UINT16 *)x[2].s_class);
	x[0].s_bool = (bool)xret;
    }
	...
	Q_LONG xret = this->QSocketDevice::waitForMore((int)x[1].s_int,(bool*)x[2].s_class);
	x[0].s_class = (void*)new Q_LONG(xret);
    }
	...
	Q_LONG xret = this->QSocketDevice::readBlock((char*)x[1].s_class,*(Q_ULONG *)x[2].s_class);
	x[0].s_class = (void*)new Q_LONG(xret);
    }
    void x_42(Smoke::Stack x) {
	// writeBlock(const char*, Q_ULONG)
	Q_LONG xret = this->QSocketDevice::writeBlock((const char*)x[1].s_class,*(Q_ULONG *)x[2].s_class);
	x[0].s_class = (void*)new Q_LONG(xret);
    }
    void x_43(Smoke::Stack x) {
	// writeBlock(const char*, Q_ULONG, const QHostAddress&, Q_UINT16)
	Q_LONG xret = this->QSocketDevice::writeBlock((const char*)x[1].s_class,*(Q_ULONG *)x[2].s_class,*(const QHostAddress *)x[3].s_class,*(Q_UINT16 *)x[4].s_class);
	x[0].s_class = (void*)new Q_LONG(xret);
    }
	...
	x[0].s_class = (void*)new QSocketDevice::Error(xret);
    }
    ...
    virtual int accept() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7094, (void*)this, x)) return (int)x[0].s_int;
	return this->QSocketDevice::accept();
    }
    virtual QIODevice::Offset at() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7080, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7081, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSocketDevice::at(x1);
    }
    virtual bool atEnd() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7082, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7092, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSocketDevice::bind(x1, x2);
    }
    virtual void close() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7077, (void*)this, x)) return;
	this->QSocketDevice::close();
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7091, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSocketDevice::connect(x1, x2);
    }
    virtual void flush() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7078, (void*)this, x)) return;
	this->QSocketDevice::flush();
    }
    virtual int getch() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7101, (void*)this, x)) return (int)x[0].s_int;
	return this->QSocketDevice::getch();
    }
    virtual bool listen(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(7093, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSocketDevice::listen(x1);
    }
    virtual bool open(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(7076, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSocketDevice::open(x1);
    }
    virtual int putch(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(7102, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7098, (void*)this, x)) {
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(3399, (void*)this, x)) {
	    Q_LONG *xptr = (Q_LONG *)x[0].s_class;
	    Q_LONG xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[1].s_int = (int)x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7075, (void*)this, x)) return;
	this->QSocketDevice::setSocket(x1, x2);
    }
    virtual QIODevice::Offset size() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7079, (void*)this, x)) {
	    QIODevice::Offset *xptr = (QIODevice::Offset *)x[0].s_class;
	    QIODevice::Offset xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(7103, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7099, (void*)this, x)) {
	    Q_LONG *xptr = (Q_LONG *)x[0].s_class;
	    Q_LONG xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[3].s_class = (void*)&x3;
	x[4].s_class = (void*)&x4;
	if(qt_Smoke->callMethod(7100, (void*)this, x)) {
	    Q_LONG *xptr = (Q_LONG *)x[0].s_class;
	    Q_LONG xret(*xptr);
	    delete xptr;
	    return xret;
