...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(4692, (void*)this, x)) return;
	this->QLocalFs::operationRemove(x1);
    }
    virtual void operationRename(QNetworkOperation* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(4693, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4689, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QLocalFs(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 8: delete (QLocalFs*)xself;	break;
    }
}
