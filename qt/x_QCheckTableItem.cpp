...
public:
	...
	// QCheckTableItem(QCheckTableItem&)
	x_QCheckTableItem* xret = new x_QCheckTableItem(*(QCheckTableItem *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QCheckTableItem(QCheckTableItem& x1) : QCheckTableItem(x1) {
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1085, (void*)this, x)) return (QWidget*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1090, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QCheckTableItem(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 7: x_QCheckTableItem::x_7(args);	break;
	case 8: delete (QCheckTableItem*)xself;	break;
    }
}
