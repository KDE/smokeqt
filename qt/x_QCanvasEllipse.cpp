...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(665, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(666, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(670, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(667, (void*)this, x)) return (int)x[0].s_int;
    ...
    ~x_QCanvasEllipse() { qt_Smoke->binding->deleted(21, (void*)this); }
};
