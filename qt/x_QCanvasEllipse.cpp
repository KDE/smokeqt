...
public:
	...
	x_QCanvasEllipse* xret = new x_QCanvasEllipse(*(QCanvasEllipse *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QCanvasEllipse(QCanvasEllipse& x1) : QCanvasEllipse(x1) {
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(647, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(648, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(651, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(649, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QCanvasEllipse(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 12: x_QCanvasEllipse::x_12(args);	break;
	case 13: xself->x_13(args);	break;
	case 14: delete (QCanvasEllipse*)xself;	break;
    }
}
