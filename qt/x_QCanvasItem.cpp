...
public:
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(699, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	qt_Smoke->binding->callMethod(680, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->binding->callMethod(683, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(698, (void*)this, x)) return (int)x[0].s_int;
