...
public:
	...
	x_QEditorFactory* xret = new x_QEditorFactory((QObject*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QEditorFactory* xret = new x_QEditorFactory((QObject*)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	QWidget* xret = this->QEditorFactory::createEditor((QWidget*)x[1].s_voidp,*(const QVariant *)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	QEditorFactory::installDefaultFactory((QEditorFactory*)x[1].s_voidp);
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(call_method((void*)this, 2351, x)) 	return (QWidget*)x[0].s_voidp;
