...
public:
	...
	x[2].s_class = (void*)x2;
	x[3].s_voidp = (void*)x3;
	if(qt_Smoke->binding->callMethod(6912, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(6913, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_uint = x2;
	if(qt_Smoke->binding->callMethod(6900, (void*)this, x)) return;
