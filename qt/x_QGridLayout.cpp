...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 3137, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3135, x)) {
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3133, x)) return (bool)x[0].s_bool;
	return this->QGridLayout::hasHeightForWidth();
    }
    virtual int heightForWidth(int x1) const {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 3134, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3136, x)) return;
	this->QGridLayout::invalidate();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3153, x)) {
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3124, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3127, x)) return;
	this->QGridLayout::setColStretch(x1, x2);
    }
    virtual void setGeometry(const QRect& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 3154, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3126, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3123, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
