...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3130, x)) return (bool)x[0].s_bool;
	return this->QGridLayout::hasHeightForWidth();
    }
    virtual int heightForWidth(int x1) const {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 3131, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3133, x)) return;
	this->QGridLayout::invalidate();
    }
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3124, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3123, x)) return;
