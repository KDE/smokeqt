...
public:
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3311, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 3324, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3300, x)) return;
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_int = (int)x3;
	if(call_method((void*)this, 3269, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 3316, x)) return;
	this->QHeader::setOffset(x1);
    }
    virtual void setOrientation(Qt::Orientation x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 3275, x)) return;
	...
	x[1].s_bool = (bool)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 3284, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(call_method((void*)this, 3315, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3305, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
