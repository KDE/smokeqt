...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5599, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(5663, (void*)this, x)) return (QDockArea*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5693, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(5640, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5598, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5634, (void*)this, x)) {
	...
	x[1].s_class = (void*)x1;
	x[2].s_enum = x2;
	if(qt_Smoke->binding->callMethod(5627, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(5600, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(5602, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(5601, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(5603, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5613, (void*)this, x)) return;
	...
	x[2].s_enum = x2;
	x[3].s_bool = x3;
	if(qt_Smoke->binding->callMethod(5618, (void*)this, x)) return;
	...
	x[1].s_enum = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(5615, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5695, (void*)this, x)) return;
	this->QMainWindow::setUpLayout();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5633, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 398: //QMainWindow::DockWindows
	    switch(xop) {
	      case Smoke::EnumNew:
