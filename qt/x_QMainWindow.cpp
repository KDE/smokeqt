...
public:
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_bool = (bool)x3;
	if(call_method((void*)this, 4723, x)) return;
	...
	x[3].s_voidp = (void*)&x3;
	x[4].s_bool = (bool)x4;
	if(call_method((void*)this, 4726, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4789, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4765, x)) 	return (QDockArea*)x[0].s_voidp;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4790, x)) return (bool)x[0].s_bool;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)x2;
	if(call_method((void*)this, 4742, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4770, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4736, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4715, x)) return;
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_bool = (bool)x3;
	if(call_method((void*)this, 4720, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4792, x)) return;
	this->QMainWindow::setUpLayout();
    }
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4734, x)) return;
	this->QMainWindow::show();
    }
    virtual bool showDockMenu(const QPoint& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4793, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4735, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
