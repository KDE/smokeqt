...
public:
	...
	x_QTextView* xret = new x_QTextView(*(const QString *)x[1].x_voidp,*(const QString *)x[2].x_voidp,(QWidget*)x[3].x_voidp,(const char*)x[4].x_voidp);
	...
	x_QTextView* xret = new x_QTextView(*(const QString *)x[1].x_voidp,*(const QString *)x[2].x_voidp,(QWidget*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QTextView* xret = new x_QTextView(*(const QString *)x[1].x_voidp,*(const QString *)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QTextView* xret = new x_QTextView(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QTextView* xret = new x_QTextView((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QTextView(QWidget*)
	x_QTextView* xret = new x_QTextView((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QTextView(xargs *x, void *s, int xi) {
    x_QTextView *xself = (x_QTextView*)s;
    switch(xi) {
	case 0: x_QTextView::x_0(x);	break;
	case 1: x_QTextView::x_1(x);	break;
	case 2: x_QTextView::x_2(x);	break;
	case 3: x_QTextView::x_3(x);	break;
	case 4: x_QTextView::x_4(x);	break;
	case 5: x_QTextView::x_5(x);	break;
	case 6: x_QTextView::x_6(x);	break;
