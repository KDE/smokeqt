...
public:
	...
	x_QTextView* xret = new x_QTextView(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp);
	...
	x_QTextView* xret = new x_QTextView(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,(QWidget*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QTextView* xret = new x_QTextView((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	// QTextView(QWidget*)
	x_QTextView* xret = new x_QTextView((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
