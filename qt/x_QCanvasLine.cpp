...
public:
	...
	x_QCanvasLine* xret = new x_QCanvasLine(*(QCanvasLine *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QCanvasLine(QCanvasLine& x1) : QCanvasLine(x1) {
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(714, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(710, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QCanvasLine(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 6: x_QCanvasLine::x_6(args);	break;
	case 7: xself->x_7(args);	break;
	case 8: xself->x_8(args);	break;
	case 9: delete (QCanvasLine*)xself;	break;
    }
}
