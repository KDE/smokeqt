...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8967, (void*)this, x)) return;
	this->QSqlForm::readFields();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(8964, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(8966, (void*)this, x)) return;
	this->QSqlForm::writeField(x1);
    }
    virtual void writeFields() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8968, (void*)this, x)) return;
	this->QSqlForm::writeFields();
    }
