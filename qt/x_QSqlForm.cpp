...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8941, (void*)this, x)) return (const char*)x[0].s_class;
	return this->QSqlForm::className();
    }
    virtual void clear() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8963, (void*)this, x)) return;
	this->QSqlForm::clear();
    }
	...
	x[1].s_class = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(8951, (void*)this, x)) return;
	this->QSqlForm::insert(x1, x2);
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8940, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(8942, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(8944, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(8945, (void*)this, x)) return (bool)x[0].s_bool;
