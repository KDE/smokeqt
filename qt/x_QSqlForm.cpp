...
public:
    ...
    virtual void clear() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7527, (void*)this, x)) return;
	this->QSqlForm::clear();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7523, (void*)this, x)) return;
	this->QSqlForm::readField(x1);
    }
    virtual void readFields() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7525, (void*)this, x)) return;
	this->QSqlForm::readFields();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7516, (void*)this, x)) return;
	this->QSqlForm::remove(x1);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7522, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7524, (void*)this, x)) return;
