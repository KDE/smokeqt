...
public:
	...
	x_QSplitter* xret = new x_QSplitter((Qt::Orientation)x[1].s_enum,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QSplitter* xret = new x_QSplitter((Qt::Orientation)x[1].s_enum,(QWidget*)x[2].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	this->QSplitter::setResizeMode((QWidget*)x[1].s_voidp,(QSplitter::ResizeMode)x[2].s_enum);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QSplitter::drawSplitter((QPainter*)x[1].s_voidp,(QCOORD)x[2].s_int,(QCOORD)x[3].s_int,(QCOORD)x[4].s_int,(QCOORD)x[5].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
