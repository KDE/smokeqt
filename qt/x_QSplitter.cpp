...
public:
	...
	x[0].x_long = (long)QSplitter::Stretch;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QSplitter::KeepSize;
    }
    static void x_2(xargs *x) {
	x[0].x_long = (long)QSplitter::FollowSizeHint;
    }
    static void x_3(xargs *x) {
	// QSplitter(QWidget*, const char*)
	x_QSplitter* xret = new x_QSplitter((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QSplitter(QWidget*)
	x_QSplitter* xret = new x_QSplitter((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSplitter* xret = new x_QSplitter((Qt::Orientation)x[1].x_long,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSplitter* xret = new x_QSplitter((Qt::Orientation)x[1].x_long,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSplitter* xret = new x_QSplitter((Qt::Orientation)x[1].x_long);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QSplitter::setOrientation((Qt::Orientation)x[1].x_long);
    }
	...
	this->QSplitter::setResizeMode((QWidget*)x[1].x_voidp,(QSplitter::ResizeMode)x[2].x_long);
    }
    void x_12(xargs *x) {
	// setOpaqueResize(bool)
	this->QSplitter::setOpaqueResize((bool)x[1].x_bool);
    }
    void x_13(xargs *x) {
	// setOpaqueResize()
    ...
    void x_15(xargs *x) {
	// moveToFirst(QWidget*)
	this->QSplitter::moveToFirst((QWidget*)x[1].x_voidp);
    }
    void x_16(xargs *x) {
	// moveToLast(QWidget*)
	this->QSplitter::moveToLast((QWidget*)x[1].x_voidp);
    }
    void x_17(xargs *x) {
	// refresh()
	...
	this->QSplitter::setSizes(*(QValueList<int> *)x[1].x_voidp);
    }
    void x_22(xargs *x) {
	// childEvent(QChildEvent*)
	this->QSplitter::childEvent((QChildEvent*)x[1].x_voidp);
    }
    void x_23(xargs *x) {
	// event(QEvent*)
	bool xret = this->QSplitter::event((QEvent*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_24(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QSplitter::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_25(xargs *x) const {
	// idAfter(QWidget*)
	int xret = this->QSplitter::idAfter((QWidget*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_26(xargs *x) {
	// moveSplitter(QCOORD, int)
	this->QSplitter::moveSplitter(*(QCOORD *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_27(xargs *x) {
	// drawSplitter(QPainter*, QCOORD, QCOORD, QCOORD, QCOORD)
	this->QSplitter::drawSplitter((QPainter*)x[1].x_voidp,*(QCOORD *)x[2].x_voidp,*(QCOORD *)x[3].x_voidp,*(QCOORD *)x[4].x_voidp,*(QCOORD *)x[5].x_voidp);
    }
    void x_28(xargs *x) {
	// styleChange(QStyle&)
	this->QSplitter::styleChange(*(QStyle *)x[1].x_voidp);
    }
    void x_29(xargs *x) {
	// adjustPos(int, int)
	int xret = this->QSplitter::adjustPos((int)x[1].x_int,(int)x[2].x_int);
	x[0].x_int = (int)xret;
    }
    void x_30(xargs *x) {
	// setRubberband(int)
	this->QSplitter::setRubberband((int)x[1].x_int);
    }
    void x_31(xargs *x) {
	// getRange(int, int*, int*)
	this->QSplitter::getRange((int)x[1].x_int,(int*)x[2].x_voidp,(int*)x[3].x_voidp);
    }
	...
	x[4].x_voidp = (void*)&x4;
	x[5].x_voidp = (void*)&x5;
	if(call_method((void*)this, 7216, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 7212, x)) return (bool)x[0].x_bool;
	...
	xargs x[1];
	if(call_method((void*)this, 7208, x)) {
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_long = (long)x2;
	if(call_method((void*)this, 7200, x)) return;
	...
	xargs x[2];
	x[1].x_int = (int)x1;
	if(call_method((void*)this, 7219, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 7207, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 7217, x)) return;
...
void xcall_QSplitter(xargs *x, void *s, int xi) {
    x_QSplitter *xself = (x_QSplitter*)s;
    switch(xi) {
	case 0: x_QSplitter::x_0(x);	break;
	case 1: x_QSplitter::x_1(x);	break;
	case 2: x_QSplitter::x_2(x);	break;
	case 3: x_QSplitter::x_3(x);	break;
	case 4: x_QSplitter::x_4(x);	break;
	case 5: x_QSplitter::x_5(x);	break;
	case 6: x_QSplitter::x_6(x);	break;
	case 7: x_QSplitter::x_7(x);	break;
	case 8: x_QSplitter::x_8(x);	break;
