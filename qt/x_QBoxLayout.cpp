...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(341, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(340, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(342, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(344, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(343, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(345, (void*)this, x)) return (bool)x[0].s_bool;
...
void xcall_QBoxLayout(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 55: x_QBoxLayout::x_55(args);	break;
	...
	case 61: delete (QBoxLayout*)xself;	break;
    }
}
