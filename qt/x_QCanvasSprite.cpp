...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(675, (void*)this, x)) return;
	this->QCanvasSprite::advance(x1);
    }
    virtual QRect boundingRect() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(661, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(660, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QCanvasSprite::collidesWith(x1);
    }
    virtual void draw(QPainter& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(676, (void*)this, x)) return;
	...
	x[3].s_int = (int)x3;
	if(qt_Smoke->callMethod(651, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(659, (void*)this, x)) return (int)x[0].s_int;
	...
	x[2].s_int = (int)x2;
	x[3].s_int = (int)x3;
	if(qt_Smoke->callMethod(653, (void*)this, x)) return;
