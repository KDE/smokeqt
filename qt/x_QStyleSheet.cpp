...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8023, (void*)this, x)) return;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(8022, (void*)this, x)) return;
	...
	x[5].s_bool = x5;
	x[6].s_voidp = (void*)x6;
	if(qt_Smoke->binding->callMethod(8021, (void*)this, x)) return (QTextCustomItem*)x[0].s_class;
