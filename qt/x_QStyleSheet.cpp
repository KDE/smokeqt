...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9516, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9515, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(9517, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(9530, (void*)this, x)) return;
	...
	x[5].s_bool = x5;
	x[6].s_voidp = (void*)x6;
	if(qt_Smoke->binding->callMethod(9529, (void*)this, x)) return (QTextCustomItem*)x[0].s_class;
    ...
    ~x_QStyleSheet() { qt_Smoke->binding->deleted(304, (void*)this); }
};
