...
public:
	...
	QString xret = QStyleSheet::convertFromPlainText(*(const QString *)x[1].s_voidp,*(QStyleSheetItem::WhiteSpaceMode *)x[2].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 7952, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 7951, x)) return;
	...
	x[5].s_bool = (bool)x5;
	x[6].s_voidp = (void*)x6;
	if(call_method((void*)this, 7950, x)) 	return (QTextCustomItem*)x[0].s_voidp;
