...
public:
	...
	QDomDocument xret = this->QDomImplementation::createDocument(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,*(const QDomDocumentType *)x[3].s_class);
    ...
    ~x_QDomImplementation() { qt_Smoke->binding->deleted(86, (void*)this); }
};
