...
public:
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4112, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4114, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4115, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4111, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4110, (void*)this, x, true /*pure virtual*/);
	QSize *xptr = (QSize *)x[0].s_class;
	QSize xret(*xptr);
	delete xptr;
	return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->binding->callMethod(4113, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual QSize sizeHint() const {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4109, (void*)this, x, true /*pure virtual*/);
	QSize *xptr = (QSize *)x[0].s_class;
	QSize xret(*xptr);
	delete xptr;
	return xret;
