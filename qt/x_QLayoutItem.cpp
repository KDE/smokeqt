...
public:
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(5242, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(5243, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->binding->callMethod(5241, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
