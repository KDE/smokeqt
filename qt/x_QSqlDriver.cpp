...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8785, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8773, (void*)this, x)) return (const char*)x[0].s_class;
	return this->QSqlDriver::className();
    }
    virtual void close() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(8804, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual bool commitTransaction() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8786, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(8805, (void*)this, x, true /*pure virtual*/);
	...
	x[1].s_class = (void*)x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8795, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	qt_Smoke->binding->callMethod(8798, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8772, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	return this->QSqlDriver::metaObject();
    }
    virtual QString nullText() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8794, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[4].s_voidp = (void*)&x4;
	x[5].s_int = x5;
	qt_Smoke->binding->callMethod(8799, (void*)this, x, true /*pure virtual*/);
	return (bool)x[0].s_bool;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8789, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(8774, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(8777, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSqlDriver::qt_property(x1, x2, x3);
    }
    virtual QSqlRecord record(const QSqlQuery& x1) const {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8791, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8790, (void*)this, x)) {
	    QSqlRecord *xptr = (QSqlRecord *)x[0].s_class;
	    QSqlRecord xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8793, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8792, (void*)this, x)) {
	    QSqlRecordInfo *xptr = (QSqlRecordInfo *)x[0].s_class;
	    QSqlRecordInfo xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8787, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSqlDriver::rollbackTransaction();
    }
    virtual void setLastError(const QSqlError& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8813, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(8811, (void*)this, x)) return;
	this->QSqlDriver::setOpen(x1);
    }
    virtual void setOpenError(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(8812, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8788, (void*)this, x)) {
	...
	switch(xtype) {
	  case 611: //QSqlDriver::DriverFeature
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QSqlDriver() { qt_Smoke->binding->deleted(276, (void*)this); }
};
