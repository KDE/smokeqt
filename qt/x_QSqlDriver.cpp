...
public:
    ...
    virtual void close() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(7409, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(7410, (void*)this, x, true /*pure virtual*/);
	...
	x[1].s_class = (void*)x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(7400, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	qt_Smoke->binding->callMethod(7403, (void*)this, x, true /*pure virtual*/);
	...
	x[4].s_voidp = (void*)&x4;
	x[5].s_int = x5;
	qt_Smoke->binding->callMethod(7404, (void*)this, x, true /*pure virtual*/);
	return (bool)x[0].s_bool;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7394, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7395, (void*)this, x)) {
	    QSqlRecord *xptr = (QSqlRecord *)x[0].s_class;
	    QSqlRecord xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7392, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSqlDriver::rollbackTransaction();
    }
    virtual void setLastError(const QSqlError& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7413, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(7411, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7393, (void*)this, x)) {
