...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7390, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void close() {
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(7409, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual bool commitTransaction() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7391, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(7410, (void*)this, x, true /*pure virtual*/);
	...
	x[1].s_class = (void*)x1;
	x[2].s_bool = (bool)x2;
	if(qt_Smoke->callMethod(7400, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->callMethod(7403, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7399, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[4].s_class = (void*)&x4;
	x[5].s_int = (int)x5;
	qt_Smoke->callMethod(7404, (void*)this, x, true /*pure virtual*/);
	return (bool)x[0].s_bool;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7394, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7396, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7395, (void*)this, x)) {
	    QSqlRecord *xptr = (QSqlRecord *)x[0].s_class;
	    QSqlRecord xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7398, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7397, (void*)this, x)) {
	    QSqlRecordInfo *xptr = (QSqlRecordInfo *)x[0].s_class;
	    QSqlRecordInfo xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7392, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QSqlDriver::rollbackTransaction();
    }
    virtual void setLastError(const QSqlError& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7413, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(7411, (void*)this, x)) return;
	this->QSqlDriver::setOpen(x1);
    }
    virtual void setOpenError(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(7412, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7393, (void*)this, x)) {
