...
public:
	...
	x_QTextBrowser* xret = new x_QTextBrowser((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QTextBrowser* xret = new x_QTextBrowser((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QTextBrowser::setSource(*(const QString *)x[1].x_voidp);
    }
    void x_5(xargs *x) {
	// backward()
	...
	this->QTextBrowser::setText(*(const QString *)x[1].x_voidp);
    }
    void x_10(xargs *x) {
	// setText(const QString&, const QString&)
	this->QTextBrowser::setText(*(const QString *)x[1].x_voidp,*(const QString *)x[2].x_voidp);
    }
    void x_11(xargs *x) {
	// backwardAvailable(bool)
	this->QTextBrowser::backwardAvailable((bool)x[1].x_bool);
    }
    void x_12(xargs *x) {
	// forwardAvailable(bool)
	this->QTextBrowser::forwardAvailable((bool)x[1].x_bool);
    }
    void x_13(xargs *x) {
	// highlighted(const QString&)
	this->QTextBrowser::highlighted(*(const QString *)x[1].x_voidp);
    }
    void x_14(xargs *x) {
	// linkClicked(const QString&)
	this->QTextBrowser::linkClicked(*(const QString *)x[1].x_voidp);
    }
    void x_15(xargs *x) {
	// keyPressEvent(QKeyEvent*)
	this->QTextBrowser::keyPressEvent((QKeyEvent*)x[1].x_voidp);
    }
    ...
    virtual void home() {
	xargs x[1];
	if(call_method((void*)this, 8445, x)) return;
	this->QTextBrowser::home();
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 8453, x)) return;
	...
	x[1].x_voidp = (void*)&x1;
	x[2].x_voidp = (void*)&x2;
	if(call_method((void*)this, 8448, x)) return;
...
void xcall_QTextBrowser(xargs *x, void *s, int xi) {
    x_QTextBrowser *xself = (x_QTextBrowser*)s;
    switch(xi) {
	case 0: x_QTextBrowser::x_0(x);	break;
	case 1: x_QTextBrowser::x_1(x);	break;
	case 2: x_QTextBrowser::x_2(x);	break;
