...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8524, (void*)this, x)) return;
	this->QTextBrowser::backward();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8525, (void*)this, x)) return;
	this->QTextBrowser::forward();
    }
    ...
    virtual void home() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8526, (void*)this, x)) return;
	this->QTextBrowser::home();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(8534, (void*)this, x)) return;
    ...
    virtual void reload() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8527, (void*)this, x)) return;
	this->QTextBrowser::reload();
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(8529, (void*)this, x)) return;
