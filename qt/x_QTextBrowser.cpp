...
public:
	...
	this->QTextBrowser::sourceChanged(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QTextBrowser::anchorClicked(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10532, (void*)this, x)) return;
	this->QTextBrowser::backward();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10520, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10533, (void*)this, x)) return;
	this->QTextBrowser::forward();
    }
    ...
    virtual void home() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10534, (void*)this, x)) return;
	this->QTextBrowser::home();
    }
	...
	x[2].s_int = x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(10817, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10549, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10519, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10521, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10523, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10522, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void reload() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10535, (void*)this, x)) return;
	this->QTextBrowser::reload();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(10531, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(10537, (void*)this, x)) return;
    ...
    ~x_QTextBrowser() { qt_Smoke->binding->deleted(323, (void*)this); }
};
void xcall_QTextBrowser(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 27: x_QTextBrowser::x_27(args);	break;
	case 28: x_QTextBrowser::x_28(args);	break;
	case 29: xself->x_29(args);	break;
	case 30: delete (QTextBrowser*)xself;	break;
    }
}
