...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8441, x)) return;
	this->QTextBrowser::backward();
    }
    ...
    virtual void home() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8443, x)) return;
	this->QTextBrowser::home();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 8451, x)) return;
    ...
    virtual void reload() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8444, x)) return;
	this->QTextBrowser::reload();
    }
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(call_method((void*)this, 8446, x)) return;
