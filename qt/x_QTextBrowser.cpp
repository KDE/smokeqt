...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8513, (void*)this, x)) return;
	this->QTextBrowser::backward();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8514, (void*)this, x)) return;
	this->QTextBrowser::forward();
    }
    ...
    virtual void home() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8515, (void*)this, x)) return;
	this->QTextBrowser::home();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(8523, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8512, (void*)this, x)) return;
