...
public:
    ...
    virtual void clear() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(7784, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual uint count() const {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(7783, (void*)this, x, true /*pure virtual*/);
    ...
    ~x_QPtrCollection() { qt_Smoke->binding->deleted(247, (void*)this); }
};
