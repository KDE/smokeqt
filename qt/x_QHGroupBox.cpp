...
public:
	...
	x_QHGroupBox* xret = new x_QHGroupBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QHGroupBox(QWidget*)
	x_QHGroupBox* xret = new x_QHGroupBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHGroupBox* xret = new x_QHGroupBox(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHGroupBox* xret = new x_QHGroupBox(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHGroupBox* xret = new x_QHGroupBox(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QHGroupBox(xargs *x, void *s, int xi) {
    x_QHGroupBox *xself = (x_QHGroupBox*)s;
    switch(xi) {
	case 0: x_QHGroupBox::x_0(x);	break;
	case 1: x_QHGroupBox::x_1(x);	break;
	case 2: x_QHGroupBox::x_2(x);	break;
	case 3: x_QHGroupBox::x_3(x);	break;
	case 4: x_QHGroupBox::x_4(x);	break;
	case 5: x_QHGroupBox::x_5(x);	break;
