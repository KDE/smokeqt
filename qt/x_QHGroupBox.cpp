...
public:
	...
	x_QHGroupBox* xret = new x_QHGroupBox((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	...
	x_QHGroupBox* xret = new x_QHGroupBox(*(const QString *)x[1].s_class,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QHGroupBox* xret = new x_QHGroupBox(*(const QString *)x[1].s_class,(QWidget*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QHGroupBox* xret = new x_QHGroupBox(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
