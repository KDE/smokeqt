...
public:
    ...
    virtual int getch() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 342, x)) return (int)x[0].s_int;
	return this->QBuffer::getch();
    }
    virtual bool open(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 332, x)) return (bool)x[0].s_bool;
	return this->QBuffer::open(x1);
    }
    virtual int putch(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 343, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 344, x)) return (int)x[0].s_int;
