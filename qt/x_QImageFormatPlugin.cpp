...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	qt_Smoke->binding->callMethod(4869, (void*)this, x, true /*pure virtual*/);
	return (bool)x[0].s_bool;
	// ABSTRACT
    }
    virtual QStringList keys() const {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4866, (void*)this, x, true /*pure virtual*/);
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(4867, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_class = (void*)&x3;
	if(qt_Smoke->binding->callMethod(4868, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QImageFormatPlugin() { qt_Smoke->binding->deleted(167, (void*)this); }
};
