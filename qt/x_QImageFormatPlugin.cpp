...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4835, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4843, (void*)this, x, true /*pure virtual*/);
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(4844, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QImageFormatPlugin::loadImage(x1, x2, x3);
    }
    virtual QMetaObject* metaObject() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4834, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(4836, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(4837, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_class = (void*)&x3;
	if(qt_Smoke->binding->callMethod(4845, (void*)this, x)) return (bool)x[0].s_bool;
