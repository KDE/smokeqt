...
public:
	...
	QCString xret = this->QBig5Codec::fromUnicode(*(const QString *)x[1].s_class,*(int *)x[2].s_class);
	x[0].s_class = (void*)new QCString(xret);
    }
    void x_4(Smoke::Stack x) const {
	// toUnicode(const char*, int)
	QString xret = this->QBig5Codec::toUnicode((const char*)x[1].s_class,(int)x[2].s_int);
	x[0].s_class = (void*)new QString(xret);
    }
    void x_5(Smoke::Stack x) const {
	// heuristicContentMatch(const char*, int)
	int xret = this->QBig5Codec::heuristicContentMatch((const char*)x[1].s_class,(int)x[2].s_int);
	x[0].s_int = (int)xret;
    }
    void x_6(Smoke::Stack x) const {
	// heuristicNameMatch(const char*)
	int xret = this->QBig5Codec::heuristicNameMatch((const char*)x[1].s_class);
	x[0].s_int = (int)xret;
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(237, (void*)this, x)) {
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(239, (void*)this, x)) return (int)x[0].s_int;
	return this->QBig5Codec::heuristicContentMatch(x1, x2);
    }
    virtual int heuristicNameMatch(const char* x1) const {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(240, (void*)this, x)) return (int)x[0].s_int;
	return this->QBig5Codec::heuristicNameMatch(x1);
    }
    virtual QTextDecoder* makeDecoder() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(236, (void*)this, x)) return (QTextDecoder*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(234, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(235, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(238, (void*)this, x)) {
...
void xcall_QBig5Codec(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 8: delete (QBig5Codec*)xself;	break;
    }
}
