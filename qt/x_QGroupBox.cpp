...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3814, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3813, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(3815, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(3817, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(3816, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(3818, (void*)this, x)) return (bool)x[0].s_bool;
...
void xcall_QGroupBox(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 34: x_QGroupBox::x_34(args);	break;
	case 35: x_QGroupBox::x_35(args);	break;
	...
	case 45: delete (QGroupBox*)xself;	break;
    }
}
