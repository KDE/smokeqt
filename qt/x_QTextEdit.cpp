...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10677, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10676, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10678, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10679, (void*)this, x)) return (bool)x[0].s_bool;
	...
	switch(xtype) {
	  case 669: //QTextEdit::KeyboardAction
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QTextEdit::KeyboardAction*)xdata = (QTextEdit::KeyboardAction)xvalue;
	    ...
	    break;
	  case 670: //QTextEdit::TextInsertionFlags
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QTextEdit::TextInsertionFlags*)xdata = (QTextEdit::TextInsertionFlags)xvalue;
	    ...
	    break;
	  case 671: //QTextEdit::VerticalAlignment
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QTextEdit::VerticalAlignment*)xdata = (QTextEdit::VerticalAlignment)xvalue;
	    ...
	    break;
	  case 668: //QTextEdit::CursorAction
	    switch(xop) {
	      case Smoke::EnumNew:
	  ...
	  case 673: //QTextEdit::WordWrap
		...
		*(QTextEdit::WordWrap*)xdata = (QTextEdit::WordWrap)xvalue;
	    ...
	    break;
	  case 667: //QTextEdit::AutoFormatting
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QTextEdit() { qt_Smoke->binding->deleted(329, (void*)this); }
};
