...
public:
    ...
    void x_205(Smoke::Stack x) const {
	// document()
	QTextDocument* xret = this->QTextEdit::document();
	x[0].s_voidp = (void*)xret;
    }
    void x_206(Smoke::Stack x) const {
	// textCursor()
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10224, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10223, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10225, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10227, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10226, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(10228, (void*)this, x)) return (bool)x[0].s_bool;
	...
	switch(xtype) {
	  case 645: //QTextEdit::KeyboardAction
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QTextEdit::KeyboardAction*)xdata = (QTextEdit::KeyboardAction)xvalue;
	    ...
	    break;
	  case 646: //QTextEdit::VerticalAlignment
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QTextEdit::VerticalAlignment*)xdata = (QTextEdit::VerticalAlignment)xvalue;
	    ...
	    break;
	  case 644: //QTextEdit::CursorAction
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QTextEdit() { qt_Smoke->binding->deleted(322, (void*)this); }
};
...
void xcall_QTextEdit(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 35: x_QTextEdit::x_35(args);	break;
	case 36: x_QTextEdit::x_36(args);	break;
	case 37: x_QTextEdit::x_37(args);	break;
	case 38: x_QTextEdit::x_38(args);	break;
	case 39: x_QTextEdit::x_39(args);	break;
	...
	case 179: x_QTextEdit::x_179(args);	break;
	case 180: x_QTextEdit::x_180(args);	break;
	case 181: x_QTextEdit::x_181(args);	break;
	case 182: x_QTextEdit::x_182(args);	break;
	case 183: x_QTextEdit::x_183(args);	break;
	...
	case 213: delete (QTextEdit*)xself;	break;
    }
}
