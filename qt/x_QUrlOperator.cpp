...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(call_method((void*)this, 9161, x)) 	return (const QNetworkOperation*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 9157, x)) 	return (const QNetworkOperation*)x[0].s_class;
	return this->QUrlOperator::listChildren();
    }
    virtual const QNetworkOperation* mkdir(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(call_method((void*)this, 9158, x)) 	return (const QNetworkOperation*)x[0].s_class;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(call_method((void*)this, 9163, x)) 	return (const QNetworkOperation*)x[0].s_class;
	return this->QUrlOperator::put(x1, x2);
    }
    virtual const QNetworkOperation* remove(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(call_method((void*)this, 9159, x)) 	return (const QNetworkOperation*)x[0].s_class;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(call_method((void*)this, 9160, x)) 	return (const QNetworkOperation*)x[0].s_class;
