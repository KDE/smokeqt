...
public:
	...
	QString xret = QInputDialog::getText(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,*(QLineEdit::EchoMode *)x[3].s_voidp,*(const QString *)x[4].s_voidp,(bool*)x[5].s_voidp,(QWidget*)x[6].s_voidp,(const char*)x[7].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
    static void x_1(Smoke::Stack x) {
	// getText(const QString&, const QString&, QLineEdit::EchoMode, const QString&, bool*, QWidget*)
	QString xret = QInputDialog::getText(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,*(QLineEdit::EchoMode *)x[3].s_voidp,*(const QString *)x[4].s_voidp,(bool*)x[5].s_voidp,(QWidget*)x[6].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
    static void x_2(Smoke::Stack x) {
	// getText(const QString&, const QString&, QLineEdit::EchoMode, const QString&, bool*)
	QString xret = QInputDialog::getText(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,*(QLineEdit::EchoMode *)x[3].s_voidp,*(const QString *)x[4].s_voidp,(bool*)x[5].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
    static void x_3(Smoke::Stack x) {
	// getText(const QString&, const QString&, QLineEdit::EchoMode, const QString&)
	QString xret = QInputDialog::getText(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,*(QLineEdit::EchoMode *)x[3].s_voidp,*(const QString *)x[4].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
    static void x_4(Smoke::Stack x) {
	// getText(const QString&, const QString&, QLineEdit::EchoMode)
	QString xret = QInputDialog::getText(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,*(QLineEdit::EchoMode *)x[3].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
