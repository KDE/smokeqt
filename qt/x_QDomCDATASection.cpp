...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2469, (void*)this, x)) {
	...
	x[1].s_ulong = x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(2465, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2458, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QDomCDATASection::isCDATASection();
    }
    virtual bool isCharacterData() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2472, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2468, (void*)this, x)) return (uint)x[0].s_uint;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2457, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(2470, (void*)this, x)) return;
	...
	x[1].s_ulong = x1;
	x[2].s_ulong = x2;
	if(qt_Smoke->binding->callMethod(2463, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomCDATASection() { qt_Smoke->binding->deleted(81, (void*)this); }
};
