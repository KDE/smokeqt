...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2427, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2710, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2437, (void*)this, x)) return (uint)x[0].s_uint;
	...
	x[1].s_ulong = x1;
	x[2].s_ulong = x2;
	if(qt_Smoke->binding->callMethod(2432, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomCDATASection() { qt_Smoke->binding->deleted(77, (void*)this); }
};
