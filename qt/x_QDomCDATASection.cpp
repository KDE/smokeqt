...
public:
	...
	x_QDomCDATASection* xret = new x_QDomCDATASection(*(const QDomCDATASection *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	QDomCDATASection& xret = this->QDomCDATASection::operator=(*(const QDomCDATASection *)x[1].s_class);
	x[0].s_class = (void*)&xret;
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2011, (void*)this, x)) {
	...
	x[1].s_ulong = x1;
	x[2].s_ulong = x2;
	if(qt_Smoke->binding->callMethod(2008, (void*)this, x)) return;
	...
	x[1].s_ulong = x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(2007, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2000, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QDomCDATASection::isCDATASection();
    }
    virtual bool isCharacterData() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2014, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2281, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2010, (void*)this, x)) return (uint)x[0].s_uint;
	...
	x[2].s_ulong = x2;
	x[3].s_voidp = (void*)&x3;
	if(qt_Smoke->binding->callMethod(2009, (void*)this, x)) return;
	this->QDomCharacterData::replaceData(x1, x2, x3);
    }
    virtual void setData(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(2012, (void*)this, x)) return;
	...
	x[1].s_ulong = x1;
	x[2].s_ulong = x2;
	if(qt_Smoke->binding->callMethod(2005, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomCDATASection() { qt_Smoke->binding->deleted(79, (void*)this); }
};
