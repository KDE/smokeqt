...
public:
	...
	x_QProgressBar* xret = new x_QProgressBar((QWidget*)x[1].s_class,(const char*)x[2].s_class,*(Qt::WFlags *)x[3].s_class);
	...
	x_QProgressBar* xret = new x_QProgressBar((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QProgressBar* xret = new x_QProgressBar((int)x[1].s_int,(QWidget*)x[2].s_class,(const char*)x[3].s_class,*(Qt::WFlags *)x[4].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QProgressBar* xret = new x_QProgressBar((int)x[1].s_int,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	bool xret = this->QProgressBar::setIndicator(*(QString *)x[1].s_class,(int)x[2].s_int,(int)x[3].s_int);
	x[0].s_bool = (bool)xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(6281, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6270, (void*)this, x)) {
	...
	x[2].s_int = (int)x2;
	x[3].s_int = (int)x3;
	if(qt_Smoke->callMethod(6282, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(6280, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(6279, (void*)this, x)) return;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6277, (void*)this, x)) return;
	this->QProgressBar::show();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6269, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(6283, (void*)this, x)) return;
