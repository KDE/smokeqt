...
public:
	...
	x_QProgressBar* xret = new x_QProgressBar((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,*(Qt::WFlags *)x[3].s_voidp);
	...
	x_QProgressBar* xret = new x_QProgressBar((int)x[1].s_int,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp,*(Qt::WFlags *)x[4].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6226, x)) {
	...
	x[2].s_int = (int)x2;
	x[3].s_int = (int)x3;
	if(call_method((void*)this, 6238, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6236, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6225, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
