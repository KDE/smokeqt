...
public:
	...
	x[0].s_enum = (long)QGArray::MemOptim;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_enum = (long)QGArray::SpeedOptim;
    }
	...
	// resize(uint, QGArray::Optimization)
	bool xret = this->QGArray::resize((uint)x[1].s_uint,(QGArray::Optimization)x[2].s_enum);
	x[0].s_bool = xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(3688, (void*)this, x)) return;
	this->QGArray::deleteData(x1);
    }
    virtual void detach() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3664, (void*)this, x)) return;
	this->QGArray::detach();
    }
    virtual QGArray::array_data* newData() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3687, (void*)this, x)) return (QGArray::array_data*)x[0].s_class;
	return this->QGArray::newData();
    }
    static void xenum_operation(Smoke::EnumOperation xop, Smoke::Index xtype, void *&xdata, long &xvalue) {
	switch(xtype) {
	  case 248: //QGArray::Optimization
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QGArray::Optimization;
		break;
	      case Smoke::EnumDelete:
		delete (QGArray::Optimization*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QGArray::Optimization*)xdata = (QGArray::Optimization)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QGArray::Optimization*)xdata;
		break;
	    }
	    break;
	}
...
void xenum_QGArray(Smoke::EnumOperation xop, Smoke::Index xtype, void *&xdata, long &xvalue) {
    x_QGArray::xenum_operation(xop, xtype, xdata, xvalue);
}
void xcall_QGArray(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 4: x_QGArray::x_4(args);	break;
	case 5: x_QGArray::x_5(args);	break;
