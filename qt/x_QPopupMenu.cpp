...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6019, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6015, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(call_method((void*)this, 6043, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6011, x)) return;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6006, x)) return;
	this->QPopupMenu::show();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6012, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
