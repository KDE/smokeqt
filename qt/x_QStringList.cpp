...
public:
	...
	x_QStringList* xret = new x_QStringList(*(const QValueList<QString> *)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QStringList* xret = new x_QStringList(*(const QString *)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QStringList* xret = new x_QStringList((const char*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	// join(const QString&)
	QString xret = this->QStringList::join(*(const QString *)x[1].s_voidp);
	x[0].s_voidp = (void*)new QString(xret);
    }
    void x_7(Smoke::Stack x) const {
	// grep(const QString&, bool)
	QStringList xret = this->QStringList::grep(*(const QString *)x[1].s_voidp,(bool)x[2].s_bool);
	x[0].s_class = (void*)new QStringList(xret);
    }
    void x_8(Smoke::Stack x) const {
	// grep(const QString&)
	QStringList xret = this->QStringList::grep(*(const QString *)x[1].s_voidp);
	x[0].s_class = (void*)new QStringList(xret);
    }
	...
	QStringList xret = QStringList::split(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,(bool)x[3].s_bool);
	x[0].s_class = (void*)new QStringList(xret);
    }
    static void x_12(Smoke::Stack x) {
	// split(const QString&, const QString&)
	QStringList xret = QStringList::split(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp);
	x[0].s_class = (void*)new QStringList(xret);
    }
