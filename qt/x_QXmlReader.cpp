...
public:
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(12556, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->binding->callMethod(12557, (void*)this, x, true /*pure virtual*/);
	return (bool)x[0].s_bool;
	// ABSTRACT
    }
    virtual bool parse(const QXmlInputSource* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	qt_Smoke->binding->callMethod(12558, (void*)this, x, true /*pure virtual*/);
	return (bool)x[0].s_bool;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	qt_Smoke->binding->callMethod(12555, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    ...
    ~x_QXmlReader() { qt_Smoke->binding->deleted(389, (void*)this); }
};
