...
return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(8552, (void*)this, x)) return (int)x[0].s_int;
...
return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(8536, (void*)this, x, true /*pure virtual*/);
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(8541, (void*)this, x)) {
