...
public:
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_int = x2;
	qt_Smoke->binding->callMethod(4607, (void*)this, x, true /*pure virtual*/);
	return (QImageFormat*)x[0].s_class;
	// ABSTRACT
    }
    virtual const char* formatName() const {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4608, (void*)this, x, true /*pure virtual*/);
	return (const char*)x[0].s_class;
	// ABSTRACT
    }
    ~x_QImageFormatType() { qt_Smoke->binding->deleted(162, (void*)this); }
};
