...
public:
	...
	x_QCanvasView* xret = new x_QCanvasView((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,*(Qt::WFlags *)x[3].x_voidp);
	...
	x_QCanvasView* xret = new x_QCanvasView((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QCanvasView(QWidget*)
	x_QCanvasView* xret = new x_QCanvasView((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QCanvasView* xret = new x_QCanvasView((QCanvas*)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp,*(Qt::WFlags *)x[4].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QCanvasView* xret = new x_QCanvasView((QCanvas*)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QCanvasView* xret = new x_QCanvasView((QCanvas*)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QCanvasView(QCanvas*)
	x_QCanvasView* xret = new x_QCanvasView((QCanvas*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_9(xargs *x) {
	// setCanvas(QCanvas*)
	this->QCanvasView::setCanvas((QCanvas*)x[1].x_voidp);
    }
	...
	bool xret = this->QCanvasView::setWorldMatrix(*(const QWMatrix *)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_13(xargs *x) {
	// drawContents(QPainter*, int, int, int, int)
	this->QCanvasView::drawContents((QPainter*)x[1].x_voidp,(int)x[2].x_int,(int)x[3].x_int,(int)x[4].x_int,(int)x[5].x_int);
    }
...
void xcall_QCanvasView(xargs *x, void *s, int xi) {
    x_QCanvasView *xself = (x_QCanvasView*)s;
    switch(xi) {
	case 0: x_QCanvasView::x_0(x);	break;
	case 1: x_QCanvasView::x_1(x);	break;
	case 2: x_QCanvasView::x_2(x);	break;
	case 3: x_QCanvasView::x_3(x);	break;
	case 4: x_QCanvasView::x_4(x);	break;
	case 5: x_QCanvasView::x_5(x);	break;
	case 6: x_QCanvasView::x_6(x);	break;
	case 7: x_QCanvasView::x_7(x);	break;
