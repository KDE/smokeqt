...
public:
	...
	x_QCanvasView* xret = new x_QCanvasView((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,(Qt::WFlags)x[3].s_int);
	...
	x_QCanvasView* xret = new x_QCanvasView((QCanvas*)x[1].s_voidp,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp,(Qt::WFlags)x[4].s_int);
	x[0].s_class = (void*)xret;
    }
	...
	x[4].s_int = x4;
	x[5].s_int = x5;
	if(qt_Smoke->callMethod(711, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(712, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
