...
public:
	...
	// setAttribute(const QString&, long)
	this->QDomElement::setAttribute(*(const QString *)x[1].s_voidp,(long)x[2].s_long);
	(void)x; // noop (for compiler warning)
    }
    void x_9(Smoke::Stack x) {
	// setAttribute(const QString&, ulong)
	this->QDomElement::setAttribute(*(const QString *)x[1].s_voidp,(ulong)x[2].s_ulong);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2558, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(2544, (void*)this, x)) {
	    QDomNodeList *xptr = (QDomNodeList *)x[0].s_class;
	    QDomNodeList xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(2554, (void*)this, x)) {
	    QDomNodeList *xptr = (QDomNodeList *)x[0].s_class;
	    QDomNodeList xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2560, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2559, (void*)this, x)) {
    ...
    ~x_QDomElement() { qt_Smoke->binding->deleted(83, (void*)this); }
};
void xcall_QDomElement(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 33: delete (QDomElement*)xself;	break;
    }
}
