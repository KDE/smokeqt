...
public:
	...
	x[1].s_class = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(9370, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(9450, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(9372, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(9434, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(9435, (void*)this, x)) return;
	this->QSqlRecord::setGenerated(x1, x2);
    }
    virtual void setName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9367, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(9431, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(9430, (void*)this, x)) return;
	this->QSqlRecord::setValue(x1, x2);
    }
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(9457, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9429, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(9428, (void*)this, x)) {
	    QVariant *xptr = (QVariant *)x[0].s_class;
	    QVariant xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QSqlIndex() { qt_Smoke->binding->deleted(294, (void*)this); }
};
