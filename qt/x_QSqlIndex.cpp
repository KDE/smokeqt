...
public:
	...
	x_QSqlIndex* xret = new x_QSqlIndex(*(const QString *)x[1].s_class,*(const QString *)x[2].s_class);
	...
	x_QSqlIndex* xret = new x_QSqlIndex(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	QString xret = this->QSqlIndex::toString(*(const QString *)x[1].s_class,*(const QString *)x[2].s_class,(bool)x[3].s_bool);
	x[0].s_class = (void*)new QString(xret);
    }
    void x_14(Smoke::Stack x) const {
	// toString(const QString&, const QString&)
	QString xret = this->QSqlIndex::toString(*(const QString *)x[1].s_class,*(const QString *)x[2].s_class);
	x[0].s_class = (void*)new QString(xret);
    }
    void x_15(Smoke::Stack x) const {
	// toString(const QString&)
	QString xret = this->QSqlIndex::toString(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)new QString(xret);
    }
	...
	QStringList xret = this->QSqlIndex::toStringList(*(const QString *)x[1].s_class,(bool)x[2].s_bool);
	x[0].s_class = (void*)new QStringList(xret);
    }
    void x_18(Smoke::Stack x) const {
	// toStringList(const QString&)
	QStringList xret = this->QSqlIndex::toStringList(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)new QStringList(xret);
    }
	...
	QSqlIndex xret = QSqlIndex::fromStringList(*(const QStringList *)x[1].s_class,(const QSqlCursor*)x[2].s_class);
	x[0].s_class = (void*)new QSqlIndex(xret);
    }
    virtual void append(const QSqlField& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7543, (void*)this, x)) return;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_bool = (bool)x2;
	if(qt_Smoke->callMethod(7544, (void*)this, x)) return;
	this->QSqlIndex::append(x1, x2);
    }
    virtual void clear() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(7618, (void*)this, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7614, (void*)this, x)) return;
	this->QSqlRecord::insert(x1, x2);
    }
    virtual void remove(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(7615, (void*)this, x)) return;
	this->QSqlRecord::remove(x1);
    }
    virtual void setCursorName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7539, (void*)this, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_bool = (bool)x2;
	if(qt_Smoke->callMethod(7546, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7541, (void*)this, x)) return;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(7622, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(7596, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(7595, (void*)this, x)) {
	    QVariant *xptr = (QVariant *)x[0].s_class;
	    QVariant xret(*xptr);
	    delete xptr;
	    return xret;
