...
public:
	...
	x[1].s_class = (void*)&x1;
	x[2].s_bool = (bool)x2;
	if(call_method((void*)this, 7489, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 7560, x)) return;
	this->QSqlRecord::remove(x1);
    }
    virtual void setCursorName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(call_method((void*)this, 7484, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_bool = (bool)x2;
	if(call_method((void*)this, 7491, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(call_method((void*)this, 7486, x)) return;
