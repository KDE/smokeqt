...
public:
	...
	x_QDateTimeEditBase* xret = new x_QDateTimeEditBase((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QDateTimeEditBase* xret = new x_QDateTimeEditBase((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	qt_Smoke->callMethod(1634, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->callMethod(1635, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->callMethod(1633, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->callMethod(1632, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(1637, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual void stepUp() {
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(1636, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
