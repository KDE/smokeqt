...
public:
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	qt_Smoke->binding->callMethod(1983, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1972, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1971, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(1973, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(1975, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(1987, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual void stepUp() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(1986, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
