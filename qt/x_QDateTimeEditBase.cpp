...
public:
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	qt_Smoke->binding->callMethod(1634, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(1635, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(1633, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(1632, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(1637, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual void stepUp() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(1636, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
...
void xcall_QDateTimeEditBase(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 3: delete (QDateTimeEditBase*)xself;	break;
    }
}
