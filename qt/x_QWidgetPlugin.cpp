...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11716, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[2].s_class = (void*)x2;
	x[3].s_voidp = (void*)x3;
	qt_Smoke->binding->callMethod(11725, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11728, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11729, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11733, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QWidgetPlugin::isContainer(x1);
    }
    virtual QStringList keys() const {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(11724, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11715, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(11717, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11732, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QWidgetPlugin() { qt_Smoke->binding->deleted(366, (void*)this); }
};
