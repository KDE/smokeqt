...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12206, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(12218, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(12214, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12205, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(12207, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(12208, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QWidgetPlugin() { qt_Smoke->binding->deleted(371, (void*)this); }
};
