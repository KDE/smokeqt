...
public:
	...
	x[0].x_long = (long)QButton::SingleShot;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QButton::Toggle;
    }
    static void x_2(xargs *x) {
	x[0].x_long = (long)QButton::Tristate;
    }
    static void x_3(xargs *x) {
	x[0].x_long = (long)QButton::Off;
    }
    static void x_4(xargs *x) {
	x[0].x_long = (long)QButton::NoChange;
    }
    static void x_5(xargs *x) {
	x[0].x_long = (long)QButton::On;
    }
    static void x_6(xargs *x) {
	// QButton(QWidget*, const char*, Qt::WFlags)
	x_QButton* xret = new x_QButton((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,*(Qt::WFlags *)x[3].x_voidp);
	...
	x_QButton* xret = new x_QButton((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QButton(QWidget*)
	x_QButton* xret = new x_QButton((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QButton::setText(*(const QString *)x[1].x_voidp);
    }
	...
	this->QButton::setPixmap(*(const QPixmap *)x[1].x_voidp);
    }
	...
	this->QButton::setAccel(*(const QKeySequence *)x[1].x_voidp);
    }
    ...
    void x_18(xargs *x) {
	// setDown(bool)
	this->QButton::setDown((bool)x[1].x_bool);
    }
    ...
    void x_23(xargs *x) {
	// setAutoResize(bool)
	this->QButton::setAutoResize((bool)x[1].x_bool);
    }
    ...
    void x_25(xargs *x) {
	// setAutoRepeat(bool)
	this->QButton::setAutoRepeat((bool)x[1].x_bool);
    }
    ...
    void x_33(xargs *x) {
	// toggled(bool)
	this->QButton::toggled((bool)x[1].x_bool);
    }
    void x_34(xargs *x) {
	// stateChanged(int)
	this->QButton::stateChanged((int)x[1].x_int);
    }
    void x_35(xargs *x) {
	// setToggleButton(bool)
	this->QButton::setToggleButton((bool)x[1].x_bool);
    }
    void x_36(xargs *x) {
	// setToggleType(QButton::ToggleType)
	this->QButton::setToggleType((QButton::ToggleType)x[1].x_long);
    }
    void x_37(xargs *x) {
	// setOn(bool)
	this->QButton::setOn((bool)x[1].x_bool);
    }
    void x_38(xargs *x) {
	// setState(QButton::ToggleState)
	this->QButton::setState((QButton::ToggleState)x[1].x_long);
    }
    void x_39(xargs *x) const {
	// hitButton(const QPoint&)
	bool xret = this->QButton::hitButton(*(const QPoint *)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_40(xargs *x) {
	// drawButton(QPainter*)
	this->QButton::drawButton((QPainter*)x[1].x_voidp);
    }
    void x_41(xargs *x) {
	// drawButtonLabel(QPainter*)
	this->QButton::drawButtonLabel((QPainter*)x[1].x_voidp);
    }
    void x_42(xargs *x) {
	// keyPressEvent(QKeyEvent*)
	this->QButton::keyPressEvent((QKeyEvent*)x[1].x_voidp);
    }
    void x_43(xargs *x) {
	// keyReleaseEvent(QKeyEvent*)
	this->QButton::keyReleaseEvent((QKeyEvent*)x[1].x_voidp);
    }
    void x_44(xargs *x) {
	// mousePressEvent(QMouseEvent*)
	this->QButton::mousePressEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_45(xargs *x) {
	// mouseReleaseEvent(QMouseEvent*)
	this->QButton::mouseReleaseEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_46(xargs *x) {
	// mouseMoveEvent(QMouseEvent*)
	this->QButton::mouseMoveEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_47(xargs *x) {
	// paintEvent(QPaintEvent*)
	this->QButton::paintEvent((QPaintEvent*)x[1].x_voidp);
    }
    void x_48(xargs *x) {
	// focusInEvent(QFocusEvent*)
	this->QButton::focusInEvent((QFocusEvent*)x[1].x_voidp);
    }
    void x_49(xargs *x) {
	// focusOutEvent(QFocusEvent*)
	this->QButton::focusOutEvent((QFocusEvent*)x[1].x_voidp);
    }
    void x_50(xargs *x) {
	// enabledChange(bool)
	this->QButton::enabledChange((bool)x[1].x_bool);
    }
...
void xcall_QButton(xargs *x, void *s, int xi) {
    x_QButton *xself = (x_QButton*)s;
    switch(xi) {
	case 0: x_QButton::x_0(x);	break;
	case 1: x_QButton::x_1(x);	break;
	case 2: x_QButton::x_2(x);	break;
	case 3: x_QButton::x_3(x);	break;
	case 4: x_QButton::x_4(x);	break;
	case 5: x_QButton::x_5(x);	break;
	case 6: x_QButton::x_6(x);	break;
	case 7: x_QButton::x_7(x);	break;
	case 8: x_QButton::x_8(x);	break;
	case 9: x_QButton::x_9(x);	break;
