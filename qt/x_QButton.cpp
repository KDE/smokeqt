...
public:
	...
	// setEnabled(bool)
	this->QButton::setEnabled((bool)x[1].s_bool);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(437, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(484, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(436, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(438, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(440, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(439, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(441, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QButton() { qt_Smoke->binding->deleted(16, (void*)this); }
};
...
void xcall_QButton(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 47: x_QButton::x_47(args);	break;
	...
	case 64: delete (QButton*)xself;	break;
    }
}
