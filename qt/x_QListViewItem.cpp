...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5845, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QListViewItem::acceptDrop(x1);
    }
    virtual void activate() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5860, (void*)this, x)) return;
	this->QListViewItem::activate();
    }
	...
	x[2].s_int = x2;
	x[3].s_bool = x3;
	if(qt_Smoke->binding->callMethod(5816, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5864, (void*)this, x)) return;
	this->QListViewItem::dragLeft();
    }
    virtual void dropped(QDropEvent* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5862, (void*)this, x)) return;
	this->QListViewItem::dropped(x1);
    }
    virtual void enforceSortOrder() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5858, (void*)this, x)) return;
	this->QListViewItem::enforceSortOrder();
    }
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(5815, (void*)this, x)) {
	...
	x[4].s_int = x4;
	x[5].s_int = x5;
	if(qt_Smoke->binding->callMethod(5824, (void*)this, x)) return;
	...
	x[2].s_class = (void*)&x2;
	x[3].s_class = (void*)&x3;
	if(qt_Smoke->binding->callMethod(5826, (void*)this, x)) return;
	this->QListViewItem::paintFocus(x1, x2, x3);
    }
    virtual const QPixmap* pixmap(int x1) const {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5814, (void*)this, x)) return (const QPixmap*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5853, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5859, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(5820, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(5848, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(5817, (void*)this, x)) return;
	this->QListViewItem::sortChildItems(x1, x2);
    }
    virtual void startRename(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5850, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5812, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[2].s_class = (void*)x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(5807, (void*)this, x)) return (int)x[0].s_int;
	return this->QListViewItem::width(x1, x2, x3);
    }
    ~x_QListViewItem() { qt_Smoke->binding->deleted(192, (void*)this); }
};
