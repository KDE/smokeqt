...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5822, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QListViewItem::acceptDrop(x1);
    }
    virtual void activate() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5837, (void*)this, x)) return;
	this->QListViewItem::activate();
    }
	...
	x[2].s_int = x2;
	x[3].s_bool = x3;
	if(qt_Smoke->binding->callMethod(5793, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5841, (void*)this, x)) return;
	this->QListViewItem::dragLeft();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5835, (void*)this, x)) return;
	this->QListViewItem::enforceSortOrder();
    }
	...
	x[2].s_class = (void*)&x2;
	x[3].s_class = (void*)&x3;
	if(qt_Smoke->binding->callMethod(5803, (void*)this, x)) return;
	this->QListViewItem::paintFocus(x1, x2, x3);
    }
    virtual const QPixmap* pixmap(int x1) const {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5791, (void*)this, x)) return (const QPixmap*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5830, (void*)this, x)) return (int)x[0].s_int;
	return this->QListViewItem::rtti();
    }
    virtual void setDragEnabled(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(5818, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(5813, (void*)this, x)) return;
	this->QListViewItem::setExpandable(x1);
    }
    virtual void setHeight(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5836, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(5790, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(5825, (void*)this, x)) return;
	this->QListViewItem::setRenameEnabled(x1, x2);
    }
    virtual void setSelectable(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(5811, (void*)this, x)) return;
	this->QListViewItem::setSelectable(x1);
    }
    virtual void setSelected(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(5799, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(5788, (void*)this, x)) return;
	this->QListViewItem::setText(x1, x2);
    }
    virtual void setup() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5798, (void*)this, x)) return;
	this->QListViewItem::setup();
    }
    virtual void sort() {
	Smoke::StackItem x[1];
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(5794, (void*)this, x)) return;
	this->QListViewItem::sortChildItems(x1, x2);
    }
    virtual void startRename(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5827, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(5789, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[2].s_class = (void*)x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(5784, (void*)this, x)) return (int)x[0].s_int;
