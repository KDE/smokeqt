...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4679, (void*)this, x)) return;
	this->QListViewItem::activate();
    }
	...
	x[2].s_class = (void*)&x2;
	x[3].s_class = (void*)&x3;
	if(qt_Smoke->callMethod(4647, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4674, (void*)this, x)) return (int)x[0].s_int;
    ...
    virtual void setup() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4642, (void*)this, x)) return;
	this->QListViewItem::setup();
    }
    virtual void sort() {
	Smoke::StackItem x[1];
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(4633, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[2].s_class = (void*)x2;
	x[3].s_int = (int)x3;
	if(qt_Smoke->callMethod(4628, (void*)this, x)) return (int)x[0].s_int;
