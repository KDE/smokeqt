...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2535, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2534, (void*)this, x)) {
    ...
    ~x_QDomDocument() { qt_Smoke->binding->deleted(84, (void*)this); }
};
