...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2422, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2416, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2421, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2418, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2417, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QDomAttr::specified();
    }
    virtual QString value() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2419, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomAttr() { qt_Smoke->binding->deleted(76, (void*)this); }
};
