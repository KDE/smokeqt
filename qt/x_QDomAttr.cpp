...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1994, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1988, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1993, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1990, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->callMethod(1992, (void*)this, x)) return;
	this->QDomAttr::setValue(x1);
    }
    virtual bool specified() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1989, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QDomAttr::specified();
    }
    virtual QString value() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1991, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
