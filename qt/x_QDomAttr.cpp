...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2452, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2451, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2448, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(2450, (void*)this, x)) return;
	this->QDomAttr::setValue(x1);
    }
    virtual bool specified() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2447, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QDomAttr::specified();
    }
    virtual QString value() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2449, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomAttr() { qt_Smoke->binding->deleted(80, (void*)this); }
};
