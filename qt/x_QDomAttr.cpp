...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2429, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2423, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2428, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2425, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2424, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QDomAttr::specified();
    }
    virtual QString value() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2426, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
