...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 5389, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 5367, x)) return (int)x[0].s_int;
