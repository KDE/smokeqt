...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6362, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6361, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	return this->QNetworkProtocol::metaObject();
    }
    virtual void operationGet(QNetworkOperation* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(6403, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(6363, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(6365, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(6364, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6374, (void*)this, x)) return (int)x[0].s_int;
	...
	switch(xtype) {
	  case 445: //QNetworkProtocol::ConnectionState
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QNetworkProtocol::ConnectionState*)xdata = (QNetworkProtocol::ConnectionState)xvalue;
	    ...
	    break;
	  case 446: //QNetworkProtocol::Error
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QNetworkProtocol::Error*)xdata = (QNetworkProtocol::Error)xvalue;
	    ...
	    break;
	  case 447: //QNetworkProtocol::Operation
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QNetworkProtocol::Operation*)xdata = (QNetworkProtocol::Operation)xvalue;
	    ...
	    break;
	  case 448: //QNetworkProtocol::State
	    switch(xop) {
	      case Smoke::EnumNew:
