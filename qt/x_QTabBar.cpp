...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10075, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(10089, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10102, (void*)this, x)) return;
	this->QTabBar::layoutTabs();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10074, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10095, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10076, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(10079, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(10103, (void*)this, x)) return (QTab*)x[0].s_class;
    ...
    ~x_QTabBar() { qt_Smoke->binding->deleted(317, (void*)this); }
};
