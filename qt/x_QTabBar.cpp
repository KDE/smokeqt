...
public:
	...
	// event(QEvent*)
	bool xret = this->QTabBar::event((QEvent*)x[1].s_class);
	x[0].s_bool = xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10087, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10126, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QTabBar::event(x1);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10117, (void*)this, x)) return;
	this->QTabBar::focusOutEvent(x1);
    }
    virtual void fontChange(const QFont& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(10125, (void*)this, x)) return;
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(10088, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10094, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(10102, (void*)this, x)) return (QTab*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10107, (void*)this, x)) return;
	this->QTabBar::setCurrentTab(x1);
    }
    virtual void setCurrentTab(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(10106, (void*)this, x)) return;
	this->QTabBar::setCurrentTab(x1);
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10093, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QTabBar() { qt_Smoke->binding->deleted(316, (void*)this); }
};
...
void xcall_QTabBar(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 58: delete (QTabBar*)xself;	break;
    }
}
