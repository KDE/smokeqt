...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 8059, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 8060, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8073, x)) return;
	this->QTabBar::layoutTabs();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8066, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 8062, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 8074, x)) 	return (QTab*)x[0].s_voidp;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 8057, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_bool = (bool)x2;
	if(call_method((void*)this, 8063, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8065, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
