...
public:
	...
	x[2].s_int = x2;
	x[3].s_bool = x3;
	if(qt_Smoke->binding->callMethod(7654, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(7667, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(7663, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(7657, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(7664, (void*)this, x)) return;
...
void xcall_QStatusBar(Smoke::Index xi, void *obj, Smoke::Stack args) {
    ...
    switch(xi) {
	case 0: x_QStatusBar::x_0(args);	break;
	case 1: x_QStatusBar::x_1(args);	break;
	case 2: x_QStatusBar::x_2(args);	break;
	...
	case 17: delete (QStatusBar*)xself;	break;
    }
}
