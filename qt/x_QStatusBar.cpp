...
public:
	...
	x_QStatusBar* xret = new x_QStatusBar((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QStatusBar(QWidget*)
	x_QStatusBar* xret = new x_QStatusBar((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QStatusBar::addWidget((QWidget*)x[1].x_voidp,(int)x[2].x_int,(bool)x[3].x_bool);
    }
    void x_4(xargs *x) {
	// addWidget(QWidget*, int)
	this->QStatusBar::addWidget((QWidget*)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_5(xargs *x) {
	// addWidget(QWidget*)
	this->QStatusBar::addWidget((QWidget*)x[1].x_voidp);
    }
    void x_6(xargs *x) {
	// removeWidget(QWidget*)
	this->QStatusBar::removeWidget((QWidget*)x[1].x_voidp);
    }
    void x_7(xargs *x) {
	// setSizeGripEnabled(bool)
	this->QStatusBar::setSizeGripEnabled((bool)x[1].x_bool);
    }
	...
	this->QStatusBar::message(*(const QString *)x[1].x_voidp);
    }
    void x_10(xargs *x) {
	// message(const QString&, int)
	this->QStatusBar::message(*(const QString *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_11(xargs *x) {
	// clear()
	...
	this->QStatusBar::paintEvent((QPaintEvent*)x[1].x_voidp);
    }
    void x_13(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QStatusBar::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_14(xargs *x) {
	// reformat()
    ...
    void x_16(xargs *x) {
	// event(QEvent*)
	bool xret = this->QStatusBar::event((QEvent*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
	...
	x[2].x_int = (int)x2;
	x[3].x_bool = (bool)x3;
	if(call_method((void*)this, 7612, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 7625, x)) return (bool)x[0].x_bool;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 7621, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 7615, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 7622, x)) return;
...
void xcall_QStatusBar(xargs *x, void *s, int xi) {
    x_QStatusBar *xself = (x_QStatusBar*)s;
    switch(xi) {
	case 0: x_QStatusBar::x_0(x);	break;
	case 1: x_QStatusBar::x_1(x);	break;
	case 2: x_QStatusBar::x_2(x);	break;
