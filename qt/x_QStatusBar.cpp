...
public:
	...
	x_QStatusBar* xret = new x_QStatusBar((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	...
	x[2].s_int = (int)x2;
	x[3].s_bool = (bool)x3;
	if(qt_Smoke->callMethod(7667, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7680, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7676, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7670, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(7677, (void*)this, x)) return;
