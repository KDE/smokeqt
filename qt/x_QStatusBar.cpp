...
public:
	...
	x_QStatusBar* xret = new x_QStatusBar((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	// QStatusBar(QWidget*)
	x_QStatusBar* xret = new x_QStatusBar((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	this->QStatusBar::addWidget((QWidget*)x[1].s_voidp,(int)x[2].s_int,(bool)x[3].s_bool);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_4(Smoke::Stack x) {
	// addWidget(QWidget*, int)
	this->QStatusBar::addWidget((QWidget*)x[1].s_voidp,(int)x[2].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_5(Smoke::Stack x) {
	// addWidget(QWidget*)
	this->QStatusBar::addWidget((QWidget*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_6(Smoke::Stack x) {
	// removeWidget(QWidget*)
	this->QStatusBar::removeWidget((QWidget*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QStatusBar::paintEvent((QPaintEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_13(Smoke::Stack x) {
	// resizeEvent(QResizeEvent*)
	this->QStatusBar::resizeEvent((QResizeEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	// event(QEvent*)
	bool xret = this->QStatusBar::event((QEvent*)x[1].s_voidp);
	x[0].s_bool = xret;
    }
	...
	x[2].s_int = x2;
	x[3].s_bool = x3;
	if(qt_Smoke->callMethod(7654, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(7667, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(7663, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(7657, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(7664, (void*)this, x)) return;
