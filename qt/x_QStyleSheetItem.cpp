...
public:
	...
	switch(xtype) {
	  case 626: //QStyleSheetItem::DisplayMode
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QStyleSheetItem::DisplayMode*)xdata = (QStyleSheetItem::DisplayMode)xvalue;
	    ...
	    break;
	  case 631: //QStyleSheetItem::VerticalAlignment
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QStyleSheetItem::VerticalAlignment*)xdata = (QStyleSheetItem::VerticalAlignment)xvalue;
	    ...
	    break;
	  case 630: //QStyleSheetItem::Margin
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QStyleSheetItem::Margin*)xdata = (QStyleSheetItem::Margin)xvalue;
	    ...
	    break;
	  case 632: //QStyleSheetItem::WhiteSpaceMode
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QStyleSheetItem::WhiteSpaceMode*)xdata = (QStyleSheetItem::WhiteSpaceMode)xvalue;
	    ...
	    break;
	  case 628: //QStyleSheetItem::ListStyle
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QStyleSheetItem::ListStyle*)xdata = (QStyleSheetItem::ListStyle)xvalue;
	    ...
	    break;
	  case 625: //QStyleSheetItem::AdditionalStyleValues
	    switch(xop) {
	      case Smoke::EnumNew:
