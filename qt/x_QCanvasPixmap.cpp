...
public:
	...
	x_QCanvasPixmap* xret = new x_QCanvasPixmap(*(const QImage *)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QCanvasPixmap* xret = new x_QCanvasPixmap(*(const QPixmap *)x[1].s_voidp,*(const QPoint *)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
