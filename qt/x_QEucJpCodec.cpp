...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 2363, x)) 	return (QTextDecoder*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 2362, x)) 	return (const char*)x[0].s_class;
	return this->QEucJpCodec::mimeName();
    }
    virtual const char* name() const {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 2361, x)) 	return (const char*)x[0].s_class;
