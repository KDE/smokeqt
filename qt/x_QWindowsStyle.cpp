...
public:
	...
	this->QWindowsStyle::polishPopupMenu((QPopupMenu*)x[1].x_voidp);
    }
	...
	this->QWindowsStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].x_long,(QPainter*)x[2].x_voidp,*(const QRect *)x[3].x_voidp,*(const QColorGroup *)x[4].x_voidp,*(QStyle::SFlags *)x[5].x_voidp,*(const QStyleOption *)x[6].x_voidp);
    }
    void x_3(xargs *x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QWindowsStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].x_long,(QPainter*)x[2].x_voidp,*(const QRect *)x[3].x_voidp,*(const QColorGroup *)x[4].x_voidp,*(QStyle::SFlags *)x[5].x_voidp);
    }
    void x_4(xargs *x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&)
	this->QWindowsStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].x_long,(QPainter*)x[2].x_voidp,*(const QRect *)x[3].x_voidp,*(const QColorGroup *)x[4].x_voidp);
    }
	...
	this->QWindowsStyle::drawControl((QStyle::ControlElement)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(const QStyleOption *)x[7].x_voidp);
    }
	...
	this->QWindowsStyle::drawControl((QStyle::ControlElement)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp);
    }
    void x_7(xargs *x) const {
	// drawControl(QStyle::ControlElement, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QWindowsStyle::drawControl((QStyle::ControlElement)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp);
    }
	...
	this->QWindowsStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(QStyle::SCFlags *)x[7].x_voidp,*(QStyle::SCFlags *)x[8].x_voidp,*(const QStyleOption *)x[9].x_voidp);
    }
	...
	this->QWindowsStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(QStyle::SCFlags *)x[7].x_voidp,*(QStyle::SCFlags *)x[8].x_voidp);
    }
	...
	this->QWindowsStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(QStyle::SCFlags *)x[7].x_voidp);
    }
	...
	this->QWindowsStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp);
    }
    void x_12(xargs *x) const {
	// drawComplexControl(QStyle::ComplexControl, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QWindowsStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp);
    }
    void x_13(xargs *x) const {
	// pixelMetric(QStyle::PixelMetric, const QWidget*)
	int xret = this->QWindowsStyle::pixelMetric((QStyle::PixelMetric)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_14(xargs *x) const {
	// pixelMetric(QStyle::PixelMetric)
	int xret = this->QWindowsStyle::pixelMetric((QStyle::PixelMetric)x[1].x_long);
	x[0].x_int = (int)xret;
    }
    void x_15(xargs *x) const {
	// sizeFromContents(QStyle::ContentsType, const QWidget*, const QSize&, const QStyleOption&)
	QSize xret = this->QWindowsStyle::sizeFromContents((QStyle::ContentsType)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QSize *)x[3].x_voidp,*(const QStyleOption *)x[4].x_voidp);
	x[0].x_voidp = (void*)new QSize(xret);
    }
    void x_16(xargs *x) const {
	// sizeFromContents(QStyle::ContentsType, const QWidget*, const QSize&)
	QSize xret = this->QWindowsStyle::sizeFromContents((QStyle::ContentsType)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QSize *)x[3].x_voidp);
	x[0].x_voidp = (void*)new QSize(xret);
    }
    void x_17(xargs *x) const {
	// styleHint(QStyle::StyleHint, const QWidget*, const QStyleOption&, QStyleHintReturn*)
	int xret = this->QWindowsStyle::styleHint((QStyle::StyleHint)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QStyleOption *)x[3].x_voidp,(QStyleHintReturn*)x[4].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_18(xargs *x) const {
	// styleHint(QStyle::StyleHint, const QWidget*, const QStyleOption&)
	int xret = this->QWindowsStyle::styleHint((QStyle::StyleHint)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QStyleOption *)x[3].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_19(xargs *x) const {
	// styleHint(QStyle::StyleHint, const QWidget*)
	int xret = this->QWindowsStyle::styleHint((QStyle::StyleHint)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_20(xargs *x) const {
	// stylePixmap(QStyle::StylePixmap, const QWidget*, const QStyleOption&)
	QPixmap xret = this->QWindowsStyle::stylePixmap((QStyle::StylePixmap)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QStyleOption *)x[3].x_voidp);
	x[0].x_voidp = (void*)new QPixmap(xret);
    }
    void x_21(xargs *x) const {
	// stylePixmap(QStyle::StylePixmap, const QWidget*)
	QPixmap xret = this->QWindowsStyle::stylePixmap((QStyle::StylePixmap)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)new QPixmap(xret);
    }
    void x_22(xargs *x) const {
	// stylePixmap(QStyle::StylePixmap)
	QPixmap xret = this->QWindowsStyle::stylePixmap((QStyle::StylePixmap)x[1].x_long);
	x[0].x_voidp = (void*)new QPixmap(xret);
    }
	...
	x[8].x_voidp = (void*)&x8;
	x[9].x_voidp = (void*)&x9;
	if(call_method((void*)this, 9809, x)) return;
	...
	x[6].x_voidp = (void*)&x6;
	x[7].x_voidp = (void*)&x7;
	if(call_method((void*)this, 9806, x)) return;
	...
	x[5].x_voidp = (void*)&x5;
	x[6].x_voidp = (void*)&x6;
	if(call_method((void*)this, 9803, x)) return;
	...
	x[1].x_long = (long)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 9814, x)) return (int)x[0].x_int;
...
void xcall_QWindowsStyle(xargs *x, void *s, int xi) {
    x_QWindowsStyle *xself = (x_QWindowsStyle*)s;
    switch(xi) {
	case 0: x_QWindowsStyle::x_0(x);	break;
