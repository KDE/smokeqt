...
public:
	...
	QPtrCollection::Item xret = this->QBaseBucket::setData(*(QPtrCollection::Item *)x[1].s_class);
	x[0].s_class = (void*)new QPtrCollection::Item(xret);
    }
	...
	x_QBaseBucket* xret = new x_QBaseBucket(*(QPtrCollection::Item *)x[1].s_class,(QBaseBucket*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
