...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10616, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10632, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(10631, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10615, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10617, (void*)this, x)) return (void*)x[0].s_voidp;
    ...
    ~x_QTextDrag() { qt_Smoke->binding->deleted(328, (void*)this); }
};
