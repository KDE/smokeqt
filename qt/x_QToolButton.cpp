...
public:
	...
	x_QToolButton* xret = new x_QToolButton((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QToolButton(QWidget*)
	x_QToolButton* xret = new x_QToolButton((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QToolButton* xret = new x_QToolButton(*(const QIconSet *)x[1].x_voidp,*(const QString *)x[2].x_voidp,*(const QString *)x[3].x_voidp,(QObject*)x[4].x_voidp,(const char*)x[5].x_voidp,(QToolBar*)x[6].x_voidp,(const char*)x[7].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QToolButton* xret = new x_QToolButton(*(const QIconSet *)x[1].x_voidp,*(const QString *)x[2].x_voidp,*(const QString *)x[3].x_voidp,(QObject*)x[4].x_voidp,(const char*)x[5].x_voidp,(QToolBar*)x[6].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QToolButton* xret = new x_QToolButton((Qt::ArrowType)x[1].x_long,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QToolButton* xret = new x_QToolButton((Qt::ArrowType)x[1].x_long,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QToolButton::setOnIconSet(*(const QIconSet *)x[1].x_voidp);
    }
    void x_9(xargs *x) {
	// setOffIconSet(const QIconSet&)
	this->QToolButton::setOffIconSet(*(const QIconSet *)x[1].x_voidp);
    }
    void x_10(xargs *x) {
	// setIconSet(const QIconSet&, bool)
	this->QToolButton::setIconSet(*(const QIconSet *)x[1].x_voidp,(bool)x[2].x_bool);
    }
	...
	// iconSet(bool)
	QIconSet xret = this->QToolButton::iconSet((bool)x[1].x_bool);
	x[0].x_voidp = (void*)new QIconSet(xret);
    }
    void x_14(xargs *x) {
	// setIconSet(const QIconSet&)
	this->QToolButton::setIconSet(*(const QIconSet *)x[1].x_voidp);
    }
    ...
    void x_19(xargs *x) {
	// setPopup(QPopupMenu*)
	this->QToolButton::setPopup((QPopupMenu*)x[1].x_voidp);
    }
    ...
    void x_21(xargs *x) {
	// setPopupDelay(int)
	this->QToolButton::setPopupDelay((int)x[1].x_int);
    }
    ...
    void x_24(xargs *x) {
	// setAutoRaise(bool)
	this->QToolButton::setAutoRaise((bool)x[1].x_bool);
    }
	...
	this->QToolButton::setUsesBigPixmap((bool)x[1].x_bool);
    }
    void x_27(xargs *x) {
	// setUsesTextLabel(bool)
	this->QToolButton::setUsesTextLabel((bool)x[1].x_bool);
    }
    void x_28(xargs *x) {
	// setTextLabel(const QString&, bool)
	this->QToolButton::setTextLabel(*(const QString *)x[1].x_voidp,(bool)x[2].x_bool);
    }
    void x_29(xargs *x) {
	// setToggleButton(bool)
	this->QToolButton::setToggleButton((bool)x[1].x_bool);
    }
    void x_30(xargs *x) {
	// setOn(bool)
	this->QToolButton::setOn((bool)x[1].x_bool);
    }
    void x_31(xargs *x) {
	// toggle()
	...
	this->QToolButton::setTextLabel(*(const QString *)x[1].x_voidp);
    }
    void x_33(xargs *x) {
	// mousePressEvent(QMouseEvent*)
	this->QToolButton::mousePressEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_34(xargs *x) {
	// drawButton(QPainter*)
	this->QToolButton::drawButton((QPainter*)x[1].x_voidp);
    }
    void x_35(xargs *x) {
	// drawButtonLabel(QPainter*)
	this->QToolButton::drawButtonLabel((QPainter*)x[1].x_voidp);
    }
    void x_36(xargs *x) {
	// enterEvent(QEvent*)
	this->QToolButton::enterEvent((QEvent*)x[1].x_voidp);
    }
    void x_37(xargs *x) {
	// leaveEvent(QEvent*)
	this->QToolButton::leaveEvent((QEvent*)x[1].x_voidp);
    }
    void x_38(xargs *x) {
	// moveEvent(QMoveEvent*)
	this->QToolButton::moveEvent((QMoveEvent*)x[1].x_voidp);
    }
	...
	bool xret = this->QToolButton::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_41(xargs *x) {
	// paletteChange(const QPalette&)
	this->QToolButton::paletteChange(*(const QPalette *)x[1].x_voidp);
    }
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 8958, x)) return (bool)x[0].x_bool;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 385, x)) return (bool)x[0].x_bool;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 8955, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 8925, x)) {
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 8956, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 8959, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 8932, x)) return;
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 8948, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 8924, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QToolButton(xargs *x, void *s, int xi) {
    x_QToolButton *xself = (x_QToolButton*)s;
    switch(xi) {
	case 0: x_QToolButton::x_0(x);	break;
	case 1: x_QToolButton::x_1(x);	break;
	case 2: x_QToolButton::x_2(x);	break;
	case 3: x_QToolButton::x_3(x);	break;
	case 4: x_QToolButton::x_4(x);	break;
	case 5: x_QToolButton::x_5(x);	break;
