...
public:
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_int = (int)x3;
	if(call_method((void*)this, 4472, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 4470, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4567, x)) 	return (QDragObject*)x[0].s_voidp;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)x2;
	if(call_method((void*)this, 4517, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4466, x)) return;
	this->QListView::insertItem(x1);
    }
    virtual void invertSelection() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4532, x)) return;
	this->QListView::invertSelection();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4519, x)) {
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 4483, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_voidp = (void*)&x2;
	if(call_method((void*)this, 4475, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4515, x)) return;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_bool = (bool)x2;
	if(call_method((void*)this, 4499, x)) return;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_bool = (bool)x2;
	if(call_method((void*)this, 4496, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4465, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4518, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
