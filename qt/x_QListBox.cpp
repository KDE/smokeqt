...
public:
	...
	x[0].x_long = (long)QListBox::Single;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QListBox::Multi;
    }
    static void x_2(xargs *x) {
	x[0].x_long = (long)QListBox::Extended;
    }
    static void x_3(xargs *x) {
	x[0].x_long = (long)QListBox::NoSelection;
    }
    static void x_4(xargs *x) {
	x[0].x_long = (long)QListBox::FixedNumber;
    }
    static void x_5(xargs *x) {
	x[0].x_long = (long)QListBox::FitToWidth;
    }
    static void x_6(xargs *x) {
	x[0].x_long = (long)QListBox::FitToHeight;
    }
    static void x_7(xargs *x) {
	x[0].x_long = (long)QListBox::Variable;
    }
    static void x_8(xargs *x) {
	// QListBox(QWidget*, const char*, Qt::WFlags)
	x_QListBox* xret = new x_QListBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,*(Qt::WFlags *)x[3].x_voidp);
	...
	x_QListBox* xret = new x_QListBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QListBox(QWidget*)
	x_QListBox* xret = new x_QListBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_12(xargs *x) {
	// setFont(const QFont&)
	this->QListBox::setFont(*(const QFont *)x[1].x_voidp);
    }
	...
	this->QListBox::insertStringList(*(const QStringList *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_15(xargs *x) {
	// insertStringList(const QStringList&)
	this->QListBox::insertStringList(*(const QStringList *)x[1].x_voidp);
    }
    void x_16(xargs *x) {
	// insertStrList(const QStrList*, int)
	this->QListBox::insertStrList((const QStrList*)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_17(xargs *x) {
	// insertStrList(const QStrList*)
	this->QListBox::insertStrList((const QStrList*)x[1].x_voidp);
    }
    void x_18(xargs *x) {
	// insertStrList(const QStrList&, int)
	this->QListBox::insertStrList(*(const QStrList *)x[1].x_voidp,(int)x[2].x_int);
	...
	this->QListBox::insertStrList((const char**)x[1].x_voidp,(int)x[2].x_int,(int)x[3].x_int);
    }
    void x_21(xargs *x) {
	// insertStrList(const char**, int)
	this->QListBox::insertStrList((const char**)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_22(xargs *x) {
	// insertStrList(const char**)
	this->QListBox::insertStrList((const char**)x[1].x_voidp);
    }
    void x_23(xargs *x) {
	// insertItem(const QListBoxItem*, int)
	this->QListBox::insertItem((const QListBoxItem*)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_24(xargs *x) {
	// insertItem(const QListBoxItem*)
	this->QListBox::insertItem((const QListBoxItem*)x[1].x_voidp);
    }
    void x_25(xargs *x) {
	// insertItem(const QListBoxItem*, const QListBoxItem*)
	this->QListBox::insertItem((const QListBoxItem*)x[1].x_voidp,(const QListBoxItem*)x[2].x_voidp);
    }
    void x_26(xargs *x) {
	// insertItem(const QString&, int)
	this->QListBox::insertItem(*(const QString *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_27(xargs *x) {
	// insertItem(const QString&)
	this->QListBox::insertItem(*(const QString *)x[1].x_voidp);
    }
    void x_28(xargs *x) {
	// insertItem(const QPixmap&, int)
	this->QListBox::insertItem(*(const QPixmap *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_29(xargs *x) {
	// insertItem(const QPixmap&)
	this->QListBox::insertItem(*(const QPixmap *)x[1].x_voidp);
    }
    void x_30(xargs *x) {
	// insertItem(const QPixmap&, const QString&, int)
	this->QListBox::insertItem(*(const QPixmap *)x[1].x_voidp,*(const QString *)x[2].x_voidp,(int)x[3].x_int);
    }
    void x_31(xargs *x) {
	// insertItem(const QPixmap&, const QString&)
	this->QListBox::insertItem(*(const QPixmap *)x[1].x_voidp,*(const QString *)x[2].x_voidp);
    }
    void x_32(xargs *x) {
	// removeItem(int)
	this->QListBox::removeItem((int)x[1].x_int);
    }
    void x_33(xargs *x) const {
	// text(int)
	QString xret = this->QListBox::text((int)x[1].x_int);
	x[0].x_voidp = (void*)new QString(xret);
    }
    void x_34(xargs *x) const {
	// pixmap(int)
	const QPixmap* xret = this->QListBox::pixmap((int)x[1].x_int);
	x[0].x_voidp = (void*)xret;
    }
    void x_35(xargs *x) {
	// changeItem(const QListBoxItem*, int)
	this->QListBox::changeItem((const QListBoxItem*)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_36(xargs *x) {
	// changeItem(const QString&, int)
	this->QListBox::changeItem(*(const QString *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_37(xargs *x) {
	// changeItem(const QPixmap&, int)
	this->QListBox::changeItem(*(const QPixmap *)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_38(xargs *x) {
	// changeItem(const QPixmap&, const QString&, int)
	this->QListBox::changeItem(*(const QPixmap *)x[1].x_voidp,*(const QString *)x[2].x_voidp,(int)x[3].x_int);
    }
    void x_39(xargs *x) {
	// takeItem(const QListBoxItem*)
	this->QListBox::takeItem((const QListBoxItem*)x[1].x_voidp);
    }
    ...
    void x_43(xargs *x) {
	// setCurrentItem(int)
	this->QListBox::setCurrentItem((int)x[1].x_int);
    }
    void x_44(xargs *x) {
	// setCurrentItem(QListBoxItem*)
	this->QListBox::setCurrentItem((QListBoxItem*)x[1].x_voidp);
    }
    void x_45(xargs *x) {
	// centerCurrentItem()
    ...
    void x_47(xargs *x) {
	// setTopItem(int)
	this->QListBox::setTopItem((int)x[1].x_int);
    }
    void x_48(xargs *x) {
	// setBottomItem(int)
	this->QListBox::setBottomItem((int)x[1].x_int);
    }
	...
	this->QListBox::setSelectionMode((QListBox::SelectionMode)x[1].x_long);
    }
	...
	this->QListBox::setMultiSelection((bool)x[1].x_bool);
    }
	...
	this->QListBox::setSelected((QListBoxItem*)x[1].x_voidp,(bool)x[2].x_bool);
    }
    void x_55(xargs *x) {
	// setSelected(int, bool)
	this->QListBox::setSelected((int)x[1].x_int,(bool)x[2].x_bool);
    }
    void x_56(xargs *x) const {
	// isSelected(int)
	bool xret = this->QListBox::isSelected((int)x[1].x_int);
	x[0].x_bool = (bool)xret;
    }
    void x_57(xargs *x) const {
	// isSelected(const QListBoxItem*)
	bool xret = this->QListBox::isSelected((const QListBoxItem*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
	...
	// item(int)
	QListBoxItem* xret = this->QListBox::item((int)x[1].x_int);
	x[0].x_voidp = (void*)xret;
    }
    void x_61(xargs *x) const {
	// index(const QListBoxItem*)
	int xret = this->QListBox::index((const QListBoxItem*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_62(xargs *x) const {
	// findItem(const QString&, Qt::ComparisonFlags)
	QListBoxItem* xret = this->QListBox::findItem(*(const QString *)x[1].x_voidp,*(Qt::ComparisonFlags *)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    void x_63(xargs *x) const {
	// findItem(const QString&)
	QListBoxItem* xret = this->QListBox::findItem(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    void x_64(xargs *x) {
	// triggerUpdate(bool)
	this->QListBox::triggerUpdate((bool)x[1].x_bool);
    }
    void x_65(xargs *x) {
	// itemVisible(int)
	bool xret = this->QListBox::itemVisible((int)x[1].x_int);
	x[0].x_bool = (bool)xret;
    }
    void x_66(xargs *x) {
	// itemVisible(const QListBoxItem*)
	bool xret = this->QListBox::itemVisible((const QListBoxItem*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_67(xargs *x) {
	// setColumnMode(QListBox::LayoutMode)
	this->QListBox::setColumnMode((QListBox::LayoutMode)x[1].x_long);
    }
    void x_68(xargs *x) {
	// setColumnMode(int)
	this->QListBox::setColumnMode((int)x[1].x_int);
    }
    void x_69(xargs *x) {
	// setRowMode(QListBox::LayoutMode)
	this->QListBox::setRowMode((QListBox::LayoutMode)x[1].x_long);
    }
    void x_70(xargs *x) {
	// setRowMode(int)
	this->QListBox::setRowMode((int)x[1].x_int);
    }
	...
	this->QListBox::setVariableWidth((bool)x[1].x_bool);
    }
	...
	this->QListBox::setVariableHeight((bool)x[1].x_bool);
    }
    void x_79(xargs *x) {
	// viewportPaintEvent(QPaintEvent*)
	this->QListBox::viewportPaintEvent((QPaintEvent*)x[1].x_voidp);
    }
    ...
    void x_81(xargs *x) {
	// setDragSelect(bool)
	this->QListBox::setDragSelect((bool)x[1].x_bool);
    }
    ...
    void x_83(xargs *x) {
	// setAutoScroll(bool)
	this->QListBox::setAutoScroll((bool)x[1].x_bool);
    }
	...
	this->QListBox::setAutoScrollBar((bool)x[1].x_bool);
    }
    ...
    void x_87(xargs *x) {
	// setScrollBar(bool)
	this->QListBox::setScrollBar((bool)x[1].x_bool);
    }
	...
	this->QListBox::setAutoBottomScrollBar((bool)x[1].x_bool);
    }
	...
	this->QListBox::setBottomScrollBar((bool)x[1].x_bool);
    }
	...
	this->QListBox::setSmoothScrolling((bool)x[1].x_bool);
    }
    ...
    void x_95(xargs *x) {
	// setAutoUpdate(bool)
	this->QListBox::setAutoUpdate((bool)x[1].x_bool);
    }
    void x_96(xargs *x) {
	// setFixedVisibleLines(int)
	this->QListBox::setFixedVisibleLines((int)x[1].x_int);
    }
    void x_97(xargs *x) {
	// inSort(const QListBoxItem*)
	int xret = this->QListBox::inSort((const QListBoxItem*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_98(xargs *x) {
	// inSort(const QString&)
	int xret = this->QListBox::inSort(*(const QString *)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_99(xargs *x) const {
	// cellHeight(int)
	int xret = this->QListBox::cellHeight((int)x[1].x_int);
	x[0].x_int = (int)xret;
    }
	...
	// cellWidth(int)
	int xret = this->QListBox::cellWidth((int)x[1].x_int);
	x[0].x_int = (int)xret;
    }
	...
	// itemHeight(int)
	int xret = this->QListBox::itemHeight((int)x[1].x_int);
	x[0].x_int = (int)xret;
    }
	...
	// itemAt(const QPoint&)
	QListBoxItem* xret = this->QListBox::itemAt(*(const QPoint *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    void x_107(xargs *x) const {
	// itemRect(QListBoxItem*)
	QRect xret = this->QListBox::itemRect((QListBoxItem*)x[1].x_voidp);
    ...
    void x_109(xargs *x) {
	// sort(bool)
	this->QListBox::sort((bool)x[1].x_bool);
    }
    void x_110(xargs *x) {
	// sort()
	this->QListBox::sort();
    ...
    void x_114(xargs *x) {
	// selectAll(bool)
	this->QListBox::selectAll((bool)x[1].x_bool);
    }
    void x_115(xargs *x) {
	// invertSelection()
    ...
    void x_116(xargs *x) {
	// highlighted(int)
	this->QListBox::highlighted((int)x[1].x_int);
    }
    void x_117(xargs *x) {
	// selected(int)
	this->QListBox::selected((int)x[1].x_int);
    }
    void x_118(xargs *x) {
	// highlighted(const QString&)
	this->QListBox::highlighted(*(const QString *)x[1].x_voidp);
    }
    void x_119(xargs *x) {
	// selected(const QString&)
	this->QListBox::selected(*(const QString *)x[1].x_voidp);
    }
    void x_120(xargs *x) {
	// highlighted(QListBoxItem*)
	this->QListBox::highlighted((QListBoxItem*)x[1].x_voidp);
    }
    void x_121(xargs *x) {
	// selected(QListBoxItem*)
	this->QListBox::selected((QListBoxItem*)x[1].x_voidp);
    }
    void x_122(xargs *x) {
	// selectionChanged()
	...
	this->QListBox::selectionChanged((QListBoxItem*)x[1].x_voidp);
    }
    void x_124(xargs *x) {
	// currentChanged(QListBoxItem*)
	this->QListBox::currentChanged((QListBoxItem*)x[1].x_voidp);
    }
    void x_125(xargs *x) {
	// clicked(QListBoxItem*)
	this->QListBox::clicked((QListBoxItem*)x[1].x_voidp);
    }
    void x_126(xargs *x) {
	// clicked(QListBoxItem*, const QPoint&)
	this->QListBox::clicked((QListBoxItem*)x[1].x_voidp,*(const QPoint *)x[2].x_voidp);
    }
    void x_127(xargs *x) {
	// pressed(QListBoxItem*)
	this->QListBox::pressed((QListBoxItem*)x[1].x_voidp);
    }
    void x_128(xargs *x) {
	// pressed(QListBoxItem*, const QPoint&)
	this->QListBox::pressed((QListBoxItem*)x[1].x_voidp,*(const QPoint *)x[2].x_voidp);
    }
    void x_129(xargs *x) {
	// doubleClicked(QListBoxItem*)
	this->QListBox::doubleClicked((QListBoxItem*)x[1].x_voidp);
    }
    void x_130(xargs *x) {
	// returnPressed(QListBoxItem*)
	this->QListBox::returnPressed((QListBoxItem*)x[1].x_voidp);
    }
    void x_131(xargs *x) {
	// rightButtonClicked(QListBoxItem*, const QPoint&)
	this->QListBox::rightButtonClicked((QListBoxItem*)x[1].x_voidp,*(const QPoint *)x[2].x_voidp);
    }
    void x_132(xargs *x) {
	// rightButtonPressed(QListBoxItem*, const QPoint&)
	this->QListBox::rightButtonPressed((QListBoxItem*)x[1].x_voidp,*(const QPoint *)x[2].x_voidp);
    }
    void x_133(xargs *x) {
	// mouseButtonPressed(int, QListBoxItem*, const QPoint&)
	this->QListBox::mouseButtonPressed((int)x[1].x_int,(QListBoxItem*)x[2].x_voidp,*(const QPoint *)x[3].x_voidp);
    }
    void x_134(xargs *x) {
	// mouseButtonClicked(int, QListBoxItem*, const QPoint&)
	this->QListBox::mouseButtonClicked((int)x[1].x_int,(QListBoxItem*)x[2].x_voidp,*(const QPoint *)x[3].x_voidp);
    }
    void x_135(xargs *x) {
	// contextMenuRequested(QListBoxItem*, const QPoint&)
	this->QListBox::contextMenuRequested((QListBoxItem*)x[1].x_voidp,*(const QPoint *)x[2].x_voidp);
    }
    void x_136(xargs *x) {
	// onItem(QListBoxItem*)
	this->QListBox::onItem((QListBoxItem*)x[1].x_voidp);
    }
    void x_137(xargs *x) {
	// onViewport()
	...
	this->QListBox::mousePressEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_139(xargs *x) {
	// mouseReleaseEvent(QMouseEvent*)
	this->QListBox::mouseReleaseEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_140(xargs *x) {
	// mouseDoubleClickEvent(QMouseEvent*)
	this->QListBox::mouseDoubleClickEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_141(xargs *x) {
	// mouseMoveEvent(QMouseEvent*)
	this->QListBox::mouseMoveEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_142(xargs *x) {
	// contentsContextMenuEvent(QContextMenuEvent*)
	this->QListBox::contentsContextMenuEvent((QContextMenuEvent*)x[1].x_voidp);
    }
    void x_143(xargs *x) {
	// keyPressEvent(QKeyEvent*)
	this->QListBox::keyPressEvent((QKeyEvent*)x[1].x_voidp);
    }
    void x_144(xargs *x) {
	// focusInEvent(QFocusEvent*)
	this->QListBox::focusInEvent((QFocusEvent*)x[1].x_voidp);
    }
    void x_145(xargs *x) {
	// focusOutEvent(QFocusEvent*)
	this->QListBox::focusOutEvent((QFocusEvent*)x[1].x_voidp);
    }
    void x_146(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QListBox::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_147(xargs *x) {
	// showEvent(QShowEvent*)
	this->QListBox::showEvent((QShowEvent*)x[1].x_voidp);
    }
    void x_148(xargs *x) {
	// eventFilter(QObject*, QEvent*)
	bool xret = this->QListBox::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_149(xargs *x) {
	// updateItem(int)
	this->QListBox::updateItem((int)x[1].x_int);
    }
    void x_150(xargs *x) {
	// updateItem(QListBoxItem*)
	this->QListBox::updateItem((QListBoxItem*)x[1].x_voidp);
    }
    void x_151(xargs *x) {
	// updateCellWidth()
	...
	this->QListBox::paintCell((QPainter*)x[1].x_voidp,(int)x[2].x_int,(int)x[3].x_int);
    }
    void x_155(xargs *x) {
	// toggleCurrentItem()
	...
	this->QListBox::windowActivationChange((bool)x[1].x_bool);
    }
    void x_159(xargs *x) const {
	// itemYPos(int, int*)
	bool xret = this->QListBox::itemYPos((int)x[1].x_int,(int*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_160(xargs *x) const {
	// findItem(int)
	int xret = this->QListBox::findItem((int)x[1].x_int);
	x[0].x_int = (int)xret;
    }
    void x_161(xargs *x) {
	// clearInputString()
	...
	xargs x[1];
	if(call_method((void*)this, 4358, x)) return;
	this->QListBox::clearSelection();
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4387, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 4357, x)) return;
	this->QListBox::ensureCurrentVisible();
    }
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 4393, x)) return (bool)x[0].x_bool;
	return this->QListBox::eventFilter(x1, x2);
    }
    virtual void focusInEvent(QFocusEvent* x1) {
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4389, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4390, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 4360, x)) return;
	this->QListBox::invertSelection();
    }
    virtual void keyPressEvent(QKeyEvent* x1) {
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4388, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 4304, x)) {
	...
	x[2].x_int = (int)x2;
	x[3].x_int = (int)x3;
	if(call_method((void*)this, 4399, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4391, x)) return;
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 4359, x)) return;
	...
	xargs x[2];
	x[1].x_long = (long)x1;
	if(call_method((void*)this, 4312, x)) return;
	this->QListBox::setColumnMode(x1);
    }
    virtual void setColumnMode(int x1) {
	xargs x[2];
	x[1].x_int = (int)x1;
	if(call_method((void*)this, 4313, x)) return;
	this->QListBox::setColumnMode(x1);
    }
	...
	xargs x[2];
	x[1].x_int = (int)x1;
	if(call_method((void*)this, 4288, x)) return;
	this->QListBox::setCurrentItem(x1);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 4257, x)) return;
	...
	xargs x[2];
	x[1].x_long = (long)x1;
	if(call_method((void*)this, 4314, x)) return;
	...
	xargs x[2];
	x[1].x_int = (int)x1;
	if(call_method((void*)this, 4292, x)) return;
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 4323, x)) return;
	this->QListBox::setVariableHeight(x1);
    }
    virtual void setVariableWidth(bool x1) {
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 4321, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4392, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 4303, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4324, x)) return;
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 4403, x)) return;
	this->QListBox::windowActivationChange(x1);
    }
    ~x_QListBox() {}
};
void xcall_QListBox(xargs *x, void *s, int xi) {
    x_QListBox *xself = (x_QListBox*)s;
    switch(xi) {
	case 0: x_QListBox::x_0(x);	break;
	case 1: x_QListBox::x_1(x);	break;
	case 2: x_QListBox::x_2(x);	break;
	case 3: x_QListBox::x_3(x);	break;
	case 4: x_QListBox::x_4(x);	break;
	case 5: x_QListBox::x_5(x);	break;
	case 6: x_QListBox::x_6(x);	break;
	case 7: x_QListBox::x_7(x);	break;
	case 8: x_QListBox::x_8(x);	break;
	case 9: x_QListBox::x_9(x);	break;
	case 10: x_QListBox::x_10(x);	break;
	case 11: x_QListBox::x_11(x);	break;
