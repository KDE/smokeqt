...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4356, x)) return;
	this->QListBox::clearSelection();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4355, x)) return;
	this->QListBox::ensureCurrentVisible();
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)x2;
	if(call_method((void*)this, 4391, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4302, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4291, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4310, x)) return;
	this->QListBox::setColumnMode(x1);
    }
    virtual void setColumnMode(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4311, x)) return;
	this->QListBox::setColumnMode(x1);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4255, x)) return;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_bool = (bool)x2;
	if(call_method((void*)this, 4297, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4290, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(call_method((void*)this, 4319, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4301, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4322, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(call_method((void*)this, 4401, x)) return;
