...
public:
	...
	x_QWorkspace* xret = new x_QWorkspace((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QWorkspace(QWidget*)
	x_QWorkspace* xret = new x_QWorkspace((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x[0].x_voidp = (void*)new QWidgetList(xret);
    }
	...
	this->QWorkspace::setScrollBarsEnabled((bool)x[1].x_bool);
    }
    void x_8(xargs *x) {
	// setPaletteBackgroundColor(const QColor&)
	this->QWorkspace::setPaletteBackgroundColor(*(const QColor *)x[1].x_voidp);
    }
    void x_9(xargs *x) {
	// setPaletteBackgroundPixmap(const QPixmap&)
	this->QWorkspace::setPaletteBackgroundPixmap(*(const QPixmap *)x[1].x_voidp);
    }
    void x_10(xargs *x) {
	// cascade()
	...
	this->QWorkspace::windowActivated((QWidget*)x[1].x_voidp);
    }
    void x_13(xargs *x) {
	// styleChange(QStyle&)
	this->QWorkspace::styleChange(*(QStyle *)x[1].x_voidp);
    }
    void x_14(xargs *x) {
	// childEvent(QChildEvent*)
	this->QWorkspace::childEvent((QChildEvent*)x[1].x_voidp);
    }
    void x_15(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QWorkspace::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_16(xargs *x) {
	// eventFilter(QObject*, QEvent*)
	bool xret = this->QWorkspace::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_17(xargs *x) {
	// showEvent(QShowEvent*)
	this->QWorkspace::showEvent((QShowEvent*)x[1].x_voidp);
    }
    void x_18(xargs *x) {
	// hideEvent(QHideEvent*)
	this->QWorkspace::hideEvent((QHideEvent*)x[1].x_voidp);
    }
    void x_19(xargs *x) {
	// wheelEvent(QWheelEvent*)
	this->QWorkspace::wheelEvent((QWheelEvent*)x[1].x_voidp);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 9879, x)) return;
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 9881, x)) return (bool)x[0].x_bool;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 9883, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 9880, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 9882, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 9870, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 9878, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 9884, x)) return;
...
void xcall_QWorkspace(xargs *x, void *s, int xi) {
    x_QWorkspace *xself = (x_QWorkspace*)s;
    switch(xi) {
	case 0: x_QWorkspace::x_0(x);	break;
	case 1: x_QWorkspace::x_1(x);	break;
	case 2: x_QWorkspace::x_2(x);	break;
