...
public:
	...
	x_QErrorMessage* xret = new x_QErrorMessage((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QErrorMessage* xret = new x_QErrorMessage((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QErrorMessage::message(*(const QString *)x[1].x_voidp);
    }
    ...
    void x_4(xargs *x) {
	// done(int)
	this->QErrorMessage::done((int)x[1].x_int);
    }
    virtual void accept() {
	xargs x[1];
	...
	xargs x[2];
	x[1].x_int = (int)x1;
	if(call_method((void*)this, 2359, x)) return;
...
void xcall_QErrorMessage(xargs *x, void *s, int xi) {
    x_QErrorMessage *xself = (x_QErrorMessage*)s;
    switch(xi) {
	case 0: x_QErrorMessage::x_0(x);	break;
	case 1: x_QErrorMessage::x_1(x);	break;
	case 2: xself->x_2(x);	break;
	case 3: x_QErrorMessage::x_3(x);	break;
