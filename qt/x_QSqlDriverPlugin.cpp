...
public:
	...
	QSqlDriver* xret = this->QSqlDriverPlugin::create(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->callMethod(7432, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(7431, (void*)this, x, true /*pure virtual*/);
