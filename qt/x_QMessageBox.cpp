...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4989, x)) return;
	this->QMessageBox::adjustSize();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 5031, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4984, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 5032, x)) return;
