...
public:
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(8233, (void*)this, x)) return;
	...
	x[1].s_class = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(8231, (void*)this, x)) return;
	this->QTabWidget::addTab(x1, x2);
    }
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(8276, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_class = (void*)x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(8238, (void*)this, x)) return;
	...
	x[3].s_voidp = (void*)&x3;
	x[4].s_int = x4;
	if(qt_Smoke->binding->callMethod(8236, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8257, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8256, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
