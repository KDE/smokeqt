...
public:
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(10218, (void*)this, x)) return;
	...
	x[1].s_class = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(10216, (void*)this, x)) return;
	this->QTabWidget::addTab(x1, x2);
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10205, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(10266, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_class = (void*)x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(10223, (void*)this, x)) return;
	...
	x[3].s_voidp = (void*)&x3;
	x[4].s_int = x4;
	if(qt_Smoke->binding->callMethod(10221, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10204, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10242, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10206, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10208, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10207, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(10209, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10241, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 648: //QTabWidget::TabShape
		...
		*(QTabWidget::TabShape*)xdata = (QTabWidget::TabShape)xvalue;
	    ...
	    break;
	  case 647: //QTabWidget::TabPosition
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QTabWidget() { qt_Smoke->binding->deleted(319, (void*)this); }
};
