...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10202, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(10263, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_class = (void*)x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(10220, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10201, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10239, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10203, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(10206, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10262, (void*)this, x)) return;
	this->QTabWidget::updateMask();
    }
	...
	switch(xtype) {
	  case 647: //QTabWidget::TabShape
		...
		*(QTabWidget::TabShape*)xdata = (QTabWidget::TabShape)xvalue;
	    ...
	    break;
	  case 646: //QTabWidget::TabPosition
	    switch(xop) {
	      case Smoke::EnumNew:
