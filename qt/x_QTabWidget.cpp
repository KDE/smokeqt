...
public:
	...
	x[2].s_class = (void*)&x2;
	x[3].s_voidp = (void*)&x3;
	if(qt_Smoke->binding->callMethod(9810, (void*)this, x)) return;
	...
	x[1].s_class = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(9809, (void*)this, x)) return;
	this->QTabWidget::addTab(x1, x2);
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9798, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(9859, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[3].s_voidp = (void*)&x3;
	x[4].s_int = x4;
	if(qt_Smoke->binding->callMethod(9814, (void*)this, x)) return;
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(9812, (void*)this, x)) return;
	this->QTabWidget::insertTab(x1, x2, x3);
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9797, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(9799, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(9801, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(9800, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(9802, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(9845, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(9844, (void*)this, x)) return;
	this->QTabWidget::showPage(x1);
    }
    virtual QSize sizeHint() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9834, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 624: //QTabWidget::TabShape
		...
		*(QTabWidget::TabShape*)xdata = (QTabWidget::TabShape)xvalue;
	    ...
	    break;
	  case 623: //QTabWidget::TabPosition
	    switch(xop) {
	      case Smoke::EnumNew:
