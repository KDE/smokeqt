...
public:
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(call_method((void*)this, 8159, x)) return;
	this->QTabWidget::addTab(x1, x2);
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)x2;
	if(call_method((void*)this, 8204, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8185, x)) {
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8184, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 8202, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8203, x)) return;
	this->QTabWidget::updateMask();
    }
