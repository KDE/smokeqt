...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(763, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(767, (void*)this, x)) return;
	...
	x[1].s_double = x1;
	x[2].s_double = x2;
	if(qt_Smoke->binding->callMethod(762, (void*)this, x)) return;
	this->QCanvasPolygon::moveBy(x1, x2);
    }
    virtual int rtti() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(764, (void*)this, x)) return (int)x[0].s_int;
    ...
    ~x_QCanvasPolygon() { qt_Smoke->binding->deleted(27, (void*)this); }
};
