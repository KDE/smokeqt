...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4195, x)) return;
	this->QLineEdit::clearValidator();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4236, x)) 	return (QPopupMenu*)x[0].s_voidp;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4194, x)) return;
	this->QLineEdit::deselect();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4217, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4161, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4221, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4220, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4193, x)) return;
	this->QLineEdit::selectAll();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 4192, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4160, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
