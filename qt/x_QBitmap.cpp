...
public:
	...
	x_QBitmap* xret = new x_QBitmap((int)x[1].s_int,(int)x[2].s_int,(bool)x[3].s_bool,*(QPixmap::Optimization *)x[4].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap(*(const QSize *)x[1].s_class,(bool)x[2].s_bool,*(QPixmap::Optimization *)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap((int)x[1].s_int,(int)x[2].s_int,(const uchar*)x[3].s_class,(bool)x[4].s_bool);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap((int)x[1].s_int,(int)x[2].s_int,(const uchar*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap(*(const QSize *)x[1].s_class,(const uchar*)x[2].s_class,(bool)x[3].s_bool);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap(*(const QSize *)x[1].s_class,(const uchar*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap(*(const QString *)x[1].s_class,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QBitmap* xret = new x_QBitmap(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
