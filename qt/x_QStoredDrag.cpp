...
public:
	...
	x_QStoredDrag* xret = new x_QStoredDrag((const char*)x[1].s_class,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	...
	x_QStoredDrag* xret = new x_QStoredDrag((const char*)x[1].s_class,(QWidget*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QStoredDrag* xret = new x_QStoredDrag((const char*)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	QByteArray xret = this->QStoredDrag::encodedData((const char*)x[1].s_class);
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 7625, x)) 	return (const char*)x[0].s_class;
