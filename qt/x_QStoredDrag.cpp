...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9155, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9154, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(9156, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(9159, (void*)this, x)) return (bool)x[0].s_bool;
