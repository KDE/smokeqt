...
public:
	...
	x_QStoredDrag* xret = new x_QStoredDrag((const char*)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	...
	x_QStoredDrag* xret = new x_QStoredDrag((const char*)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QStoredDrag* xret = new x_QStoredDrag((const char*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QStoredDrag::setEncodedData(*(const QByteArray *)x[1].x_voidp);
    }
    void x_4(xargs *x) const {
	// format(int)
	const char* xret = this->QStoredDrag::format((int)x[1].x_int);
	x[0].x_voidp = (void*)xret;
    }
    void x_5(xargs *x) const {
	// encodedData(const char*)
	QByteArray xret = this->QStoredDrag::encodedData((const char*)x[1].x_voidp);
...
void xcall_QStoredDrag(xargs *x, void *s, int xi) {
    x_QStoredDrag *xself = (x_QStoredDrag*)s;
    switch(xi) {
	case 0: x_QStoredDrag::x_0(x);	break;
	case 1: x_QStoredDrag::x_1(x);	break;
	case 2: x_QStoredDrag::x_2(x);	break;
