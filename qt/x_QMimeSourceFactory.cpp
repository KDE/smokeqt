...
public:
	...
	x_QMimeSourceFactory* xret = new x_QMimeSourceFactory(*(const QMimeSourceFactory *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QMimeSourceFactory(const QMimeSourceFactory& x1) : QMimeSourceFactory(x1) {
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(6369, (void*)this, x)) return (const QMimeSource*)x[0].s_class;
	return this->QMimeSourceFactory::data(x1);
    }
    virtual QStringList filePath() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6377, (void*)this, x)) {
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(6370, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(6376, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(6373, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(6374, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(6372, (void*)this, x)) return;
	this->QMimeSourceFactory::setText(x1, x2);
    }
    ~x_QMimeSourceFactory() { qt_Smoke->binding->deleted(208, (void*)this); }
};
