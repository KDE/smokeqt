...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1616, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(1625, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(1617, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1615, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QDateTimeEdit(Smoke::Index xi, void *obj, Smoke::Stack args) {
    ...
    switch(xi) {
	case 0: x_QDateTimeEdit::x_0(args);	break;
	case 1: x_QDateTimeEdit::x_1(args);	break;
	case 2: x_QDateTimeEdit::x_2(args);	break;
	case 3: x_QDateTimeEdit::x_3(args);	break;
	case 4: x_QDateTimeEdit::x_4(args);	break;
	case 5: x_QDateTimeEdit::x_5(args);	break;
	...
	case 20: delete (QDateTimeEdit*)xself;	break;
    }
}
