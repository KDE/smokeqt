...
public:
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit(*(const QDateTime *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit(*(const QDateTime *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit(*(const QDateTime *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QDateTimeEdit::setDateTime(*(const QDateTime *)x[1].x_voidp);
    }
    ...
    void x_12(xargs *x) {
	// setAutoAdvance(bool)
	this->QDateTimeEdit::setAutoAdvance((bool)x[1].x_bool);
    }
	...
	this->QDateTimeEdit::valueChanged(*(const QDateTime *)x[1].x_voidp);
    }
    void x_15(xargs *x) {
	// init()
	...
	this->QDateTimeEdit::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_17(xargs *x) {
	// layoutEditors()
	...
	this->QDateTimeEdit::newValue(*(const QDate *)x[1].x_voidp);
    }
    void x_19(xargs *x) {
	// newValue(const QTime&)
	this->QDateTimeEdit::newValue(*(const QTime *)x[1].x_voidp);
    }
	...
	xargs x[1];
	if(call_method((void*)this, 1607, x)) {
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 1616, x)) return;
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 1612, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 1608, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 1606, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QDateTimeEdit(xargs *x, void *s, int xi) {
    x_QDateTimeEdit *xself = (x_QDateTimeEdit*)s;
    switch(xi) {
	case 0: x_QDateTimeEdit::x_0(x);	break;
	case 1: x_QDateTimeEdit::x_1(x);	break;
	case 2: x_QDateTimeEdit::x_2(x);	break;
	case 3: x_QDateTimeEdit::x_3(x);	break;
	case 4: x_QDateTimeEdit::x_4(x);	break;
	case 5: x_QDateTimeEdit::x_5(x);	break;
