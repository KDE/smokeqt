...
public:
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit(*(const QDateTime *)x[1].s_voidp,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit(*(const QDateTime *)x[1].s_voidp,(QWidget*)x[2].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDateTimeEdit* xret = new x_QDateTimeEdit(*(const QDateTime *)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	this->QDateTimeEdit::setDateTime(*(const QDateTime *)x[1].s_voidp);
	...
	this->QDateTimeEdit::valueChanged(*(const QDateTime *)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QDateTimeEdit::resizeEvent((QResizeEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QDateTimeEdit::newValue(*(const QDate *)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_19(Smoke::Stack x) {
	// newValue(const QTime&)
	this->QDateTimeEdit::newValue(*(const QTime *)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1616, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(1625, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(1621, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->callMethod(1617, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1615, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
