...
public:
	...
	x_QLayout* xret = new x_QLayout((QWidget*)x[1].s_class,(int)x[2].s_int,(int)x[3].s_int,(const char*)x[4].s_class);
	...
	x_QLayout* xret = new x_QLayout((QLayout*)x[1].s_class,(int)x[2].s_int,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QLayout* xret = new x_QLayout((int)x[1].s_int,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x[0].s_class = (void*)new QLayout::ResizeMode(xret);
    }
	...
	// addItem(QLayoutItem*)
	this->QLayout::addItem((QLayoutItem*)x[1].s_class);
    }
	...
	this->QLayout::setGeometry(*(const QRect *)x[1].s_class);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	qt_Smoke->callMethod(4095, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4096, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4091, (void*)this, x)) return;
	this->QLayout::invalidate();
    }
	...
	Smoke::StackItem x[1];
	qt_Smoke->callMethod(4100, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4098, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4097, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->callMethod(4099, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
