...
public:
	...
	x[0].s_class = (void*)new int(QCanvasText::RTTI);
    }
	...
	x_QCanvasText* xret = new x_QCanvasText(*(const QCanvasText *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QCanvasText(const QCanvasText& x1) : QCanvasText(x1) {
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(841, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(846, (void*)this, x)) return;
	...
	x[1].s_double = x1;
	x[2].s_double = x2;
	if(qt_Smoke->binding->callMethod(838, (void*)this, x)) return;
	this->QCanvasText::moveBy(x1, x2);
    }
    virtual int rtti() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(843, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QCanvasText(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 3: x_QCanvasText::x_3(args);	break;
	...
	case 16: x_QCanvasText::x_16(args);	break;
	case 17: xself->x_17(args);	break;
	case 18: delete (QCanvasText*)xself;	break;
    }
}
