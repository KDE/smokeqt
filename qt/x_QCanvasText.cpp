...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(690, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(691, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QCanvasText::collidesWith(x1);
    }
    virtual void draw(QPainter& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(693, (void*)this, x)) return;
	...
	if(qt_Smoke->callMethod(687, (void*)this, x)) return;
	this->QCanvasText::moveBy(x1, x2);
    }
    virtual int rtti() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(692, (void*)this, x)) return (int)x[0].s_int;
