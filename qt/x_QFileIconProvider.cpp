...
public:
	...
	x_QFileIconProvider* xret = new x_QFileIconProvider((QObject*)x[1].s_class,(const char*)x[2].s_class);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(2587, (void*)this, x)) return (const QPixmap*)x[0].s_class;
