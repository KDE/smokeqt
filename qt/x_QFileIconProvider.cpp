...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3115, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3114, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	return this->QFileIconProvider::metaObject();
    }
    virtual const QPixmap* pixmap(const QFileInfo& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(3124, (void*)this, x)) return (const QPixmap*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(3116, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(3119, (void*)this, x)) return (bool)x[0].s_bool;
