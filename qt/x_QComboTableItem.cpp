...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1384, (void*)this, x)) return (QWidget*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1396, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QComboTableItem(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 16: x_QComboTableItem::x_16(args);	break;
	case 17: delete (QComboTableItem*)xself;	break;
    }
}
