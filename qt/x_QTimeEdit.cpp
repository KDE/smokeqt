...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10883, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10863, (void*)this, x)) {
	...
	x[2].s_int = x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(10892, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10885, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(10888, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(10891, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(10869, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(10895, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10862, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
