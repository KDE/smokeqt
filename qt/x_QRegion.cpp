...
public:
	...
	x[0].s_long = (long)QRegion::Rectangle;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_long = (long)QRegion::Ellipse;
    }
	...
	x_QRegion* xret = new x_QRegion((int)x[1].s_int,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,*(QRegion::RegionType *)x[5].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QRegion* xret = new x_QRegion(*(const QRect *)x[1].s_voidp,*(QRegion::RegionType *)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
