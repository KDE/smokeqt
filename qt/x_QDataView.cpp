...
public:
	...
	x_QDataView* xret = new x_QDataView((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,(Qt::WFlags)x[3].s_int);
	...
	x_QDataView* xret = new x_QDataView((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	// QDataView(QWidget*)
	x_QDataView* xret = new x_QDataView((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	// setForm(QSqlForm*)
	this->QDataView::setForm((QSqlForm*)x[1].s_voidp);
	...
	this->QDataView::setRecord((QSqlRecord*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	// refresh(QSqlRecord*)
	this->QDataView::refresh((QSqlRecord*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1499, (void*)this, x)) return;
	this->QDataView::clearValues();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1497, (void*)this, x)) return;
	this->QDataView::readFields();
    }
    virtual void refresh(QSqlRecord* x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(1496, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(1492, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(1494, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1498, (void*)this, x)) return;
	this->QDataView::writeFields();
    }
    ~x_QDataView() {}
};
