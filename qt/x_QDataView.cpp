...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1499, (void*)this, x)) return;
	this->QDataView::clearValues();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1497, (void*)this, x)) return;
	this->QDataView::readFields();
    }
    virtual void refresh(QSqlRecord* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(1496, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(1492, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(1494, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1498, (void*)this, x)) return;
	this->QDataView::writeFields();
    }
    ~x_QDataView() { qt_Smoke->binding->deleted(61, (void*)this); }
};
