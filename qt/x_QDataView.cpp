...
public:
	...
	x_QDataView* xret = new x_QDataView((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,*(Qt::WFlags *)x[3].x_voidp);
	...
	x_QDataView* xret = new x_QDataView((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QDataView(QWidget*)
	x_QDataView* xret = new x_QDataView((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_4(xargs *x) {
	// setForm(QSqlForm*)
	this->QDataView::setForm((QSqlForm*)x[1].x_voidp);
    }
    void x_5(xargs *x) {
	// form()
	...
	this->QDataView::setRecord((QSqlRecord*)x[1].x_voidp);
    }
    void x_7(xargs *x) {
	// record()
    ...
    void x_8(xargs *x) {
	// refresh(QSqlRecord*)
	this->QDataView::refresh((QSqlRecord*)x[1].x_voidp);
    }
    void x_9(xargs *x) {
	// readFields()
...
void xcall_QDataView(xargs *x, void *s, int xi) {
    x_QDataView *xself = (x_QDataView*)s;
    switch(xi) {
	case 0: x_QDataView::x_0(x);	break;
	case 1: x_QDataView::x_1(x);	break;
	case 2: x_QDataView::x_2(x);	break;
	case 3: x_QDataView::x_3(x);	break;
