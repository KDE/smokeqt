...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5578, (void*)this, x)) return (const QPixmap*)x[0].s_class;
	return this->QListBoxPixmap::pixmap();
    }
    virtual int rtti() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5581, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5580, (void*)this, x)) return (int)x[0].s_int;
