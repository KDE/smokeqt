...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4411, x)) return (int)x[0].s_int;
	return this->QListBoxItem::height(x1);
    }
    virtual void paint(QPainter* x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	call_method_abstract((void*)this, 4423, x);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4422, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4412, x)) return (int)x[0].s_int;
