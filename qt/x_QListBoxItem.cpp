...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5298, (void*)this, x)) return (int)x[0].s_int;
	return this->QListBoxItem::height(x1);
    }
    virtual void paint(QPainter* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	qt_Smoke->binding->callMethod(5311, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual const QPixmap* pixmap() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5297, (void*)this, x)) return (const QPixmap*)x[0].s_class;
	return this->QListBoxItem::pixmap();
    }
    virtual int rtti() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5309, (void*)this, x)) return (int)x[0].s_int;
	return this->QListBoxItem::rtti();
    }
    virtual void setText(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(5312, (void*)this, x)) return;
	this->QListBoxItem::setText(x1);
    }
    virtual QString text() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5296, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5299, (void*)this, x)) return (int)x[0].s_int;
	return this->QListBoxItem::width(x1);
    }
    ~x_QListBoxItem() { qt_Smoke->binding->deleted(182, (void*)this); }
};
