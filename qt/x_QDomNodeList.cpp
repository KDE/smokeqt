...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2684, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2685, (void*)this, x)) return (uint)x[0].s_uint;
	return this->QDomNodeList::length();
    }
    ~x_QDomNodeList() { qt_Smoke->binding->deleted(89, (void*)this); }
};
