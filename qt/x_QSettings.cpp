...
public:
	...
	x[0].s_enum = (long)QSettings::Native;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_enum = (long)QSettings::Ini;
    }
	...
	x[0].s_enum = (long)QSettings::User;
    }
    static void x_6(Smoke::Stack x) {
	x[0].s_enum = (long)QSettings::Global;
    }
	...
	x_QSettings* xret = new x_QSettings((QSettings::Format)x[1].s_enum);
	x[0].s_class = (void*)xret;
    }
    x_QSettings(QSettings::Format x1) : QSettings(x1) {
    }
	...
	// setPath(const QString&, const QString&, QSettings::Scope)
	this->QSettings::setPath(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,(QSettings::Scope)x[3].s_enum);
	(void)x; // noop (for compiler warning)
    }
    void x_54(Smoke::Stack x) {
	// setPath(const QString&, const QString&)
	this->QSettings::setPath(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp);
	(void)x; // noop (for compiler warning)
    }
    void x_55(Smoke::Stack x) {
	// beginGroup(const QString&)
	this->QSettings::beginGroup(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	// resetGroup()
	this->QSettings::resetGroup();
	(void)x; // noop (for compiler warning)
    }
    void x_58(Smoke::Stack x) const {
	// group()
	QString xret = this->QSettings::group();
	x[0].s_voidp = (void*)new QString(xret);
    }
	...
	switch(xtype) {
	  ...
	  case 511: //QSettings::Scope
		...
		break;
	      case Smoke::EnumDelete:
		delete (QSettings::Scope*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QSettings::Scope*)xdata = (QSettings::Scope)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QSettings::Scope*)xdata;
		break;
	    }
	    break;
	  case 510: //QSettings::Format
		...
		break;
	      case Smoke::EnumDelete:
		delete (QSettings::Format*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QSettings::Format*)xdata = (QSettings::Format)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QSettings::Format*)xdata;
		break;
	    }
	    break;
	}
...
void xcall_QSettings(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 4: x_QSettings::x_4(args);	break;
	case 5: x_QSettings::x_5(args);	break;
	case 6: x_QSettings::x_6(args);	break;
	case 7: x_QSettings::x_7(args);	break;
	case 8: x_QSettings::x_8(args);	break;
	...
	case 59: delete (QSettings*)xself;	break;
    }
}
