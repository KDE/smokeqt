...
public:
    ...
    virtual void back() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11835, (void*)this, x)) return;
	this->QWizard::back();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11787, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[2].s_voidp = (void*)&x2;
	x[3].s_int = x3;
	if(qt_Smoke->binding->callMethod(11802, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11786, (void*)this, x)) return (QMetaObject*)x[0].s_class;
    ...
    virtual void next() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11836, (void*)this, x)) return;
	this->QWizard::next();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(11788, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(11790, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(11789, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(11791, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11799, (void*)this, x)) return;
	this->QWizard::show();
    }
