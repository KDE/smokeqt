	...
	switch(xtype) {
	  ...
	  case 818: //Qt::Key
		...
		*(Qt::Key*)xdata = (Qt::Key)xvalue;
	    ...
	    break;
	  case 817: //Qt::ImageConversionFlags
	    switch(xop) {
	      case Smoke::EnumNew:
	  ...
	  case 819: //Qt::MacintoshVersion
		...
		*(Qt::MacintoshVersion*)xdata = (Qt::MacintoshVersion)xvalue;
	    ...
	    break;
	  case 828: //Qt::StringComparisonMode
	    switch(xop) {
	      case Smoke::EnumNew:
