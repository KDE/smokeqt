...
public:
	...
	switch(xtype) {
	  ...
	  case 810: //Qt::Key
		...
		*(Qt::Key*)xdata = (Qt::Key)xvalue;
	    ...
	    break;
	  case 809: //Qt::ImageConversionFlags
	    switch(xop) {
	      case Smoke::EnumNew:
	  ...
	  case 811: //Qt::MacintoshVersion
		...
		*(Qt::MacintoshVersion*)xdata = (Qt::MacintoshVersion)xvalue;
	    ...
	    break;
	  case 820: //Qt::StringComparisonMode
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_Qt() { qt_Smoke->binding->deleted(384, (void*)this); }
};
