...
public:
	...
	x_QPushButton* xret = new x_QPushButton((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	...
	x_QPushButton* xret = new x_QPushButton(*(const QString *)x[1].s_class,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QPushButton* xret = new x_QPushButton(*(const QString *)x[1].s_class,(QWidget*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QPushButton* xret = new x_QPushButton(*(const QIconSet *)x[1].s_class,*(const QString *)x[2].s_class,(QWidget*)x[3].s_class,(const char*)x[4].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QPushButton* xret = new x_QPushButton(*(const QIconSet *)x[1].s_class,*(const QString *)x[2].s_class,(QWidget*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(6360, (void*)this, x)) return;
	this->QPushButton::drawButton(x1);
    }
    virtual void drawButtonLabel(QPainter* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(6361, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(6362, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(6363, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(385, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(6340, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(6364, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(6348, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(6350, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(6351, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6339, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6365, (void*)this, x)) return;
	this->QPushButton::updateMask();
    }
