...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7322, (void*)this, x)) return (const char*)x[0].s_class;
	return this->QProcess::className();
    }
    virtual void closeStdin() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7367, (void*)this, x)) return;
	this->QProcess::closeStdin();
    }
    virtual void connectNotify(const char* x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(7378, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7321, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(7323, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(7325, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(7326, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QProcess::qt_property(x1, x2, x3);
    }
    virtual QString readLineStderr() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7360, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7359, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7356, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7355, (void*)this, x)) {
	    QByteArray *xptr = (QByteArray *)x[0].s_class;
	    QByteArray xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7366, (void*)this, x)) return;
	this->QProcess::writeToStdin(x1);
    }
