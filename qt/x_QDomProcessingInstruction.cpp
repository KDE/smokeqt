...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2732, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2731, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2728, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomProcessingInstruction() { qt_Smoke->binding->deleted(95, (void*)this); }
};
