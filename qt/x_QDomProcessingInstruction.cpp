...
public:
	...
	x_QDomProcessingInstruction* xret = new x_QDomProcessingInstruction(*(const QDomProcessingInstruction *)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	QDomProcessingInstruction& xret = this->QDomProcessingInstruction::operator=(*(const QDomProcessingInstruction *)x[1].s_voidp);
	x[0].s_voidp = (void*)&xret;
    }
