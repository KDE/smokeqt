...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12487, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12486, (void*)this, x)) return;
	this->QXmlInputSource::fetchData();
    }
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(12493, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    virtual QChar next() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12488, (void*)this, x)) {
    ...
    virtual void reset() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12489, (void*)this, x)) return;
	this->QXmlInputSource::reset();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(12484, (void*)this, x)) return;
	this->QXmlInputSource::setData(x1);
    }
    ~x_QXmlInputSource() { qt_Smoke->binding->deleted(384, (void*)this); }
};
