...
public:
	...
	x_QDockArea* xret = new x_QDockArea((Qt::Orientation)x[1].s_enum,(QDockArea::HandlePosition)x[2].s_enum,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp);
	...
	x_QDockArea* xret = new x_QDockArea((Qt::Orientation)x[1].s_enum,(QDockArea::HandlePosition)x[2].s_enum,(QWidget*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
