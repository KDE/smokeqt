...
public:
	...
	x[0].x_long = (long)QDockArea::Normal;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QDockArea::Reverse;
    }
    static void x_2(xargs *x) {
	// QDockArea(Qt::Orientation, QDockArea::HandlePosition, QWidget*, const char*)
	x_QDockArea* xret = new x_QDockArea((Qt::Orientation)x[1].x_long,(QDockArea::HandlePosition)x[2].x_long,(QWidget*)x[3].x_voidp,(const char*)x[4].x_voidp);
	...
	x_QDockArea* xret = new x_QDockArea((Qt::Orientation)x[1].x_long,(QDockArea::HandlePosition)x[2].x_long,(QWidget*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QDockArea* xret = new x_QDockArea((Qt::Orientation)x[1].x_long,(QDockArea::HandlePosition)x[2].x_long);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QDockArea* xret = new x_QDockArea((Qt::Orientation)x[1].x_long);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QDockArea::moveDockWindow((QDockWindow*)x[1].x_voidp,*(const QPoint *)x[2].x_voidp,*(const QRect *)x[3].x_voidp,(bool)x[4].x_bool);
    }
    void x_7(xargs *x) {
	// removeDockWindow(QDockWindow*, bool, bool, bool)
	this->QDockArea::removeDockWindow((QDockWindow*)x[1].x_voidp,(bool)x[2].x_bool,(bool)x[3].x_bool,(bool)x[4].x_bool);
    }
    void x_8(xargs *x) {
	// removeDockWindow(QDockWindow*, bool, bool)
	this->QDockArea::removeDockWindow((QDockWindow*)x[1].x_voidp,(bool)x[2].x_bool,(bool)x[3].x_bool);
    }
    void x_9(xargs *x) {
	// moveDockWindow(QDockWindow*, int)
	this->QDockArea::moveDockWindow((QDockWindow*)x[1].x_voidp,(int)x[2].x_int);
    }
    void x_10(xargs *x) {
	// moveDockWindow(QDockWindow*)
	this->QDockArea::moveDockWindow((QDockWindow*)x[1].x_voidp);
    }
    void x_11(xargs *x) {
	// hasDockWindow(QDockWindow*, int*)
	bool xret = this->QDockArea::hasDockWindow((QDockWindow*)x[1].x_voidp,(int*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_12(xargs *x) {
	// hasDockWindow(QDockWindow*)
	bool xret = this->QDockArea::hasDockWindow((QDockWindow*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_13(xargs *x) {
	// invalidNextOffset(QDockWindow*)
	this->QDockArea::invalidNextOffset((QDockWindow*)x[1].x_voidp);
    }
	...
	bool xret = this->QDockArea::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
	...
	bool xret = this->QDockArea::isDockWindowAccepted((QDockWindow*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_21(xargs *x) {
	// setAcceptDockWindow(QDockWindow*, bool)
	this->QDockArea::setAcceptDockWindow((QDockWindow*)x[1].x_voidp,(bool)x[2].x_bool);
    }
    void x_22(xargs *x) {
	// lineUp(bool)
	this->QDockArea::lineUp((bool)x[1].x_bool);
    }
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 1889, x)) return (bool)x[0].x_bool;
...
void xcall_QDockArea(xargs *x, void *s, int xi) {
    x_QDockArea *xself = (x_QDockArea*)s;
    switch(xi) {
	case 0: x_QDockArea::x_0(x);	break;
	case 1: x_QDockArea::x_1(x);	break;
	case 2: x_QDockArea::x_2(x);	break;
	case 3: x_QDockArea::x_3(x);	break;
	case 4: x_QDockArea::x_4(x);	break;
	case 5: x_QDockArea::x_5(x);	break;
