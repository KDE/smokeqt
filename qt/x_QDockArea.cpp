...
public:
	...
	x_QDockArea* xret = new x_QDockArea(*(Qt::Orientation *)x[1].s_class,*(QDockArea::HandlePosition *)x[2].s_class,(QWidget*)x[3].s_class,(const char*)x[4].s_class);
	...
	x_QDockArea* xret = new x_QDockArea(*(Qt::Orientation *)x[1].s_class,*(QDockArea::HandlePosition *)x[2].s_class,(QWidget*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDockArea* xret = new x_QDockArea(*(Qt::Orientation *)x[1].s_class,*(QDockArea::HandlePosition *)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDockArea* xret = new x_QDockArea(*(Qt::Orientation *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	bool xret = this->QDockArea::hasDockWindow((QDockWindow*)x[1].s_class,(int*)x[2].s_class);
	...
	x[0].s_class = (void*)new QDockArea::HandlePosition(xret);
    }
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->callMethod(1897, (void*)this, x)) return (bool)x[0].s_bool;
