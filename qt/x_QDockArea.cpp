...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2294, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(2315, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2293, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(2295, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(2297, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(2296, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(2298, (void*)this, x)) return (bool)x[0].s_bool;
	...
	switch(xtype) {
	  case 133: //QDockArea::HandlePosition
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QDockArea() { qt_Smoke->binding->deleted(74, (void*)this); }
};
