...
public:
	...
	x_QDnsSocket* xret = new x_QDnsSocket((QObject*)x[1].x_voidp,(const char*)x[2].x_voidp);
...
void xcall_QDnsSocket(xargs *x, void *s, int xi) {
    x_QDnsSocket *xself = (x_QDnsSocket*)s;
    switch(xi) {
	case 0: x_QDnsSocket::x_0(x);	break;
    }
}
