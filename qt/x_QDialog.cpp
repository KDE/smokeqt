...
public:
	...
	x[0].x_long = (long)QDialog::Rejected;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QDialog::Accepted;
    }
    static void x_2(xargs *x) {
	// QDialog(QWidget*, const char*, bool, Qt::WFlags)
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,(bool)x[3].x_bool,*(Qt::WFlags *)x[4].x_voidp);
	...
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,(bool)x[3].x_bool);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QDialog(QWidget*)
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_10(xargs *x) {
	// move(int, int)
	this->QDialog::move((int)x[1].x_int,(int)x[2].x_int);
    }
    void x_11(xargs *x) {
	// move(const QPoint&)
	this->QDialog::move(*(const QPoint *)x[1].x_voidp);
    }
    void x_12(xargs *x) {
	// resize(int, int)
	this->QDialog::resize((int)x[1].x_int,(int)x[2].x_int);
    }
    void x_13(xargs *x) {
	// resize(const QSize&)
	this->QDialog::resize(*(const QSize *)x[1].x_voidp);
    }
    void x_14(xargs *x) {
	// setGeometry(int, int, int, int)
	this->QDialog::setGeometry((int)x[1].x_int,(int)x[2].x_int,(int)x[3].x_int,(int)x[4].x_int);
    }
    void x_15(xargs *x) {
	// setGeometry(const QRect&)
	this->QDialog::setGeometry(*(const QRect *)x[1].x_voidp);
    }
    void x_16(xargs *x) {
	// setOrientation(Qt::Orientation)
	this->QDialog::setOrientation((Qt::Orientation)x[1].x_long);
    }
	...
	this->QDialog::setExtension((QWidget*)x[1].x_voidp);
    }
	...
	this->QDialog::setSizeGripEnabled((bool)x[1].x_bool);
    }
    ...
    void x_25(xargs *x) {
	// setResult(int)
	this->QDialog::setResult((int)x[1].x_int);
    }
    void x_26(xargs *x) {
	// keyPressEvent(QKeyEvent*)
	this->QDialog::keyPressEvent((QKeyEvent*)x[1].x_voidp);
    }
    void x_27(xargs *x) {
	// closeEvent(QCloseEvent*)
	this->QDialog::closeEvent((QCloseEvent*)x[1].x_voidp);
    }
    void x_28(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QDialog::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_29(xargs *x) {
	// contextMenuEvent(QContextMenuEvent*)
	this->QDialog::contextMenuEvent((QContextMenuEvent*)x[1].x_voidp);
    }
    void x_30(xargs *x) {
	// eventFilter(QObject*, QEvent*)
	bool xret = this->QDialog::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_31(xargs *x) {
	// adjustPosition(QWidget*)
	this->QDialog::adjustPosition((QWidget*)x[1].x_voidp);
    }
    void x_32(xargs *x) {
	// done(int)
	this->QDialog::done((int)x[1].x_int);
    }
    void x_33(xargs *x) {
	// accept()
	this->QDialog::accept();
    ...
    void x_35(xargs *x) {
	// showExtension(bool)
	this->QDialog::showExtension((bool)x[1].x_bool);
    }
    virtual void accept() {
	xargs x[1];
...
void xcall_QDialog(xargs *x, void *s, int xi) {
    x_QDialog *xself = (x_QDialog*)s;
    switch(xi) {
	case 0: x_QDialog::x_0(x);	break;
	case 1: x_QDialog::x_1(x);	break;
	case 2: x_QDialog::x_2(x);	break;
	case 3: x_QDialog::x_3(x);	break;
	case 4: x_QDialog::x_4(x);	break;
	case 5: x_QDialog::x_5(x);	break;
	case 6: x_QDialog::x_6(x);	break;
	...
	case 36: delete (QDialog*)xself;	break;
    }
}
