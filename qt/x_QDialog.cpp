...
public:
	...
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].s_class,(const char*)x[2].s_class,(bool)x[3].s_bool,*(Qt::WFlags *)x[4].s_class);
	...
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].s_class,(const char*)x[2].s_class,(bool)x[3].s_bool);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDialog* xret = new x_QDialog((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
