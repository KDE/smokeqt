...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4125, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_ulong = x1;
	if(qt_Smoke->binding->callMethod(4126, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void flush() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4123, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual int getch() {
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4135, (void*)this, x, true /*pure virtual*/);
	return (int)x[0].s_int;
	// ABSTRACT
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_long = x2;
	qt_Smoke->binding->callMethod(4129, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4124, (void*)this, x, true /*pure virtual*/);
	QIODevice::Offset *xptr = (QIODevice::Offset *)x[0].s_class;
	QIODevice::Offset xret(*xptr);
	delete xptr;
	return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4136, (void*)this, x, true /*pure virtual*/);
	return (int)x[0].s_int;
	// ABSTRACT
    }
    ...
    ~x_QIODevice() { qt_Smoke->binding->deleted(149, (void*)this); }
};
