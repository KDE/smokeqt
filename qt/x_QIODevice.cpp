...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4381, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_ulong = x1;
	if(qt_Smoke->binding->callMethod(4382, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void close() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4378, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual void flush() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4379, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual int getch() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4390, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4377, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4391, (void*)this, x, true /*pure virtual*/);
	return (int)x[0].s_int;
	// ABSTRACT
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_long = x2;
	qt_Smoke->binding->callMethod(4385, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4380, (void*)this, x, true /*pure virtual*/);
	QIODevice::Offset *xptr = (QIODevice::Offset *)x[0].s_class;
	QIODevice::Offset xret(*xptr);
	delete xptr;
	return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4392, (void*)this, x, true /*pure virtual*/);
	return (int)x[0].s_int;
	// ABSTRACT
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_long = x2;
	qt_Smoke->binding->callMethod(4386, (void*)this, x, true /*pure virtual*/);
	Q_LONG *xptr = (Q_LONG *)x[0].s_class;
	Q_LONG xret(*xptr);
	delete xptr;
	return xret;
    ...
    ~x_QIODevice() { qt_Smoke->binding->deleted(154, (void*)this); }
};
