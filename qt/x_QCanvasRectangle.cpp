...
public:
	...
	x_QCanvasRectangle* xret = new x_QCanvasRectangle((QCanvas*)x[1].x_voidp);
	...
	x_QCanvasRectangle* xret = new x_QCanvasRectangle(*(const QRect *)x[1].x_voidp,(QCanvas*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QCanvasRectangle* xret = new x_QCanvasRectangle((int)x[1].x_int,(int)x[2].x_int,(int)x[3].x_int,(int)x[4].x_int,(QCanvas*)x[5].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_5(xargs *x) {
	// setSize(int, int)
	this->QCanvasRectangle::setSize((int)x[1].x_int,(int)x[2].x_int);
    }
	...
	bool xret = this->QCanvasRectangle::collidesWith((const QCanvasItem*)x[1].x_voidp);
    ...
    void x_11(xargs *x) {
	// drawShape(QPainter&)
	this->QCanvasRectangle::drawShape(*(QPainter *)x[1].x_voidp);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 632, x)) return (bool)x[0].x_bool;
	...
	xargs x[1];
	if(call_method((void*)this, 633, x)) return (int)x[0].x_int;
...
void xcall_QCanvasRectangle(xargs *x, void *s, int xi) {
    x_QCanvasRectangle *xself = (x_QCanvasRectangle*)s;
    switch(xi) {
	case 0: x_QCanvasRectangle::x_0(x);	break;
	case 1: x_QCanvasRectangle::x_1(x);	break;
	case 2: x_QCanvasRectangle::x_2(x);	break;
