...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(795, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(797, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(798, (void*)this, x)) return (int)x[0].s_int;
    ...
    ~x_QCanvasRectangle() { qt_Smoke->binding->deleted(29, (void*)this); }
};
