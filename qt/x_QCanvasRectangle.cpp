...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(635, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(637, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(638, (void*)this, x)) return (int)x[0].s_int;
