...
public:
	...
	x_QCanvasRectangle* xret = new x_QCanvasRectangle(*(QCanvasRectangle *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QCanvasRectangle(QCanvasRectangle& x1) : QCanvasRectangle(x1) {
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(771, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(773, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(776, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(774, (void*)this, x)) return (int)x[0].s_int;
...
void xcall_QCanvasRectangle(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 11: x_QCanvasRectangle::x_11(args);	break;
	case 12: xself->x_12(args);	break;
	case 13: xself->x_13(args);	break;
	case 14: delete (QCanvasRectangle*)xself;	break;
    }
}
