...
public:
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(1328, (void*)this, x, true /*pure virtual*/);
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = x2;
	qt_Smoke->binding->callMethod(1329, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    ~x_QDataSource() { qt_Smoke->binding->deleted(58, (void*)this); }
};
