...
public:
	...
	// setFont(const QFont&)
	QWhatsThis::setFont(*(const QFont *)x[1].s_class);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11846, (void*)this, x)) {
    ...
    ~x_QWhatsThis() { qt_Smoke->binding->deleted(363, (void*)this); }
};
void xcall_QWhatsThis(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 19: x_QWhatsThis::x_19(args);	break;
	case 20: delete (QWhatsThis*)xself;	break;
    }
}
