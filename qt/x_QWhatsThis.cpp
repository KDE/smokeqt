...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11848, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QWhatsThis::clicked(x1);
    }
    virtual QString text(const QPoint& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(11847, (void*)this, x)) {
    ...
    ~x_QWhatsThis() { qt_Smoke->binding->deleted(364, (void*)this); }
};
