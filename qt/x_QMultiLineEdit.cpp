...
public:
	...
	x_QMultiLineEdit* xret = new x_QMultiLineEdit((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QMultiLineEdit* xret = new x_QMultiLineEdit((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(5307, (void*)this, x)) return;
	this->QMultiLineEdit::backspace();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5305, (void*)this, x)) return;
	...
	x[1].s_bool = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->callMethod(5297, (void*)this, x)) return;
	...
	x[1].s_bool = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->callMethod(5300, (void*)this, x)) return;
	this->QMultiLineEdit::cursorRight(x1, x2);
    }
    virtual void cursorUp(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5303, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5310, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5308, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->callMethod(5290, (void*)this, x)) return;
	...
	x[3].s_int = x3;
	x[4].s_bool = x4;
	if(qt_Smoke->callMethod(5267, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_int = x2;
	if(qt_Smoke->callMethod(5265, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(5292, (void*)this, x)) return;
	this->QMultiLineEdit::killLine();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(5291, (void*)this, x)) return;
	this->QMultiLineEdit::newLine();
    }
    virtual void pageDown(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5295, (void*)this, x)) return;
	this->QMultiLineEdit::pageDown(x1);
    }
    virtual void pageUp(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5293, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->callMethod(5269, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->callMethod(5274, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(5283, (void*)this, x)) return;
	...
	x[2].s_int = x2;
	x[3].s_bool = x3;
	if(qt_Smoke->callMethod(5270, (void*)this, x)) return;
...
void xcall_QMultiLineEdit(Smoke::Index xi, void *obj, Smoke::Stack args) {
    ...
    switch(xi) {
	case 0: x_QMultiLineEdit::x_0(args);	break;
	case 1: x_QMultiLineEdit::x_1(args);	break;
	case 2: x_QMultiLineEdit::x_2(args);	break;
