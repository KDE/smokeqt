...
public:
	...
	x_QMultiLineEdit* xret = new x_QMultiLineEdit((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	...
	bool xret = this->QMultiLineEdit::getMarkedRegion((int*)x[1].s_class,(int*)x[2].s_class,(int*)x[3].s_class,(int*)x[4].s_class);
	x[0].s_bool = (bool)xret;
    }
