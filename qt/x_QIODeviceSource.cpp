...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4378, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4380, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QIODeviceSource() { qt_Smoke->binding->deleted(154, (void*)this); }
};
