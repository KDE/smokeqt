...
public:
	...
	x[0].s_long = (long)QDropEvent::Copy;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_long = (long)QDropEvent::Link;
    }
    static void x_2(Smoke::Stack x) {
	x[0].s_long = (long)QDropEvent::Move;
    }
    static void x_3(Smoke::Stack x) {
	x[0].s_long = (long)QDropEvent::Private;
    }
    static void x_4(Smoke::Stack x) {
	x[0].s_long = (long)QDropEvent::UserAction;
    }
    static void x_5(Smoke::Stack x) {
	// QDropEvent(const QPoint&, QEvent::Type)
	x_QDropEvent* xret = new x_QDropEvent(*(const QPoint *)x[1].s_voidp,*(QEvent::Type *)x[2].s_voidp);
	...
	this->QDropEvent::setAction(*(QDropEvent::Action *)x[1].s_voidp);
    }
    void x_16(Smoke::Stack x) const {
	// action()
	QDropEvent::Action xret = this->QDropEvent::action();
	x[0].s_voidp = (void*)new QDropEvent::Action(xret);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 2339, x)) 	return (const char*)x[0].s_voidp;
	return this->QDropEvent::format(x1);
    }
    virtual bool provides(const char* x1) const {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 2342, x)) return (bool)x[0].s_bool;
