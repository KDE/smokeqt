...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(2822, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2820, (void*)this, x)) return (const char*)x[0].s_class;
    ...
    ~x_QDropEvent() { qt_Smoke->binding->deleted(100, (void*)this); }
};
