...
public:
	...
	x_QDomDocumentFragment* xret = new x_QDomDocumentFragment(*(const QDomDocumentFragment *)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	QDomDocumentFragment& xret = this->QDomDocumentFragment::operator=(*(const QDomDocumentFragment *)x[1].s_voidp);
	x[0].s_voidp = (void*)&xret;
    }
