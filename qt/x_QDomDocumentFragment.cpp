...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2515, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2514, (void*)this, x)) {
    ...
    ~x_QDomDocumentFragment() { qt_Smoke->binding->deleted(81, (void*)this); }
};
