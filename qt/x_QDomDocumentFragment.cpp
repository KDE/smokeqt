...
public:
	...
	x_QDomDocumentFragment* xret = new x_QDomDocumentFragment(*(const QDomDocumentFragment *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	QDomDocumentFragment& xret = this->QDomDocumentFragment::operator=(*(const QDomDocumentFragment *)x[1].x_voidp);
	x[0].x_voidp = (void*)&xret;
    }
	...
	xargs x[1];
	if(call_method((void*)this, 2077, x)) return (bool)x[0].x_bool;
	...
	xargs x[1];
	if(call_method((void*)this, 2076, x)) return (QDomNode::NodeType)x[0].x_long;
    ...
    ~x_QDomDocumentFragment() {}
};
void xcall_QDomDocumentFragment(xargs *x, void *s, int xi) {
    x_QDomDocumentFragment *xself = (x_QDomDocumentFragment*)s;
    switch(xi) {
	case 0: x_QDomDocumentFragment::x_0(x);	break;
	case 1: x_QDomDocumentFragment::x_1(x);	break;
