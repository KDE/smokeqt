...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2697, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2696, (void*)this, x)) {
    ...
    ~x_QDomNotation() { qt_Smoke->binding->deleted(90, (void*)this); }
};
