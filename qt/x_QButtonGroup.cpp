...
public:
	...
	x_QButtonGroup* xret = new x_QButtonGroup((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QButtonGroup* xret = new x_QButtonGroup((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,(QWidget*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QButtonGroup* xret = new x_QButtonGroup((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,*(const QString *)x[3].s_voidp,(QWidget*)x[4].s_voidp,(const char*)x[5].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QButtonGroup* xret = new x_QButtonGroup((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,*(const QString *)x[3].s_voidp,(QWidget*)x[4].s_voidp);
	x[0].s_class = (void*)xret;
    }
