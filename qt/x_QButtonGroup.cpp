...
public:
	...
	// event(QEvent*)
	bool xret = this->QButtonGroup::event((QEvent*)x[1].s_class);
	x[0].s_bool = xret;
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(512, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(511, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(513, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(515, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(514, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(516, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QButtonGroup() { qt_Smoke->binding->deleted(18, (void*)this); }
};
void xcall_QButtonGroup(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 45: delete (QButtonGroup*)xself;	break;
    }
}
