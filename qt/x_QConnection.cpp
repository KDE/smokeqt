...
public:
	...
	x_QConnection* xret = new x_QConnection((const QObject*)x[1].s_class,(int)x[2].s_int,(const char*)x[3].s_voidp,(int)x[4].s_int);
    ...
    ~x_QConnection() { qt_Smoke->binding->deleted(50, (void*)this); }
};
