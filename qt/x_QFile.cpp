...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2988, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_ulong = x1;
	if(qt_Smoke->binding->callMethod(2989, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QFile::at(x1);
    }
    virtual bool atEnd() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2990, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QFile::atEnd();
    }
    virtual void close() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2985, (void*)this, x)) return;
	this->QFile::close();
    }
    virtual void flush() {
	Smoke::StackItem x[1];
    ...
    virtual int getch() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2996, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2997, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_long = x2;
	if(qt_Smoke->binding->callMethod(2991, (void*)this, x)) {
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_long = x2;
	if(qt_Smoke->binding->callMethod(2994, (void*)this, x)) {
	    Q_LONG *xptr = (Q_LONG *)x[0].s_class;
	    Q_LONG xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2987, (void*)this, x)) {
	    QIODevice::Offset *xptr = (QIODevice::Offset *)x[0].s_class;
	    QIODevice::Offset xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2998, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_long = x2;
	if(qt_Smoke->binding->callMethod(2992, (void*)this, x)) {
	    Q_LONG *xptr = (Q_LONG *)x[0].s_class;
	    Q_LONG xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QFile() { qt_Smoke->binding->deleted(111, (void*)this); }
};
