...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7987, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7986, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	return this->QServerSocket::metaObject();
    }
    virtual void newConnection(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(8010, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(7988, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(8008, (void*)this, x)) return;
