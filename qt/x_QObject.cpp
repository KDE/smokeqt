...
public:
	...
	// setUserData(uint, QObjectUserData*)
	this->QObject::setUserData((uint)x[1].s_uint,(QObjectUserData*)x[2].s_class);
	(void)x; // noop (for compiler warning)
    }
    void x_49(Smoke::Stack x) const {
	// userData(uint)
	QObjectUserData* xret = this->QObject::userData((uint)x[1].s_uint);
	x[0].s_class = (void*)xret;
    }
	...
	// disconnectInternal(const QObject*, int, const QObject*, int, int)
	bool xret = QObject::disconnectInternal((const QObject*)x[1].s_class,(int)x[2].s_int,(const QObject*)x[3].s_class,(int)x[4].s_int,(int)x[5].s_int);
	x[0].s_bool = xret;
    }
    static void x_64(Smoke::Stack x) {
	// registerUserData()
	uint xret = QObject::registerUserData();
	x[0].s_uint = xret;
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6631, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6630, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(6632, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(6634, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(6635, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QObject() { qt_Smoke->binding->deleted(216, (void*)this); }
};
void xcall_QObject(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 81: x_QObject::x_81(args);	break;
	case 82: delete (QObject*)xself;	break;
    }
}
