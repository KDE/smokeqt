...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2039, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_double = x1;
	if(qt_Smoke->binding->callMethod(2035, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(2056, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(2055, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2038, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
