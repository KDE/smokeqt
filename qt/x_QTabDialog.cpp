...
public:
	...
	x_QTabDialog* xret = new x_QTabDialog((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,(bool)x[3].x_bool,*(Qt::WFlags *)x[4].x_voidp);
	...
	x_QTabDialog* xret = new x_QTabDialog((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,(bool)x[3].x_bool);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QTabDialog* xret = new x_QTabDialog((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QTabDialog(QWidget*)
	x_QTabDialog* xret = new x_QTabDialog((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_6(xargs *x) {
	// setFont(const QFont&)
	this->QTabDialog::setFont(*(const QFont *)x[1].x_voidp);
    }
    void x_7(xargs *x) {
	// addTab(QWidget*, const QString&)
	this->QTabDialog::addTab((QWidget*)x[1].x_voidp,*(const QString *)x[2].x_voidp);
    }
    void x_8(xargs *x) {
	// addTab(QWidget*, const QIconSet&, const QString&)
	this->QTabDialog::addTab((QWidget*)x[1].x_voidp,*(const QIconSet *)x[2].x_voidp,*(const QString *)x[3].x_voidp);
    }
    void x_9(xargs *x) {
	// addTab(QWidget*, QTab*)
	this->QTabDialog::addTab((QWidget*)x[1].x_voidp,(QTab*)x[2].x_voidp);
    }
    void x_10(xargs *x) {
	// insertTab(QWidget*, const QString&, int)
	this->QTabDialog::insertTab((QWidget*)x[1].x_voidp,*(const QString *)x[2].x_voidp,(int)x[3].x_int);
    }
    void x_11(xargs *x) {
	// insertTab(QWidget*, const QString&)
	this->QTabDialog::insertTab((QWidget*)x[1].x_voidp,*(const QString *)x[2].x_voidp);
    }
    void x_12(xargs *x) {
	// insertTab(QWidget*, const QIconSet&, const QString&, int)
	this->QTabDialog::insertTab((QWidget*)x[1].x_voidp,*(const QIconSet *)x[2].x_voidp,*(const QString *)x[3].x_voidp,(int)x[4].x_int);
    }
    void x_13(xargs *x) {
	// insertTab(QWidget*, const QIconSet&, const QString&)
	this->QTabDialog::insertTab((QWidget*)x[1].x_voidp,*(const QIconSet *)x[2].x_voidp,*(const QString *)x[3].x_voidp);
    }
    void x_14(xargs *x) {
	// insertTab(QWidget*, QTab*, int)
	this->QTabDialog::insertTab((QWidget*)x[1].x_voidp,(QTab*)x[2].x_voidp,(int)x[3].x_int);
    }
    void x_15(xargs *x) {
	// insertTab(QWidget*, QTab*)
	this->QTabDialog::insertTab((QWidget*)x[1].x_voidp,(QTab*)x[2].x_voidp);
    }
    void x_16(xargs *x) {
	// changeTab(QWidget*, const QString&)
	this->QTabDialog::changeTab((QWidget*)x[1].x_voidp,*(const QString *)x[2].x_voidp);
    }
    void x_17(xargs *x) {
	// changeTab(QWidget*, const QIconSet&, const QString&)
	this->QTabDialog::changeTab((QWidget*)x[1].x_voidp,*(const QIconSet *)x[2].x_voidp,*(const QString *)x[3].x_voidp);
    }
    void x_18(xargs *x) const {
	// isTabEnabled(QWidget*)
	bool xret = this->QTabDialog::isTabEnabled((QWidget*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_19(xargs *x) {
	// setTabEnabled(QWidget*, bool)
	this->QTabDialog::setTabEnabled((QWidget*)x[1].x_voidp,(bool)x[2].x_bool);
    }
    void x_20(xargs *x) const {
	// isTabEnabled(const char*)
	bool xret = this->QTabDialog::isTabEnabled((const char*)x[1].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_21(xargs *x) {
	// setTabEnabled(const char*, bool)
	this->QTabDialog::setTabEnabled((const char*)x[1].x_voidp,(bool)x[2].x_bool);
    }
    void x_22(xargs *x) {
	// showPage(QWidget*)
	this->QTabDialog::showPage((QWidget*)x[1].x_voidp);
    }
    void x_23(xargs *x) {
	// removePage(QWidget*)
	this->QTabDialog::removePage((QWidget*)x[1].x_voidp);
    }
    void x_24(xargs *x) {
	// tabLabel(QWidget*)
	QString xret = this->QTabDialog::tabLabel((QWidget*)x[1].x_voidp);
	...
	this->QTabDialog::setDefaultButton(*(const QString *)x[1].x_voidp);
    }
    void x_27(xargs *x) {
	// setDefaultButton()
	...
	this->QTabDialog::setHelpButton(*(const QString *)x[1].x_voidp);
    }
    void x_30(xargs *x) {
	// setHelpButton()
	...
	this->QTabDialog::setCancelButton(*(const QString *)x[1].x_voidp);
    }
    void x_33(xargs *x) {
	// setCancelButton()
	...
	this->QTabDialog::setApplyButton(*(const QString *)x[1].x_voidp);
    }
    void x_36(xargs *x) {
	// setApplyButton()
	...
	this->QTabDialog::setOKButton(*(const QString *)x[1].x_voidp);
    }
    void x_39(xargs *x) {
	// setOKButton()
	...
	this->QTabDialog::currentChanged((QWidget*)x[1].x_voidp);
    }
    void x_49(xargs *x) {
	// selected(const QString&)
	this->QTabDialog::selected(*(const QString *)x[1].x_voidp);
    }
    void x_50(xargs *x) {
	// paintEvent(QPaintEvent*)
	this->QTabDialog::paintEvent((QPaintEvent*)x[1].x_voidp);
    }
    void x_51(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QTabDialog::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_52(xargs *x) {
	// styleChange(QStyle&)
	this->QTabDialog::styleChange(*(QStyle *)x[1].x_voidp);
    }
    void x_53(xargs *x) {
	// setTabBar(QTabBar*)
	this->QTabDialog::setTabBar((QTabBar*)x[1].x_voidp);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 8148, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 8103, x)) return;
    ...
    virtual void show() {
	xargs x[1];
	if(call_method((void*)this, 8102, x)) return;
	this->QTabDialog::show();
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 8149, x)) return;
...
void xcall_QTabDialog(xargs *x, void *s, int xi) {
    x_QTabDialog *xself = (x_QTabDialog*)s;
    switch(xi) {
	case 0: x_QTabDialog::x_0(x);	break;
	case 1: x_QTabDialog::x_1(x);	break;
	case 2: x_QTabDialog::x_2(x);	break;
	case 3: x_QTabDialog::x_3(x);	break;
	case 4: x_QTabDialog::x_4(x);	break;
