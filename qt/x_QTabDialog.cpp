...
public:
	...
	x_QTabDialog* xret = new x_QTabDialog((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,(bool)x[3].s_bool,(Qt::WFlags)x[4].s_int);
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(8217, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(8218, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->callMethod(8219, (void*)this, x)) return;
