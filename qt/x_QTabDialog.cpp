...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10129, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10128, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10130, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(10131, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10141, (void*)this, x)) return;
	this->QTabDialog::show();
    }
    ...
    ~x_QTabDialog() { qt_Smoke->binding->deleted(317, (void*)this); }
};
