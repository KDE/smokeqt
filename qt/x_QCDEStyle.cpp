...
public:
	...
	x[6].s_int = x6;
	x[7].s_class = (void*)&x7;
	if(qt_Smoke->binding->callMethod(438, (void*)this, x)) return;
	...
	x[5].s_int = x5;
	x[6].s_class = (void*)&x6;
	if(qt_Smoke->binding->callMethod(441, (void*)this, x)) return;
	...
	x[1].s_enum = x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(436, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_enum = x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(5188, (void*)this, x)) {
	    QRect *xptr = (QRect *)x[0].s_class;
	    QRect xret(*xptr);
	    delete xptr;
	    return xret;
