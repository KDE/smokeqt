...
public:
	...
	x[0].x_long = (long)QLCDNumber::Hex;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QLCDNumber::Dec;
    }
    static void x_2(xargs *x) {
	x[0].x_long = (long)QLCDNumber::Oct;
    }
    static void x_3(xargs *x) {
	x[0].x_long = (long)QLCDNumber::Bin;
    }
	...
	x[0].x_long = (long)QLCDNumber::Outline;
    }
    static void x_9(xargs *x) {
	x[0].x_long = (long)QLCDNumber::Filled;
    }
    static void x_10(xargs *x) {
	x[0].x_long = (long)QLCDNumber::Flat;
    }
    static void x_11(xargs *x) {
	// QLCDNumber(QWidget*, const char*)
	x_QLCDNumber* xret = new x_QLCDNumber((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QLCDNumber(QWidget*)
	x_QLCDNumber* xret = new x_QLCDNumber((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QLCDNumber* xret = new x_QLCDNumber((uint)x[1].x_uint,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QLCDNumber* xret = new x_QLCDNumber((uint)x[1].x_uint,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QLCDNumber(uint)
	x_QLCDNumber* xret = new x_QLCDNumber((uint)x[1].x_uint);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_19(xargs *x) {
	// setNumDigits(int)
	this->QLCDNumber::setNumDigits((int)x[1].x_int);
    }
    void x_20(xargs *x) const {
	// checkOverflow(double)
	bool xret = this->QLCDNumber::checkOverflow((double)x[1].x_double);
	x[0].x_bool = (bool)xret;
    }
    void x_21(xargs *x) const {
	// checkOverflow(int)
	bool xret = this->QLCDNumber::checkOverflow((int)x[1].x_int);
	x[0].x_bool = (bool)xret;
    }
	...
	this->QLCDNumber::setMode((QLCDNumber::Mode)x[1].x_long);
    }
	...
	this->QLCDNumber::setSegmentStyle((QLCDNumber::SegmentStyle)x[1].x_long);
    }
	...
	this->QLCDNumber::display(*(const QString *)x[1].x_voidp);
    }
    void x_30(xargs *x) {
	// display(int)
	this->QLCDNumber::display((int)x[1].x_int);
    }
    void x_31(xargs *x) {
	// display(double)
	this->QLCDNumber::display((double)x[1].x_double);
    }
    void x_32(xargs *x) {
	// setHexMode()
	...
	this->QLCDNumber::setSmallDecimalPoint((bool)x[1].x_bool);
    }
    void x_37(xargs *x) {
	// overflow()
	...
	this->QLCDNumber::drawContents((QPainter*)x[1].x_voidp);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 4017, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 4014, x)) return;
	this->QLCDNumber::setBinMode();
    }
	...
	xargs x[2];
	x[1].x_int = (int)x1;
	if(call_method((void*)this, 3998, x)) return;
	...
	xargs x[2];
	x[1].x_long = (long)x1;
	if(call_method((void*)this, 4004, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 4007, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QLCDNumber(xargs *x, void *s, int xi) {
    x_QLCDNumber *xself = (x_QLCDNumber*)s;
    switch(xi) {
	case 0: x_QLCDNumber::x_0(x);	break;
	case 1: x_QLCDNumber::x_1(x);	break;
	case 2: x_QLCDNumber::x_2(x);	break;
	case 3: x_QLCDNumber::x_3(x);	break;
	case 4: x_QLCDNumber::x_4(x);	break;
	case 5: x_QLCDNumber::x_5(x);	break;
	case 6: x_QLCDNumber::x_6(x);	break;
	case 7: x_QLCDNumber::x_7(x);	break;
	case 8: x_QLCDNumber::x_8(x);	break;
	case 9: x_QLCDNumber::x_9(x);	break;
	case 10: x_QLCDNumber::x_10(x);	break;
	case 11: x_QLCDNumber::x_11(x);	break;
	case 12: x_QLCDNumber::x_12(x);	break;
	case 13: x_QLCDNumber::x_13(x);	break;
	case 14: x_QLCDNumber::x_14(x);	break;
	case 15: x_QLCDNumber::x_15(x);	break;
	case 16: x_QLCDNumber::x_16(x);	break;
