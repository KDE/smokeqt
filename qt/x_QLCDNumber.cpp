...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4794, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4793, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(4795, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(4797, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(4796, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(4798, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4825, (void*)this, x)) return;
	this->QLCDNumber::setBinMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4823, (void*)this, x)) return;
	this->QLCDNumber::setDecMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4822, (void*)this, x)) return;
	this->QLCDNumber::setHexMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(4813, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(4809, (void*)this, x)) return;
	this->QLCDNumber::setNumDigits(x1);
    }
    virtual void setOctMode() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4824, (void*)this, x)) return;
	this->QLCDNumber::setOctMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(4815, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(4826, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4818, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 367: //QLCDNumber::Mode
		...
		*(QLCDNumber::Mode*)xdata = (QLCDNumber::Mode)xvalue;
	    ...
	    break;
	  case 368: //QLCDNumber::SegmentStyle
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QLCDNumber() { qt_Smoke->binding->deleted(171, (void*)this); }
};
