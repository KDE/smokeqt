...
public:
	...
	x_QLCDNumber* xret = new x_QLCDNumber((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	...
	x_QLCDNumber* xret = new x_QLCDNumber((uint)x[1].s_uint,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x[0].s_class = (void*)new QLCDNumber::Mode(xret);
    }
	...
	x[0].s_class = (void*)new QLCDNumber::SegmentStyle(xret);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(4019, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4016, (void*)this, x)) return;
	this->QLCDNumber::setBinMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4014, (void*)this, x)) return;
	this->QLCDNumber::setDecMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4013, (void*)this, x)) return;
	this->QLCDNumber::setHexMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(qt_Smoke->callMethod(4000, (void*)this, x)) return;
	this->QLCDNumber::setNumDigits(x1);
    }
    virtual void setOctMode() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4015, (void*)this, x)) return;
	this->QLCDNumber::setOctMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(4017, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4009, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
