...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(4009, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4006, (void*)this, x)) return;
	this->QLCDNumber::setBinMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4004, (void*)this, x)) return;
	this->QLCDNumber::setDecMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4003, (void*)this, x)) return;
	this->QLCDNumber::setHexMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->callMethod(3994, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->callMethod(3990, (void*)this, x)) return;
	this->QLCDNumber::setNumDigits(x1);
    }
    virtual void setOctMode() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4005, (void*)this, x)) return;
	this->QLCDNumber::setOctMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->callMethod(3996, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->callMethod(4007, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3999, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
