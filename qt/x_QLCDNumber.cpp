...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(2937, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4004, (void*)this, x)) return;
	this->QLCDNumber::setDecMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(4007, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3999, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QLCDNumber(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 11: x_QLCDNumber::x_11(args);	break;
	case 12: x_QLCDNumber::x_12(args);	break;
	case 13: x_QLCDNumber::x_13(args);	break;
	case 14: x_QLCDNumber::x_14(args);	break;
	case 15: x_QLCDNumber::x_15(args);	break;
	case 16: x_QLCDNumber::x_16(args);	break;
	...
	case 39: delete (QLCDNumber*)xself;	break;
    }
}
