...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4008, x)) return;
	this->QLCDNumber::setBinMode();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4006, x)) return;
	this->QLCDNumber::setDecMode();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4005, x)) return;
	this->QLCDNumber::setHexMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 3992, x)) return;
	this->QLCDNumber::setNumDigits(x1);
    }
    virtual void setOctMode() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4007, x)) return;
	this->QLCDNumber::setOctMode();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4001, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
