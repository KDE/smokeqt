...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5092, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5131, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5091, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(5093, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(5095, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(5094, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5123, (void*)this, x)) return;
	this->QLCDNumber::setBinMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5121, (void*)this, x)) return;
	this->QLCDNumber::setDecMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5120, (void*)this, x)) return;
	this->QLCDNumber::setHexMode();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5122, (void*)this, x)) return;
	this->QLCDNumber::setOctMode();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(5124, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5116, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 338: //QLCDNumber::Mode
		...
		*(QLCDNumber::Mode*)xdata = (QLCDNumber::Mode)xvalue;
	    ...
	    break;
	  case 339: //QLCDNumber::SegmentStyle
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QLCDNumber() { qt_Smoke->binding->deleted(179, (void*)this); }
};
