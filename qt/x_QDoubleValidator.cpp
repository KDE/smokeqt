...
public:
	...
	x_QDoubleValidator* xret = new x_QDoubleValidator((QObject*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QDoubleValidator* xret = new x_QDoubleValidator((QObject*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDoubleValidator* xret = new x_QDoubleValidator((double)x[1].s_double,(double)x[2].s_double,(int)x[3].s_int,(QObject*)x[4].s_voidp,(const char*)x[5].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDoubleValidator* xret = new x_QDoubleValidator((double)x[1].s_double,(double)x[2].s_double,(int)x[3].s_int,(QObject*)x[4].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x[2].s_double = x2;
	x[3].s_int = x3;
	if(qt_Smoke->callMethod(2288, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->callMethod(2287, (void*)this, x)) {
