...
public:
	...
	bool xret = this->QScrollView::isHorizontalSliderPressed();
	x[0].s_bool = xret;
    }
    void x_71(Smoke::Stack x) {
	// isVerticalSliderPressed()
	bool xret = this->QScrollView::isVerticalSliderPressed();
	x[0].s_bool = xret;
    }
	...
	this->QScrollView::disableSizeHintCaching();
	(void)x; // noop (for compiler warning)
    }
	...
	this->QScrollView::horizontalSliderPressed();
	(void)x; // noop (for compiler warning)
    }
    void x_86(Smoke::Stack x) {
	// horizontalSliderReleased()
	this->QScrollView::horizontalSliderReleased();
	(void)x; // noop (for compiler warning)
    }
    void x_87(Smoke::Stack x) {
	// verticalSliderPressed()
	this->QScrollView::verticalSliderPressed();
	(void)x; // noop (for compiler warning)
    }
    void x_88(Smoke::Stack x) {
	// verticalSliderReleased()
	this->QScrollView::verticalSliderReleased();
	(void)x; // noop (for compiler warning)
    }
	...
	// setCachedSizeHint(const QSize&)
	this->QScrollView::setCachedSizeHint(*(const QSize *)x[1].s_class);
	(void)x; // noop (for compiler warning)
    }
    void x_136(Smoke::Stack x) const {
	// cachedSizeHint()
	QSize xret = this->QScrollView::cachedSizeHint();
	x[0].s_class = (void*)new QSize(xret);
    }
    void x_137(Smoke::Stack x) {
	// fontChange(const QFont&)
	this->QScrollView::fontChange(*(const QFont *)x[1].s_class);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7986, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7985, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(7987, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(7989, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(7988, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(7990, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8046, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 498: //QScrollView::ResizePolicy
	    switch(xop) {
	      case Smoke::EnumNew:
		...
		*(QScrollView::ResizePolicy*)xdata = (QScrollView::ResizePolicy)xvalue;
	    ...
	    break;
	  case 499: //QScrollView::ScrollBarMode
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QScrollView() { qt_Smoke->binding->deleted(253, (void*)this); }
};
...
void xcall_QScrollView(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 89: x_QScrollView::x_89(args);	break;
	case 90: x_QScrollView::x_90(args);	break;
	case 91: x_QScrollView::x_91(args);	break;
	case 92: x_QScrollView::x_92(args);	break;
	case 93: x_QScrollView::x_93(args);	break;
	...
	case 138: delete (QScrollView*)xself;	break;
    }
}
