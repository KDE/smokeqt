...
public:
	...
	x_QVGroupBox* xret = new x_QVGroupBox((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	// QVGroupBox(QWidget*)
	x_QVGroupBox* xret = new x_QVGroupBox((QWidget*)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QVGroupBox* xret = new x_QVGroupBox(*(const QString *)x[1].s_voidp,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QVGroupBox* xret = new x_QVGroupBox(*(const QString *)x[1].s_voidp,(QWidget*)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
