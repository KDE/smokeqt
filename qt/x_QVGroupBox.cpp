...
public:
	...
	x_QVGroupBox* xret = new x_QVGroupBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QVGroupBox(QWidget*)
	x_QVGroupBox* xret = new x_QVGroupBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QVGroupBox* xret = new x_QVGroupBox(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QVGroupBox* xret = new x_QVGroupBox(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QVGroupBox* xret = new x_QVGroupBox(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QVGroupBox(xargs *x, void *s, int xi) {
    x_QVGroupBox *xself = (x_QVGroupBox*)s;
    switch(xi) {
	case 0: x_QVGroupBox::x_0(x);	break;
	case 1: x_QVGroupBox::x_1(x);	break;
	case 2: x_QVGroupBox::x_2(x);	break;
	case 3: x_QVGroupBox::x_3(x);	break;
	case 4: x_QVGroupBox::x_4(x);	break;
	case 5: x_QVGroupBox::x_5(x);	break;
