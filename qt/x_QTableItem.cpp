...
public:
	...
	x[0].s_class = (void*)new int(QTableItem::RTTI);
    }
    static void x_5(Smoke::Stack x) {
	// QTableItem(QTable*, QTableItem::EditType, const QString&)
	x_QTableItem* xret = new x_QTableItem((QTable*)x[1].s_class,(QTableItem::EditType)x[2].s_enum,*(const QString *)x[3].s_voidp);
	...
	x_QTableItem* xret = new x_QTableItem((QTable*)x[1].s_class,(QTableItem::EditType)x[2].s_enum,*(const QString *)x[3].s_voidp,*(const QPixmap *)x[4].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	// QTableItem(const QTableItem&)
	x_QTableItem* xret = new x_QTableItem(*(const QTableItem *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QTableItem(const QTableItem& x1) : QTableItem(x1) {
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10287, (void*)this, x)) return (QWidget*)x[0].s_class;
	...
	switch(xtype) {
	  case 647: //QTableItem::EditType
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QTableItem::EditType;
		break;
	      case Smoke::EnumDelete:
		delete (QTableItem::EditType*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QTableItem::EditType*)xdata = (QTableItem::EditType)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QTableItem::EditType*)xdata;
		break;
	    }
	    break;
	}
    }
    ~x_QTableItem() { qt_Smoke->binding->deleted(315, (void*)this); }
};
void xenum_QTableItem(Smoke::EnumOperation xop, Smoke::Index xtype, void *&xdata, long &xvalue) {
    x_QTableItem::xenum_operation(xop, xtype, xdata, xvalue);
}
void xcall_QTableItem(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 6: x_QTableItem::x_6(args);	break;
	...
	case 34: x_QTableItem::x_34(args);	break;
	case 35: delete (QTableItem*)xself;	break;
    }
}
