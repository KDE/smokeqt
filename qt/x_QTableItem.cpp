...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10466, (void*)this, x)) return (QWidget*)x[0].s_class;
	...
	x[3].s_class = (void*)&x3;
	x[4].s_bool = x4;
	if(qt_Smoke->binding->callMethod(10479, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10483, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(10467, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10471, (void*)this, x)) {
    ...
    ~x_QTableItem() { qt_Smoke->binding->deleted(321, (void*)this); }
};
