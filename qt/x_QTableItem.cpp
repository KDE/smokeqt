...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10463, (void*)this, x)) return (QWidget*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10480, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10468, (void*)this, x)) {
