...
public:
	...
	x_QCanvasPixmapArray* xret = new x_QCanvasPixmapArray(*(const QString *)x[1].s_class,(int)x[2].s_int);
	x[0].s_class = (void*)xret;
    }
	...
	x_QCanvasPixmapArray* xret = new x_QCanvasPixmapArray(*(const QString *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QCanvasPixmapArray* xret = new x_QCanvasPixmapArray(*(QPtrList<QPixmap> *)x[1].s_class,*(QPtrList<QPoint> *)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QCanvasPixmapArray* xret = new x_QCanvasPixmapArray(*(QValueList<QPixmap> *)x[1].s_class,*(QPointArray *)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QCanvasPixmapArray* xret = new x_QCanvasPixmapArray(*(QValueList<QPixmap> *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	bool xret = this->QCanvasPixmapArray::readPixmaps(*(const QString *)x[1].s_class,(int)x[2].s_int);
	x[0].s_bool = (bool)xret;
    }
    void x_7(Smoke::Stack x) {
	// readPixmaps(const QString&)
	bool xret = this->QCanvasPixmapArray::readPixmaps(*(const QString *)x[1].s_class);
	x[0].s_bool = (bool)xret;
    }
    void x_8(Smoke::Stack x) {
	// readCollisionMasks(const QString&)
	bool xret = this->QCanvasPixmapArray::readCollisionMasks(*(const QString *)x[1].s_class);
	x[0].s_bool = (bool)xret;
    }
