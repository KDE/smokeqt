...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->binding->callMethod(4809, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual void end() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4808, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    virtual void frameDone() {
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(4810, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	qt_Smoke->binding->callMethod(4811, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4813, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4812, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	qt_Smoke->binding->callMethod(4814, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
    ~x_QImageConsumer() { qt_Smoke->binding->deleted(163, (void*)this); }
};
