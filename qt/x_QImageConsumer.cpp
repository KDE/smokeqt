...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4793, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	qt_Smoke->binding->callMethod(4792, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	qt_Smoke->binding->callMethod(4794, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
