...
public:
	...
	x_QWidget* xret = new x_QWidget((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,(Qt::WFlags)x[3].s_int);
	...
	this->QWidget::reparent((QWidget*)x[1].s_voidp,(Qt::WFlags)x[2].s_int,*(const QPoint *)x[3].s_voidp,(bool)x[4].s_bool);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_141(Smoke::Stack x) {
	// reparent(QWidget*, Qt::WFlags, const QPoint&)
	this->QWidget::reparent((QWidget*)x[1].s_voidp,(Qt::WFlags)x[2].s_int,*(const QPoint *)x[3].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QWidget::recreate((QWidget*)x[1].s_voidp,(Qt::WFlags)x[2].s_int,*(const QPoint *)x[3].s_voidp,(bool)x[4].s_bool);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_145(Smoke::Stack x) {
	// recreate(QWidget*, Qt::WFlags, const QPoint&)
	this->QWidget::recreate((QWidget*)x[1].s_voidp,(Qt::WFlags)x[2].s_int,*(const QPoint *)x[3].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
