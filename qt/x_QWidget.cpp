...
public:
	...
	x[0].s_enum = (long)QWidget::AncestorOrigin;
    }
	...
	// isShown()
	bool xret = this->QWidget::isShown();
	x[0].s_bool = xret;
    }
	...
	// isFullScreen()
	bool xret = this->QWidget::isFullScreen();
	x[0].s_bool = xret;
    }
	...
	// setSizePolicy(QSizePolicy::SizeType, QSizePolicy::SizeType, bool)
	this->QWidget::setSizePolicy((QSizePolicy::SizeType)x[1].s_enum,(QSizePolicy::SizeType)x[2].s_enum,(bool)x[3].s_bool);
	(void)x; // noop (for compiler warning)
    }
    void x_147(Smoke::Stack x) {
	// setSizePolicy(QSizePolicy::SizeType, QSizePolicy::SizeType)
	this->QWidget::setSizePolicy((QSizePolicy::SizeType)x[1].s_enum,(QSizePolicy::SizeType)x[2].s_enum);
	(void)x; // noop (for compiler warning)
    }
    void x_148(Smoke::Stack x) const {
	// heightForWidth(int)
	...
	// backgroundOffset()
	QPoint xret = this->QWidget::backgroundOffset();
	x[0].s_class = (void*)new QPoint(xret);
    }
	...
	// setShown(bool)
	this->QWidget::setShown((bool)x[1].s_bool);
	(void)x; // noop (for compiler warning)
    }
    void x_208(Smoke::Stack x) {
	// setHidden(bool)
	this->QWidget::setHidden((bool)x[1].s_bool);
	(void)x; // noop (for compiler warning)
    }
    ...
    void x_215(Smoke::Stack x) const {
	// constPolish()
    ...
    void x_279(Smoke::Stack x) const {
	// getWState()
    ...
    void x_282(Smoke::Stack x) const {
	// getWFlags()
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11893, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11892, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(11894, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(11896, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(11895, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(11897, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(12026, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 749: //QWidget::FocusPolicy
		...
		*(QWidget::FocusPolicy*)xdata = (QWidget::FocusPolicy)xvalue;
	    ...
	    break;
	  case 748: //QWidget::BackgroundOrigin
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QWidget() { qt_Smoke->binding->deleted(365, (void*)this); }
};
...
void xcall_QWidget(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 19: x_QWidget::x_19(args);	break;
	...
	case 229: x_QWidget::x_229(args);	break;
	case 230: x_QWidget::x_230(args);	break;
	case 231: x_QWidget::x_231(args);	break;
	case 232: x_QWidget::x_232(args);	break;
	case 233: x_QWidget::x_233(args);	break;
	case 234: x_QWidget::x_234(args);	break;
	case 235: x_QWidget::x_235(args);	break;
	case 236: x_QWidget::x_236(args);	break;
	...
	case 285: xself->x_285(args);	break;
	case 286: xself->x_286(args);	break;
	case 287: xself->x_287(args);	break;
	case 288: xself->x_288(args);	break;
	case 289: xself->x_289(args);	break;
	case 290: xself->x_290(args);	break;
	case 291: xself->x_291(args);	break;
	case 292: xself->x_292(args);	break;
	case 293: delete (QWidget*)xself;	break;
    }
}
