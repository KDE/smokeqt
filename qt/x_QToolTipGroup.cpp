...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10743, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10742, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(10744, (void*)this, x)) return (void*)x[0].s_voidp;
    ...
    ~x_QToolTipGroup() { qt_Smoke->binding->deleted(334, (void*)this); }
};
