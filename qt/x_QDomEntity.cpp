...
public:
	...
	x_QDomEntity* xret = new x_QDomEntity(*(const QDomEntity *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	QDomEntity& xret = this->QDomEntity::operator=(*(const QDomEntity *)x[1].x_voidp);
	x[0].x_voidp = (void*)&xret;
    }
	...
	xargs x[1];
	if(call_method((void*)this, 2130, x)) return (bool)x[0].x_bool;
	...
	xargs x[1];
	if(call_method((void*)this, 2129, x)) return (QDomNode::NodeType)x[0].x_long;
...
void xcall_QDomEntity(xargs *x, void *s, int xi) {
    x_QDomEntity *xself = (x_QDomEntity*)s;
    switch(xi) {
	case 0: x_QDomEntity::x_0(x);	break;
	case 1: x_QDomEntity::x_1(x);	break;
