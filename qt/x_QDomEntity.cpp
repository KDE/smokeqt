...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2570, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2568, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QDomEntity() { qt_Smoke->binding->deleted(84, (void*)this); }
};
