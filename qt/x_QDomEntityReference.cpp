...
public:
	...
	x_QDomEntityReference* xret = new x_QDomEntityReference(*(const QDomEntityReference *)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	QDomEntityReference& xret = this->QDomEntityReference::operator=(*(const QDomEntityReference *)x[1].s_voidp);
	x[0].s_voidp = (void*)&xret;
    }
