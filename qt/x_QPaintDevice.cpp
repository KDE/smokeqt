...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(6935, (void*)this, x)) return (int)x[0].s_int;
    ...
    ~x_QPaintDevice() { qt_Smoke->binding->deleted(227, (void*)this); }
};
