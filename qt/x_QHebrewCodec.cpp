...
public:
	...
	QCString xret = this->QHebrewCodec::fromUnicode(*(const QString *)x[1].s_class,*(int *)x[2].s_class);
	x[0].s_class = (void*)new QCString(xret);
    }
    void x_4(Smoke::Stack x) const {
	// toUnicode(const char*, int)
	QString xret = this->QHebrewCodec::toUnicode((const char*)x[1].s_class,(int)x[2].s_int);
	x[0].s_class = (void*)new QString(xret);
    }
    void x_5(Smoke::Stack x) const {
	// heuristicContentMatch(const char*, int)
	int xret = this->QHebrewCodec::heuristicContentMatch((const char*)x[1].s_class,(int)x[2].s_int);
	x[0].s_int = (int)xret;
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(3327, (void*)this, x)) {
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(3329, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3324, (void*)this, x)) return (int)x[0].s_int;
	return this->QHebrewCodec::mibEnum();
    }
    virtual const char* mimeName() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3326, (void*)this, x)) return (const char*)x[0].s_class;
	return this->QHebrewCodec::mimeName();
    }
    virtual const char* name() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3325, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(3328, (void*)this, x)) {
