...
public:
	...
	// QHebrewCodec(const QHebrewCodec&)
	x_QHebrewCodec* xret = new x_QHebrewCodec(*(const QHebrewCodec *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QHebrewCodec(const QHebrewCodec& x1) : QHebrewCodec(x1) {
    }
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(4052, (void*)this, x)) {
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(4054, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(10114, (void*)this, x)) return (QTextDecoder*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4049, (void*)this, x)) return (int)x[0].s_int;
	return this->QHebrewCodec::mibEnum();
    }
    virtual const char* mimeName() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4051, (void*)this, x)) return (const char*)x[0].s_class;
	return this->QHebrewCodec::mimeName();
    }
    virtual const char* name() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(4050, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(4053, (void*)this, x)) {
    ...
    ~x_QHebrewCodec() { qt_Smoke->binding->deleted(144, (void*)this); }
};
void xcall_QHebrewCodec(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 7: x_QHebrewCodec::x_7(args);	break;
	case 8: delete (QHebrewCodec*)xself;	break;
    }
}
