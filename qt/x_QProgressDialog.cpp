...
public:
	...
	x_QProgressDialog* xret = new x_QProgressDialog((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,(bool)x[3].s_bool,(Qt::WFlags)x[4].s_int);
	...
	x_QProgressDialog* xret = new x_QProgressDialog(*(const QString *)x[1].s_voidp,*(const QString *)x[2].s_voidp,(int)x[3].s_int,(QWidget*)x[4].s_voidp,(const char*)x[5].s_voidp,(bool)x[6].s_bool,(Qt::WFlags)x[7].s_int);
	x[0].s_class = (void*)xret;
    }
