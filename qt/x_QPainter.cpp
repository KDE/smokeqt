...
public:
	...
	x[0].s_class = (void*)new Qt::BGMode(xret);
    }
	...
	x[0].s_class = (void*)new Qt::RasterOp(xret);
    }
	...
	QRegion xret = this->QPainter::clipRegion(*(QPainter::CoordinateMode *)x[1].s_class);
	...
	QRect xret = this->QPainter::boundingRect((int)x[1].s_int,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,(int)x[5].s_int,*(const QString *)x[6].s_class,(int)x[7].s_int,(QTextParag**)x[8].s_class);
	x[0].s_class = (void*)new QRect(xret);
    }
    void x_180(Smoke::Stack x) {
	// boundingRect(int, int, int, int, int, const QString&, int)
	QRect xret = this->QPainter::boundingRect((int)x[1].s_int,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,(int)x[5].s_int,*(const QString *)x[6].s_class,(int)x[7].s_int);
	x[0].s_class = (void*)new QRect(xret);
    }
	...
	QRect xret = this->QPainter::boundingRect(*(const QRect *)x[1].s_class,(int)x[2].s_int,*(const QString *)x[3].s_class,(int)x[4].s_int,(QTextParag**)x[5].s_class);
	x[0].s_class = (void*)new QRect(xret);
    }
    void x_183(Smoke::Stack x) {
	// boundingRect(const QRect&, int, const QString&, int)
	QRect xret = this->QPainter::boundingRect(*(const QRect *)x[1].s_class,(int)x[2].s_int,*(const QString *)x[3].s_class,(int)x[4].s_int);
	x[0].s_class = (void*)new QRect(xret);
    }
