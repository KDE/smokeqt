...
public:
	...
	// QMotifStyle(bool)
	x_QMotifStyle* xret = new x_QMotifStyle((bool)x[1].x_bool);
	...
	this->QMotifStyle::setUseHighlightColors((bool)x[1].x_bool);
    }
    ...
    void x_4(xargs *x) {
	// polish(QPalette&)
	this->QMotifStyle::polish(*(QPalette *)x[1].x_voidp);
    }
    void x_5(xargs *x) {
	// polish(QWidget*)
	this->QMotifStyle::polish((QWidget*)x[1].x_voidp);
    }
    void x_6(xargs *x) {
	// polish(QApplication*)
	this->QMotifStyle::polish((QApplication*)x[1].x_voidp);
    }
    void x_7(xargs *x) {
	// polishPopupMenu(QPopupMenu*)
	this->QMotifStyle::polishPopupMenu((QPopupMenu*)x[1].x_voidp);
    }
	...
	this->QMotifStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].x_long,(QPainter*)x[2].x_voidp,*(const QRect *)x[3].x_voidp,*(const QColorGroup *)x[4].x_voidp,*(QStyle::SFlags *)x[5].x_voidp,*(const QStyleOption *)x[6].x_voidp);
    }
    void x_9(xargs *x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QMotifStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].x_long,(QPainter*)x[2].x_voidp,*(const QRect *)x[3].x_voidp,*(const QColorGroup *)x[4].x_voidp,*(QStyle::SFlags *)x[5].x_voidp);
    }
    void x_10(xargs *x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&)
	this->QMotifStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].x_long,(QPainter*)x[2].x_voidp,*(const QRect *)x[3].x_voidp,*(const QColorGroup *)x[4].x_voidp);
    }
	...
	this->QMotifStyle::drawControl((QStyle::ControlElement)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(const QStyleOption *)x[7].x_voidp);
    }
	...
	this->QMotifStyle::drawControl((QStyle::ControlElement)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp);
    }
    void x_13(xargs *x) const {
	// drawControl(QStyle::ControlElement, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QMotifStyle::drawControl((QStyle::ControlElement)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp);
    }
	...
	this->QMotifStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(QStyle::SCFlags *)x[7].x_voidp,*(QStyle::SCFlags *)x[8].x_voidp,*(const QStyleOption *)x[9].x_voidp);
    }
	...
	this->QMotifStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(QStyle::SCFlags *)x[7].x_voidp,*(QStyle::SCFlags *)x[8].x_voidp);
    }
	...
	this->QMotifStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp,*(QStyle::SCFlags *)x[7].x_voidp);
    }
	...
	this->QMotifStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp,*(QStyle::SFlags *)x[6].x_voidp);
    }
    void x_18(xargs *x) const {
	// drawComplexControl(QStyle::ComplexControl, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QMotifStyle::drawComplexControl((QStyle::ComplexControl)x[1].x_long,(QPainter*)x[2].x_voidp,(const QWidget*)x[3].x_voidp,*(const QRect *)x[4].x_voidp,*(const QColorGroup *)x[5].x_voidp);
    }
    void x_19(xargs *x) const {
	// querySubControlMetrics(QStyle::ComplexControl, const QWidget*, QStyle::SubControl, const QStyleOption&)
	QRect xret = this->QMotifStyle::querySubControlMetrics((QStyle::ComplexControl)x[1].x_long,(const QWidget*)x[2].x_voidp,(QStyle::SubControl)x[3].x_long,*(const QStyleOption *)x[4].x_voidp);
	...
	QRect xret = this->QMotifStyle::querySubControlMetrics((QStyle::ComplexControl)x[1].x_long,(const QWidget*)x[2].x_voidp,(QStyle::SubControl)x[3].x_long);
	x[0].x_voidp = (void*)new QRect(xret);
    }
    void x_21(xargs *x) const {
	// pixelMetric(QStyle::PixelMetric, const QWidget*)
	int xret = this->QMotifStyle::pixelMetric((QStyle::PixelMetric)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_22(xargs *x) const {
	// pixelMetric(QStyle::PixelMetric)
	int xret = this->QMotifStyle::pixelMetric((QStyle::PixelMetric)x[1].x_long);
	x[0].x_int = (int)xret;
    }
    void x_23(xargs *x) const {
	// sizeFromContents(QStyle::ContentsType, const QWidget*, const QSize&, const QStyleOption&)
	QSize xret = this->QMotifStyle::sizeFromContents((QStyle::ContentsType)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QSize *)x[3].x_voidp,*(const QStyleOption *)x[4].x_voidp);
	x[0].x_voidp = (void*)new QSize(xret);
    }
    void x_24(xargs *x) const {
	// sizeFromContents(QStyle::ContentsType, const QWidget*, const QSize&)
	QSize xret = this->QMotifStyle::sizeFromContents((QStyle::ContentsType)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QSize *)x[3].x_voidp);
	x[0].x_voidp = (void*)new QSize(xret);
    }
    void x_25(xargs *x) const {
	// subRect(QStyle::SubRect, const QWidget*)
	QRect xret = this->QMotifStyle::subRect((QStyle::SubRect)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)new QRect(xret);
    }
    void x_26(xargs *x) const {
	// stylePixmap(QStyle::StylePixmap, const QWidget*, const QStyleOption&)
	QPixmap xret = this->QMotifStyle::stylePixmap((QStyle::StylePixmap)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QStyleOption *)x[3].x_voidp);
	x[0].x_voidp = (void*)new QPixmap(xret);
    }
    void x_27(xargs *x) const {
	// stylePixmap(QStyle::StylePixmap, const QWidget*)
	QPixmap xret = this->QMotifStyle::stylePixmap((QStyle::StylePixmap)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)new QPixmap(xret);
    }
    void x_28(xargs *x) const {
	// stylePixmap(QStyle::StylePixmap)
	QPixmap xret = this->QMotifStyle::stylePixmap((QStyle::StylePixmap)x[1].x_long);
	x[0].x_voidp = (void*)new QPixmap(xret);
    }
    void x_29(xargs *x) const {
	// styleHint(QStyle::StyleHint, const QWidget*, const QStyleOption&, QStyleHintReturn*)
	int xret = this->QMotifStyle::styleHint((QStyle::StyleHint)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QStyleOption *)x[3].x_voidp,(QStyleHintReturn*)x[4].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_30(xargs *x) const {
	// styleHint(QStyle::StyleHint, const QWidget*, const QStyleOption&)
	int xret = this->QMotifStyle::styleHint((QStyle::StyleHint)x[1].x_long,(const QWidget*)x[2].x_voidp,*(const QStyleOption *)x[3].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_31(xargs *x) const {
	// styleHint(QStyle::StyleHint, const QWidget*)
	int xret = this->QMotifStyle::styleHint((QStyle::StyleHint)x[1].x_long,(const QWidget*)x[2].x_voidp);
	x[0].x_int = (int)xret;
    }
	...
	x[6].x_voidp = (void*)&x6;
	x[7].x_voidp = (void*)&x7;
	if(call_method((void*)this, 5180, x)) return;
	...
	x[1].x_long = (long)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 5190, x)) return (int)x[0].x_int;
...
void xcall_QMotifStyle(xargs *x, void *s, int xi) {
    x_QMotifStyle *xself = (x_QMotifStyle*)s;
    switch(xi) {
	case 0: x_QMotifStyle::x_0(x);	break;
	case 1: x_QMotifStyle::x_1(x);	break;
