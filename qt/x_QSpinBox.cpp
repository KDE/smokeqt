...
public:
	...
	x[0].x_long = (long)QSpinBox::UpDownArrows;
    }
    static void x_1(xargs *x) {
	x[0].x_long = (long)QSpinBox::PlusMinus;
    }
    static void x_2(xargs *x) {
	// QSpinBox(QWidget*, const char*)
	x_QSpinBox* xret = new x_QSpinBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QSpinBox(QWidget*)
	x_QSpinBox* xret = new x_QSpinBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSpinBox* xret = new x_QSpinBox((int)x[1].x_int,(int)x[2].x_int,(int)x[3].x_int,(QWidget*)x[4].x_voidp,(const char*)x[5].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSpinBox* xret = new x_QSpinBox((int)x[1].x_int,(int)x[2].x_int,(int)x[3].x_int,(QWidget*)x[4].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSpinBox* xret = new x_QSpinBox((int)x[1].x_int,(int)x[2].x_int,(int)x[3].x_int);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QSpinBox(int, int)
	x_QSpinBox* xret = new x_QSpinBox((int)x[1].x_int,(int)x[2].x_int);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QSpinBox::setSpecialValueText(*(const QString *)x[1].x_voidp);
    }
    ...
    void x_15(xargs *x) {
	// setWrapping(bool)
	this->QSpinBox::setWrapping((bool)x[1].x_bool);
    }
	...
	this->QSpinBox::setButtonSymbols((QSpinBox::ButtonSymbols)x[1].x_long);
    }
	...
	this->QSpinBox::setValidator((const QValidator*)x[1].x_voidp);
    }
    ...
    void x_25(xargs *x) {
	// setMinValue(int)
	this->QSpinBox::setMinValue((int)x[1].x_int);
    }
    void x_26(xargs *x) {
	// setMaxValue(int)
	this->QSpinBox::setMaxValue((int)x[1].x_int);
    }
    ...
    void x_28(xargs *x) {
	// setLineStep(int)
	this->QSpinBox::setLineStep((int)x[1].x_int);
    }
    ...
    void x_32(xargs *x) {
	// setValue(int)
	this->QSpinBox::setValue((int)x[1].x_int);
    }
    void x_33(xargs *x) {
	// setPrefix(const QString&)
	this->QSpinBox::setPrefix(*(const QString *)x[1].x_voidp);
    }
    void x_34(xargs *x) {
	// setSuffix(const QString&)
	this->QSpinBox::setSuffix(*(const QString *)x[1].x_voidp);
    }
    void x_35(xargs *x) {
	// stepUp()
    ...
    void x_37(xargs *x) {
	// setEnabled(bool)
	this->QSpinBox::setEnabled((bool)x[1].x_bool);
    }
    void x_38(xargs *x) {
	// selectAll()
    ...
    void x_39(xargs *x) {
	// valueChanged(int)
	this->QSpinBox::valueChanged((int)x[1].x_int);
    }
    void x_40(xargs *x) {
	// valueChanged(const QString&)
	this->QSpinBox::valueChanged(*(const QString *)x[1].x_voidp);
    }
    void x_41(xargs *x) {
	// mapValueToText(int)
	QString xret = this->QSpinBox::mapValueToText((int)x[1].x_int);
	x[0].x_voidp = (void*)new QString(xret);
    }
    void x_42(xargs *x) {
	// mapTextToValue(bool*)
	int xret = this->QSpinBox::mapTextToValue((bool*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_43(xargs *x) {
	// currentValueText()
	...
	bool xret = this->QSpinBox::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	x[0].x_bool = (bool)xret;
    }
    void x_50(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QSpinBox::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_51(xargs *x) {
	// wheelEvent(QWheelEvent*)
	this->QSpinBox::wheelEvent((QWheelEvent*)x[1].x_voidp);
    }
    void x_52(xargs *x) {
	// leaveEvent(QEvent*)
	this->QSpinBox::leaveEvent((QEvent*)x[1].x_voidp);
    }
    void x_53(xargs *x) {
	// styleChange(QStyle&)
	this->QSpinBox::styleChange(*(QStyle *)x[1].x_voidp);
    }
    void x_54(xargs *x) {
	// textChanged()
	...
	xargs x[1];
	if(call_method((void*)this, 7115, x)) {
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 7152, x)) return (bool)x[0].x_bool;
	...
	xargs x[1];
	if(call_method((void*)this, 7125, x)) {
	...
	xargs x[1];
	if(call_method((void*)this, 7141, x)) return;
	this->QSpinBox::selectAll();
    }
	...
	xargs x[2];
	x[1].x_bool = (bool)x1;
	if(call_method((void*)this, 7140, x)) return;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 7122, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 7124, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 7156, x)) return;
	this->QSpinBox::styleChange(x1);
    }
    virtual QString suffix() const {
	xargs x[1];
	if(call_method((void*)this, 7114, x)) {
	    QString *xptr = (QString *)x[0].x_voidp;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	xargs x[1];
	if(call_method((void*)this, 7147, x)) return;
	this->QSpinBox::updateDisplay();
    }
	...
	xargs x[1];
	if(call_method((void*)this, 7150, x)) return;
	this->QSpinBox::valueChange();
    }
...
void xcall_QSpinBox(xargs *x, void *s, int xi) {
    x_QSpinBox *xself = (x_QSpinBox*)s;
    switch(xi) {
	case 0: x_QSpinBox::x_0(x);	break;
	case 1: x_QSpinBox::x_1(x);	break;
	case 2: x_QSpinBox::x_2(x);	break;
	case 3: x_QSpinBox::x_3(x);	break;
	case 4: x_QSpinBox::x_4(x);	break;
	case 5: x_QSpinBox::x_5(x);	break;
	case 6: x_QSpinBox::x_6(x);	break;
	case 7: x_QSpinBox::x_7(x);	break;
	case 8: x_QSpinBox::x_8(x);	break;
