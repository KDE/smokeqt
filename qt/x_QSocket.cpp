...
public:
	...
	x[0].s_long = (long)QSocket::ErrConnectionRefused;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::ErrHostNotFound;
    }
    static void x_2(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::ErrSocketRead;
    }
    static void x_3(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::Idle;
    }
    static void x_4(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::HostLookup;
    }
    static void x_5(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::Connecting;
    }
    static void x_6(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::Connected;
    }
    static void x_7(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::Closing;
    }
    static void x_8(Smoke::Stack x) {
	x[0].s_long = (long)QSocket::Connection;
    }
	...
	x[0].s_voidp = (void*)new QSocket::State(xret);
    }
	...
	this->QSocket::connectToHost(*(const QString *)x[1].s_voidp,*(Q_UINT16 *)x[2].s_voidp);
    }
	...
	// at(QIODevice::Offset)
	bool xret = this->QSocket::at(*(QIODevice::Offset *)x[1].s_voidp);
	x[0].s_bool = (bool)xret;
    }
	...
	x[0].s_voidp = (void*)new Q_ULONG(xret);
    }
	...
	Q_LONG xret = this->QSocket::readBlock((char*)x[1].s_voidp,*(Q_ULONG *)x[2].s_voidp);
	x[0].s_voidp = (void*)new Q_LONG(xret);
    }
    void x_30(Smoke::Stack x) {
	// writeBlock(const char*, Q_ULONG)
	Q_LONG xret = this->QSocket::writeBlock((const char*)x[1].s_voidp,*(Q_ULONG *)x[2].s_voidp);
	x[0].s_voidp = (void*)new Q_LONG(xret);
    }
    void x_31(Smoke::Stack x) {
	// readLine(char*, Q_ULONG)
	Q_LONG xret = this->QSocket::readLine((char*)x[1].s_voidp,*(Q_ULONG *)x[2].s_voidp);
	x[0].s_voidp = (void*)new Q_LONG(xret);
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6977, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 6978, x)) return (bool)x[0].s_bool;
	return this->QSocket::at(x1);
    }
    virtual bool atEnd() const {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6979, x)) return (bool)x[0].s_bool;
    ...
    virtual void close() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6974, x)) return;
	this->QSocket::close();
    }
    ...
    virtual void flush() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6975, x)) return;
	this->QSocket::flush();
    }
    virtual int getch() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6986, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6973, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6987, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(call_method((void*)this, 6983, x)) {
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6990, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6968, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 6976, x)) {
	    QIODevice::Offset *xptr = (QIODevice::Offset *)x[0].s_voidp;
	    QIODevice::Offset xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(call_method((void*)this, 7002, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 6988, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)&x2;
	if(call_method((void*)this, 6984, x)) {
	    Q_LONG *xptr = (Q_LONG *)x[0].s_voidp;
	    Q_LONG xret(*xptr);
	    delete xptr;
	    return xret;
