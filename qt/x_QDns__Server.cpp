...
public:
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp,(Q_UINT16)x[2].s_ushort,(Q_UINT16)x[3].s_ushort,(Q_UINT16)x[4].s_ushort);
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp,(Q_UINT16)x[2].s_ushort,(Q_UINT16)x[3].s_ushort);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp,(Q_UINT16)x[2].s_ushort);
	x[0].s_class = (void*)xret;
    }
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
...
void xcall_QDns__Server(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 5: x_QDns__Server::x_5(args);	break;
	case 6: delete (QDns::Server*)xself;	break;
    }
}
