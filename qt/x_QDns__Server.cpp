...
public:
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp,*(Q_UINT16 *)x[2].s_voidp,*(Q_UINT16 *)x[3].s_voidp,*(Q_UINT16 *)x[4].s_voidp);
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp,*(Q_UINT16 *)x[2].s_voidp,*(Q_UINT16 *)x[3].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QDns__Server* xret = new x_QDns__Server(*(const QString *)x[1].s_voidp,*(Q_UINT16 *)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
