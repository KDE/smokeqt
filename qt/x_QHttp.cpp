...
public:
	...
	this->QHttp::operationGet((QNetworkOperation*)x[1].s_voidp);
    }
    void x_3(Smoke::Stack x) {
	// operationPut(QNetworkOperation*)
	this->QHttp::operationPut((QNetworkOperation*)x[1].s_voidp);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 3356, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 3357, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3355, x)) return (int)x[0].s_int;
