...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8694, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8690, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8695, (void*)this, x)) return (QSpacerItem*)x[0].s_class;
    ...
    ~x_QSpacerItem() { qt_Smoke->binding->deleted(273, (void*)this); }
};
