...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 7091, x)) {
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 7092, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 7090, x)) {
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 7089, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(call_method((void*)this, 7093, x)) return;
	this->QSpacerItem::setGeometry(x1);
    }
    virtual QSize sizeHint() const {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 7088, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 7095, x)) 	return (QSpacerItem*)x[0].s_class;
