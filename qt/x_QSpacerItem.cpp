...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8499, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8497, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8493, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8500, (void*)this, x)) return (QSpacerItem*)x[0].s_class;
    ...
    ~x_QSpacerItem() { qt_Smoke->binding->deleted(272, (void*)this); }
};
