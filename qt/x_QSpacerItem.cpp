...
public:
	...
	x_QSpacerItem* xret = new x_QSpacerItem(*(const QSpacerItem *)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QSpacerItem(const QSpacerItem& x1) : QSpacerItem(x1) {
    }
    virtual QSizePolicy::ExpandData expanding() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8869, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8872, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8870, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8868, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8867, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8871, (void*)this, x)) return;
	this->QSpacerItem::setGeometry(x1);
    }
    virtual QSize sizeHint() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8866, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8873, (void*)this, x)) return (QSpacerItem*)x[0].s_class;
    ...
    ~x_QSpacerItem() { qt_Smoke->binding->deleted(278, (void*)this); }
};
