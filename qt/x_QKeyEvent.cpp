...
public:
	...
	x_QKeyEvent* xret = new x_QKeyEvent(*(QEvent::Type *)x[1].s_class,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,*(const QString *)x[5].s_class,(bool)x[6].s_bool,(ushort)x[7].s_ushort);
	...
	x_QKeyEvent* xret = new x_QKeyEvent(*(QEvent::Type *)x[1].s_class,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,*(const QString *)x[5].s_class,(bool)x[6].s_bool);
	x[0].s_class = (void*)xret;
    }
	...
	x_QKeyEvent* xret = new x_QKeyEvent(*(QEvent::Type *)x[1].s_class,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,*(const QString *)x[5].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QKeyEvent* xret = new x_QKeyEvent(*(QEvent::Type *)x[1].s_class,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int);
	x[0].s_class = (void*)xret;
    }
