...
public:
	...
	x_QPrinter* xret = new x_QPrinter((QPrinter::PrinterMode)x[1].s_enum);
	...
	this->QPrinter::setPrinterName(*(const QString *)x[1].s_voidp);
	...
	this->QPrinter::setOutputFileName(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setPrintProgram(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setPrinterSelectionOption(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setDocName(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setCreator(*(const QString *)x[1].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setOrientation((QPrinter::Orientation)x[1].s_enum);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setPageSize((QPrinter::PageSize)x[1].s_enum);
	(void)x; // noop (for compiler warning)
    }
    void x_75(Smoke::Stack x) {
	// setPageOrder(QPrinter::PageOrder)
	this->QPrinter::setPageOrder((QPrinter::PageOrder)x[1].s_enum);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setColorMode((QPrinter::ColorMode)x[1].s_enum);
	(void)x; // noop (for compiler warning)
    }
	...
	this->QPrinter::setPaperSource((QPrinter::PaperSource)x[1].s_enum);
	(void)x; // noop (for compiler warning)
    }
	...
	x[2].s_class = (void*)x2;
	x[3].s_voidp = (void*)x3;
	if(qt_Smoke->binding->callMethod(7315, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(7316, (void*)this, x)) return (int)x[0].s_int;
	return this->QPrinter::metric(x1);
    }
    virtual int resolution() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7290, (void*)this, x)) return (int)x[0].s_int;
	return this->QPrinter::resolution();
    }
    virtual void setColorMode(QPrinter::ColorMode x1) {
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(7291, (void*)this, x)) return;
	this->QPrinter::setColorMode(x1);
    }
    virtual void setCreator(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7282, (void*)this, x)) return;
	this->QPrinter::setCreator(x1);
    }
    virtual void setDocName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7280, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(7298, (void*)this, x)) return;
	this->QPrinter::setFromTo(x1, x2);
    }
    virtual void setFullPage(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(7293, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(7301, (void*)this, x)) return;
	this->QPrinter::setMinMax(x1, x2);
    }
    virtual void setNumCopies(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(7303, (void*)this, x)) return;
	this->QPrinter::setNumCopies(x1);
    }
    virtual void setOrientation(QPrinter::Orientation x1) {
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(7284, (void*)this, x)) return;
	this->QPrinter::setOrientation(x1);
    }
    virtual void setOutputFileName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7274, (void*)this, x)) return;
	this->QPrinter::setOutputFileName(x1);
    }
    virtual void setOutputToFile(bool x1) {
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(7272, (void*)this, x)) return;
	this->QPrinter::setOutputToFile(x1);
    }
    virtual void setPageOrder(QPrinter::PageOrder x1) {
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(7287, (void*)this, x)) return;
	this->QPrinter::setPageOrder(x1);
    }
    virtual void setPageSize(QPrinter::PageSize x1) {
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(7286, (void*)this, x)) return;
	this->QPrinter::setPageSize(x1);
    }
    virtual void setPaperSource(QPrinter::PaperSource x1) {
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(7314, (void*)this, x)) return;
	this->QPrinter::setPaperSource(x1);
    }
    virtual void setPrintProgram(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7276, (void*)this, x)) return;
	this->QPrinter::setPrintProgram(x1);
    }
    virtual void setPrinterName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7270, (void*)this, x)) return;
	this->QPrinter::setPrinterName(x1);
    }
    virtual void setPrinterSelectionOption(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7278, (void*)this, x)) return;
	this->QPrinter::setPrinterSelectionOption(x1);
    }
    virtual void setResolution(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(7289, (void*)this, x)) return;
	this->QPrinter::setResolution(x1);
    }
    static void xenum_operation(Smoke::EnumOperation xop, Smoke::Index xtype, void *&xdata, long &xvalue) {
	switch(xtype) {
	  case 447: //QPrinter::PageSize
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QPrinter::PageSize;
		break;
	      case Smoke::EnumDelete:
		delete (QPrinter::PageSize*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPrinter::PageSize*)xdata = (QPrinter::PageSize)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPrinter::PageSize*)xdata;
		break;
	    }
	    break;
	  case 449: //QPrinter::PrinterMode
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QPrinter::PrinterMode;
		break;
	      case Smoke::EnumDelete:
		delete (QPrinter::PrinterMode*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPrinter::PrinterMode*)xdata = (QPrinter::PrinterMode)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPrinter::PrinterMode*)xdata;
		break;
	    }
	    break;
	  case 445: //QPrinter::Orientation
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QPrinter::Orientation;
		break;
	      case Smoke::EnumDelete:
		delete (QPrinter::Orientation*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPrinter::Orientation*)xdata = (QPrinter::Orientation)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPrinter::Orientation*)xdata;
		break;
	    }
	    break;
	  case 448: //QPrinter::PaperSource
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QPrinter::PaperSource;
		break;
	      case Smoke::EnumDelete:
		delete (QPrinter::PaperSource*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPrinter::PaperSource*)xdata = (QPrinter::PaperSource)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPrinter::PaperSource*)xdata;
		break;
	    }
	    break;
	  case 444: //QPrinter::ColorMode
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QPrinter::ColorMode;
		break;
	      case Smoke::EnumDelete:
		delete (QPrinter::ColorMode*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPrinter::ColorMode*)xdata = (QPrinter::ColorMode)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPrinter::ColorMode*)xdata;
		break;
	    }
	    break;
	  case 446: //QPrinter::PageOrder
	    switch(xop) {
	      case Smoke::EnumNew:
		xdata = (void*)new QPrinter::PageOrder;
		break;
	      case Smoke::EnumDelete:
		delete (QPrinter::PageOrder*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPrinter::PageOrder*)xdata = (QPrinter::PageOrder)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPrinter::PageOrder*)xdata;
		break;
	    }
	    break;
	}
    }
    ~x_QPrinter() { qt_Smoke->binding->deleted(235, (void*)this); }
};
void xenum_QPrinter(Smoke::EnumOperation xop, Smoke::Index xtype, void *&xdata, long &xvalue) {
    x_QPrinter::xenum_operation(xop, xtype, xdata, xvalue);
}
