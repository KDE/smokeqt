...
public:
	...
	// setMargins(uint, uint, uint, uint)
	this->QPrinter::setMargins((uint)x[1].s_uint,(uint)x[2].s_uint,(uint)x[3].s_uint,(uint)x[4].s_uint);
	(void)x; // noop (for compiler warning)
    }
    void x_85(Smoke::Stack x) const {
	// margins(uint*, uint*, uint*, uint*)
	this->QPrinter::margins((uint*)x[1].s_voidp,(uint*)x[2].s_voidp,(uint*)x[3].s_voidp,(uint*)x[4].s_voidp);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(7483, (void*)this, x)) return (int)x[0].s_int;
	return this->QPrinter::metric(x1);
    }
    virtual int resolution() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7455, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7445, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_int = x2;
	if(qt_Smoke->binding->callMethod(7465, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(7451, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7441, (void*)this, x)) return;
	this->QPrinter::setPrintProgram(x1);
    }
    virtual void setPrinterName(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(7435, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(7454, (void*)this, x)) return;
	this->QPrinter::setResolution(x1);
    }
    static void xenum_operation(Smoke::EnumOperation xop, Smoke::Index xtype, void *&xdata, long &xvalue) {
	switch(xtype) {
	  case 460: //QPrinter::PageSize
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QPrinter() { qt_Smoke->binding->deleted(238, (void*)this); }
};
...
void xcall_QPrinter(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 107: delete (QPrinter*)xself;	break;
    }
}
