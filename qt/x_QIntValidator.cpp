...
public:
	...
	x_QIntValidator* xret = new x_QIntValidator((QObject*)x[1].s_class,(const char*)x[2].s_class);
	...
	x_QIntValidator* xret = new x_QIntValidator((int)x[1].s_int,(int)x[2].s_int,(QObject*)x[3].s_class,(const char*)x[4].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	QValidator::State xret = this->QIntValidator::validate(*(QString *)x[1].s_class,*(int *)x[2].s_class);
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(3893, (void*)this, x)) return;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(3890, (void*)this, x)) {
