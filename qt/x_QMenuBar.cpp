...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4820, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4816, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4823, x)) return;
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)x2;
	if(call_method((void*)this, 4810, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4811, x)) return (int)x[0].s_int;
	return this->QMenuBar::heightForWidth(x1);
    }
    virtual void hide() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4809, x)) return;
	this->QMenuBar::hide();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4819, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 4825, x)) return;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4808, x)) return;
	this->QMenuBar::show();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 4817, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 4807, x)) return;
