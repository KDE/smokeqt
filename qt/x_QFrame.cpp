...
public:
	...
	x[0].s_long = (long)QFrame::NoFrame;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::Box;
    }
    static void x_2(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::Panel;
    }
    static void x_3(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::WinPanel;
    }
    static void x_4(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::HLine;
    }
    static void x_5(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::VLine;
    }
    static void x_6(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::StyledPanel;
    }
    static void x_7(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::PopupPanel;
    }
    static void x_8(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::MenuBarPanel;
    }
    static void x_9(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::ToolBarPanel;
    }
    static void x_10(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::LineEditPanel;
    }
    static void x_11(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::TabWidgetPanel;
    }
    static void x_12(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::MShape;
    }
    static void x_13(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::Plain;
    }
    static void x_14(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::Raised;
    }
    static void x_15(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::Sunken;
    }
    static void x_16(Smoke::Stack x) {
	x[0].s_long = (long)QFrame::MShadow;
    }
    static void x_17(Smoke::Stack x) {
	// QFrame(QWidget*, const char*, Qt::WFlags)
	x_QFrame* xret = new x_QFrame((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,*(Qt::WFlags *)x[3].s_voidp);
	...
	x_QFrame* xret = new x_QFrame((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	// QFrame(QWidget*)
	x_QFrame* xret = new x_QFrame((QWidget*)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x[0].s_voidp = (void*)new QFrame::Shape(xret);
    }
    void x_28(Smoke::Stack x) {
	// setFrameShape(QFrame::Shape)
	this->QFrame::setFrameShape(*(QFrame::Shape *)x[1].s_voidp);
    }
    void x_29(Smoke::Stack x) const {
	// frameShadow()
	QFrame::Shadow xret = this->QFrame::frameShadow();
	x[0].s_voidp = (void*)new QFrame::Shadow(xret);
    }
    void x_30(Smoke::Stack x) {
	// setFrameShadow(QFrame::Shadow)
	this->QFrame::setFrameShadow(*(QFrame::Shadow *)x[1].s_voidp);
    }
	...
	this->QFrame::setFrameRect(*(const QRect *)x[1].s_voidp);
    }
    void x_39(Smoke::Stack x) {
	// paintEvent(QPaintEvent*)
	this->QFrame::paintEvent((QPaintEvent*)x[1].s_voidp);
    }
    void x_40(Smoke::Stack x) {
	// resizeEvent(QResizeEvent*)
	this->QFrame::resizeEvent((QResizeEvent*)x[1].s_voidp);
    }
    void x_41(Smoke::Stack x) {
	// drawFrame(QPainter*)
	this->QFrame::drawFrame((QPainter*)x[1].s_voidp);
    }
    void x_42(Smoke::Stack x) {
	// drawContents(QPainter*)
	this->QFrame::drawContents((QPainter*)x[1].s_voidp);
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 2929, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
