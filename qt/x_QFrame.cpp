...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2923, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QFrame(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 18: x_QFrame::x_18(args);	break;
	case 19: x_QFrame::x_19(args);	break;
	case 20: x_QFrame::x_20(args);	break;
	...
	case 44: delete (QFrame*)xself;	break;
    }
}
