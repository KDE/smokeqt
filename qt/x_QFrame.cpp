...
public:
	...
	x[0].s_enum = (long)QFrame::GroupBoxPanel;
    }
	...
	// styleChange(QStyle&)
	this->QFrame::styleChange(*(QStyle *)x[1].s_class);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3499, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3498, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(3500, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(3502, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(3501, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(3503, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3514, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
    ...
    ~x_QFrame() { qt_Smoke->binding->deleted(120, (void*)this); }
};
...
void xcall_QFrame(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 17: x_QFrame::x_17(args);	break;
	...
	case 28: x_QFrame::x_28(args);	break;
	...
	case 51: x_QFrame::x_51(args);	break;
	...
	case 58: delete (QFrame*)xself;	break;
    }
}
