...
public:
	...
	x_QFrame* xret = new x_QFrame((QWidget*)x[1].s_class,(const char*)x[2].s_class,*(Qt::WFlags *)x[3].s_class);
	...
	x_QFrame* xret = new x_QFrame((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x[0].s_class = (void*)new QFrame::Shape(xret);
    }
	...
	x[0].s_class = (void*)new QFrame::Shadow(xret);
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(2934, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
