...
public:
	...
	x_QColorDrag* xret = new x_QColorDrag(*(const QColor *)x[1].s_class,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	...
	x_QColorDrag* xret = new x_QColorDrag((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
