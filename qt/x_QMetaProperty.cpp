...
public:
	...
	x[0].s_enum = (long)QMetaProperty::UnresolvedEnum;
    }
	...
	// designable()
	bool xret = this->QMetaProperty::designable();
	x[0].s_bool = xret;
    }
	...
	// scriptable()
	bool xret = this->QMetaProperty::scriptable();
	x[0].s_bool = xret;
    }
	...
	// stored()
	bool xret = this->QMetaProperty::stored();
	x[0].s_bool = xret;
    }
...
void xcall_QMetaProperty(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 6: x_QMetaProperty::x_6(args);	break;
	...
	case 29: x_QMetaProperty::x_29(args);	break;
	case 30: x_QMetaProperty::x_30(args);	break;
	case 31: delete (QMetaProperty*)xself;	break;
    }
}
