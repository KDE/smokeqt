...
public:
	...
	x[1].s_uint = (uint)x1;
	x[2].s_uint = (uint)x2;
	if(call_method((void*)this, 3924, x)) return (uint)x[0].s_uint;
	...
	x[1].s_uint = (uint)x1;
	x[2].s_uint = (uint)x2;
	if(call_method((void*)this, 3926, x)) return (uint)x[0].s_uint;
	...
	x[1].s_uint = (uint)x1;
	x[2].s_uint = (uint)x2;
	if(call_method((void*)this, 3927, x)) return (uint)x[0].s_uint;
	...
	x[1].s_uint = (uint)x1;
	x[2].s_uint = (uint)x2;
	if(call_method((void*)this, 3936, x)) return (uint)x[0].s_uint;
	...
	x[1].s_uint = (uint)x1;
	x[2].s_uint = (uint)x2;
	if(call_method((void*)this, 3938, x)) return (uint)x[0].s_uint;
	...
	x[1].s_uint = (uint)x1;
	x[2].s_uint = (uint)x2;
	if(call_method((void*)this, 3939, x)) return (uint)x[0].s_uint;
