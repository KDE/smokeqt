...
public:
	...
	x_QCheckBox* xret = new x_QCheckBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QCheckBox(QWidget*)
	x_QCheckBox* xret = new x_QCheckBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QCheckBox* xret = new x_QCheckBox(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QCheckBox* xret = new x_QCheckBox(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_6(xargs *x) {
	// setTristate(bool)
	this->QCheckBox::setTristate((bool)x[1].x_bool);
    }
    void x_7(xargs *x) {
	// setTristate()
    ...
    void x_10(xargs *x) {
	// setChecked(bool)
	this->QCheckBox::setChecked((bool)x[1].x_bool);
    }
    void x_11(xargs *x) {
	// resizeEvent(QResizeEvent*)
	this->QCheckBox::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_12(xargs *x) {
	// drawButton(QPainter*)
	this->QCheckBox::drawButton((QPainter*)x[1].x_voidp);
    }
    void x_13(xargs *x) {
	// drawButtonLabel(QPainter*)
	this->QCheckBox::drawButtonLabel((QPainter*)x[1].x_voidp);
    }
    void x_14(xargs *x) {
	// updateMask()
...
void xcall_QCheckBox(xargs *x, void *s, int xi) {
    x_QCheckBox *xself = (x_QCheckBox*)s;
    switch(xi) {
	case 0: x_QCheckBox::x_0(x);	break;
	case 1: x_QCheckBox::x_1(x);	break;
	case 2: x_QCheckBox::x_2(x);	break;
	case 3: x_QCheckBox::x_3(x);	break;
