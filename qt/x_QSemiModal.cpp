...
public:
	...
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].s_class,(const char*)x[2].s_class,(bool)x[3].s_bool,*(Qt::WFlags *)x[4].s_class);
	...
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].s_class,(const char*)x[2].s_class,(bool)x[3].s_bool);
	x[0].s_class = (void*)xret;
    }
	...
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].s_class,(const char*)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(1726, (void*)this, x)) return;
