...
public:
	...
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,(bool)x[3].x_bool,*(Qt::WFlags *)x[4].x_voidp);
	...
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,(bool)x[3].x_bool);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QSemiModal(QWidget*)
	x_QSemiModal* xret = new x_QSemiModal((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QSemiModal(xargs *x, void *s, int xi) {
    x_QSemiModal *xself = (x_QSemiModal*)s;
    switch(xi) {
	case 0: x_QSemiModal::x_0(x);	break;
	case 1: x_QSemiModal::x_1(x);	break;
	case 2: x_QSemiModal::x_2(x);	break;
	case 3: x_QSemiModal::x_3(x);	break;
	case 4: x_QSemiModal::x_4(x);	break;
    }
}
