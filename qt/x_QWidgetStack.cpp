...
public:
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 9784, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 9795, x)) return;
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 9796, x)) return;
	this->QWidgetStack::setChildGeometries();
    }
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 9785, x)) return;
	this->QWidgetStack::show();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 9783, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
