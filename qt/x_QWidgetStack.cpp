...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(9885, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9882, (void*)this, x)) return;
	this->QWidgetStack::frameChanged();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9872, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(9883, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9884, (void*)this, x)) return;
	this->QWidgetStack::setChildGeometries();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->callMethod(9877, (void*)this, x)) return;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9873, (void*)this, x)) return;
	this->QWidgetStack::show();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9871, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
