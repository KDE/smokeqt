...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9882, (void*)this, x)) return;
	this->QWidgetStack::frameChanged();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9872, (void*)this, x)) {
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9873, (void*)this, x)) return;
	this->QWidgetStack::show();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9871, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
