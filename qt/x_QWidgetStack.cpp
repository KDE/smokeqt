...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(9890, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9887, (void*)this, x)) return;
	this->QWidgetStack::frameChanged();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9877, (void*)this, x)) {
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9878, (void*)this, x)) return;
	this->QWidgetStack::show();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9876, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
