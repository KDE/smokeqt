...
public:
	...
	x_QWidgetStack* xret = new x_QWidgetStack((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QWidgetStack* xret = new x_QWidgetStack((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	int xret = this->QWidgetStack::addWidget((QWidget*)x[1].x_voidp,(int)x[2].x_int);
	x[0].x_int = (int)xret;
    }
    void x_4(xargs *x) {
	// addWidget(QWidget*)
	int xret = this->QWidgetStack::addWidget((QWidget*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
    void x_5(xargs *x) {
	// removeWidget(QWidget*)
	this->QWidgetStack::removeWidget((QWidget*)x[1].x_voidp);
    }
	...
	// widget(int)
	QWidget* xret = this->QWidgetStack::widget((int)x[1].x_int);
	x[0].x_voidp = (void*)xret;
    }
    void x_10(xargs *x) const {
	// id(QWidget*)
	int xret = this->QWidgetStack::id((QWidget*)x[1].x_voidp);
	x[0].x_int = (int)xret;
    }
	...
	this->QWidgetStack::setFrameRect(*(const QRect *)x[1].x_voidp);
    }
    void x_13(xargs *x) {
	// raiseWidget(int)
	this->QWidgetStack::raiseWidget((int)x[1].x_int);
    }
    void x_14(xargs *x) {
	// raiseWidget(QWidget*)
	this->QWidgetStack::raiseWidget((QWidget*)x[1].x_voidp);
    }
    void x_15(xargs *x) {
	// aboutToShow(int)
	this->QWidgetStack::aboutToShow((int)x[1].x_int);
    }
    void x_16(xargs *x) {
	// aboutToShow(QWidget*)
	this->QWidgetStack::aboutToShow((QWidget*)x[1].x_voidp);
    }
    void x_17(xargs *x) {
	// frameChanged()
	...
	this->QWidgetStack::resizeEvent((QResizeEvent*)x[1].x_voidp);
    }
    void x_19(xargs *x) {
	// setChildGeometries()
	...
	this->QWidgetStack::childEvent((QChildEvent*)x[1].x_voidp);
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 9799, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 9786, x)) {
	...
	xargs x[1];
	if(call_method((void*)this, 9798, x)) return;
	this->QWidgetStack::setChildGeometries();
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	if(call_method((void*)this, 9791, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 9785, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QWidgetStack(xargs *x, void *s, int xi) {
    x_QWidgetStack *xself = (x_QWidgetStack*)s;
    switch(xi) {
	case 0: x_QWidgetStack::x_0(x);	break;
	case 1: x_QWidgetStack::x_1(x);	break;
	case 2: x_QWidgetStack::x_2(x);	break;
