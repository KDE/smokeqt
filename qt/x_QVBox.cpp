...
public:
	...
	x_QVBox* xret = new x_QVBox((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,*(Qt::WFlags *)x[3].s_voidp);
	...
	x_QVBox* xret = new x_QVBox((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	// QVBox(QWidget*)
	x_QVBox* xret = new x_QVBox((QWidget*)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
