...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11078, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11077, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(11079, (void*)this, x)) return (void*)x[0].s_voidp;
