...
public:
	...
	x_QVBox* xret = new x_QVBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,*(Qt::WFlags *)x[3].x_voidp);
	...
	x_QVBox* xret = new x_QVBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QVBox(QWidget*)
	x_QVBox* xret = new x_QVBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QVBox(xargs *x, void *s, int xi) {
    x_QVBox *xself = (x_QVBox*)s;
    switch(xi) {
	case 0: x_QVBox::x_0(x);	break;
	case 1: x_QVBox::x_1(x);	break;
	case 2: x_QVBox::x_2(x);	break;
	case 3: x_QVBox::x_3(x);	break;
    }
}
