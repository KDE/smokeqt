...
public:
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->callMethod(10120, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QXmlSimpleReader::feature(x1, x2);
    }
    virtual bool hasFeature(const QString& x1) const {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(10123, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QXmlSimpleReader::hasFeature(x1);
    }
    virtual bool hasProperty(const QString& x1) const {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(10127, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(10140, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QXmlSimpleReader::parse(x1);
    }
    virtual bool parse(const QXmlInputSource* x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(10141, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QXmlSimpleReader::parse(x1);
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->callMethod(10124, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_bool = (bool)x2;
	if(qt_Smoke->callMethod(10122, (void*)this, x)) return;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->callMethod(10126, (void*)this, x)) return;
