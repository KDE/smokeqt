...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8939, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(8908, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8942, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8889, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(8904, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(8887, (void*)this, x)) {
	    QSqlIndex *xptr = (QSqlIndex *)x[0].s_class;
	    QSqlIndex xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8903, (void*)this, x)) return (QSqlRecord*)x[0].s_class;
	return this->QSqlCursor::primeDelete();
    }
    virtual QSqlRecord* primeInsert() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8901, (void*)this, x)) return (QSqlRecord*)x[0].s_class;
	return this->QSqlCursor::primeInsert();
    }
    virtual QSqlRecord* primeUpdate() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(8902, (void*)this, x)) return (QSqlRecord*)x[0].s_class;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(8923, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8912, (void*)this, x)) return;
	this->QSqlCursor::setCalculated(x1, x2);
    }
    virtual void setFilter(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8927, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8898, (void*)this, x)) return;
	this->QSqlCursor::setGenerated(x1, x2);
    }
    virtual void setMode(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(8910, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8929, (void*)this, x)) return;
	this->QSqlCursor::setName(x1, x2);
    }
    virtual void setNull(const QString& x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9265, (void*)this, x)) return;
	this->QSqlRecord::setNull(x1);
    }
    virtual void setNull(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(9264, (void*)this, x)) return;
	this->QSqlRecord::setNull(x1);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(8925, (void*)this, x)) return;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8914, (void*)this, x)) return;
	...
	x[1].s_int = x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(8885, (void*)this, x)) return;
	this->QSqlCursor::setValue(x1, x2);
    }
	...
	x[3].s_voidp = (void*)&x3;
	x[4].s_voidp = (void*)&x4;
	if(qt_Smoke->binding->callMethod(8945, (void*)this, x)) {
	...
	x[4].s_voidp = (void*)&x4;
	x[5].s_voidp = (void*)&x5;
	if(qt_Smoke->binding->callMethod(8946, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[2].s_class = (void*)x2;
	x[3].s_voidp = (void*)&x3;
	if(qt_Smoke->binding->callMethod(8944, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(8932, (void*)this, x)) {
	    QString *xptr = (QString *)x[0].s_class;
	    QString xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9288, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(8906, (void*)this, x)) return (int)x[0].s_int;
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(8940, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(8883, (void*)this, x)) {
	    QVariant *xptr = (QVariant *)x[0].s_class;
	    QVariant xret(*xptr);
	    delete xptr;
	    return xret;
