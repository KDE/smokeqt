...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(6998, (void*)this, x)) return (int)x[0].s_int;
    ...
    ~x_QPixmap() { qt_Smoke->binding->deleted(224, (void*)this); }
};
