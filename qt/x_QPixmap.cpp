...
public:
	...
	x_QPixmap* xret = new x_QPixmap((int)x[1].s_int,(int)x[2].s_int,(int)x[3].s_int,(QPixmap::Optimization)x[4].s_enum);
	x[0].s_class = (void*)xret;
    }
	...
	x_QPixmap* xret = new x_QPixmap(*(const QSize *)x[1].s_class,(int)x[2].s_int,(QPixmap::Optimization)x[3].s_enum);
	x[0].s_class = (void*)xret;
    }
	...
	x_QPixmap* xret = new x_QPixmap(*(const QString *)x[1].s_voidp,(const char*)x[2].s_voidp,(QPixmap::ColorMode)x[3].s_enum);
	x[0].s_class = (void*)xret;
    }
    ...
    virtual void detach() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(7005, (void*)this, x)) return;
	this->QPixmap::detach();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(7023, (void*)this, x)) return (int)x[0].s_int;
	...
	switch(xtype) {
	  case 430: //QPixmap::Optimization
		...
		delete (QPixmap::Optimization*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPixmap::Optimization*)xdata = (QPixmap::Optimization)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPixmap::Optimization*)xdata;
		break;
	    }
	    break;
	  case 429: //QPixmap::ColorMode
		...
		break;
	      case Smoke::EnumDelete:
		delete (QPixmap::ColorMode*)xdata;
		break;
	      case Smoke::EnumFromLong:
		*(QPixmap::ColorMode*)xdata = (QPixmap::ColorMode)xvalue;
		break;
	      case Smoke::EnumToLong:
		xvalue = (long)*(QPixmap::ColorMode*)xdata;
		break;
	    }
	    break;
	}
