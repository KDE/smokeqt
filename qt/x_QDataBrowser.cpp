...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1519, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(1593, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(1592, (void*)this, x)) {
	    QSql::Confirm *xptr = (QSql::Confirm *)x[0].s_class;
	    QSql::Confirm xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1591, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1590, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(1594, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1588, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void last() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1564, (void*)this, x)) return;
	this->QDataBrowser::last();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1518, (void*)this, x)) return (QMetaObject*)x[0].s_class;
    ...
    virtual void next() {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1565, (void*)this, x)) return;
	this->QDataBrowser::next();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(1520, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(1522, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(1521, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(1523, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(1557, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(1541, (void*)this, x)) return;
	...
	x[1].s_class = (void*)x1;
	x[2].s_bool = x2;
	if(qt_Smoke->binding->callMethod(1538, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(1589, (void*)this, x)) return (bool)x[0].s_bool;
	...
	switch(xtype) {
	  case 100: //QDataBrowser::Boundary
	    switch(xop) {
	      case Smoke::EnumNew:
