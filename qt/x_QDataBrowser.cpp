...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(1319, (void*)this, x)) {
	    QSql::Confirm *xptr = (QSql::Confirm *)x[0].s_class;
	    QSql::Confirm xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(1321, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1315, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(1291, (void*)this, x)) return;
	this->QDataBrowser::refresh();
    }
	...
	x[1].s_int = (int)x1;
	x[2].s_bool = (bool)x2;
	if(qt_Smoke->callMethod(1289, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(1287, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(1275, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(1273, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(qt_Smoke->callMethod(1285, (void*)this, x)) return;
	...
	x[1].s_class = (void*)x1;
	x[2].s_bool = (bool)x2;
	if(qt_Smoke->callMethod(1270, (void*)this, x)) return;
