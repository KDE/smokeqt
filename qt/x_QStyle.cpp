...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9408, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[5].s_int = x5;
	x[6].s_class = (void*)&x6;
	qt_Smoke->binding->callMethod(9427, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9407, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(9409, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(9412, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_class = (void*)x2;
	x[3].s_class = (void*)&x3;
	qt_Smoke->binding->callMethod(9455, (void*)this, x, true /*pure virtual*/);
	...
	x[1].s_enum = x1;
	x[2].s_class = (void*)x2;
	qt_Smoke->binding->callMethod(9435, (void*)this, x, true /*pure virtual*/);
	QRect *xptr = (QRect *)x[0].s_class;
	QRect xret(*xptr);
	delete xptr;
	return xret;
