...
public:
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(QWidget*)x[2].s_class,(const char*)x[3].s_class,*(Qt::WFlags *)x[4].s_class);
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(QWidget*)x[2].s_class,(const char*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_class,(QWidget*)x[3].s_class,(const char*)x[4].s_class,*(Qt::WFlags *)x[5].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_class,(QWidget*)x[3].s_class,(const char*)x[4].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_class,(QWidget*)x[3].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_class);
	x[0].s_class = (void*)xret;
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3106, (void*)this, x)) return;
	this->QGrid::frameChanged();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3105, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
