...
public:
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp,(Qt::WFlags)x[4].s_int);
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp,(Qt::WFlags)x[5].s_int);
	x[0].s_class = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(Qt::Orientation)x[2].s_enum,(QWidget*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
