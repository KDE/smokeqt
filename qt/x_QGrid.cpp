...
public:
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp,*(Qt::WFlags *)x[4].s_voidp);
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	// QGrid(int, QWidget*)
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,(QWidget*)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_voidp,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp,*(Qt::WFlags *)x[5].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_voidp,(QWidget*)x[3].s_voidp,(const char*)x[4].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_voidp,(QWidget*)x[3].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].s_int,*(Qt::Orientation *)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3101, x)) return;
	this->QGrid::frameChanged();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 3100, x)) {
	    QSize *xptr = (QSize *)x[0].s_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
