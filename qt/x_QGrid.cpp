...
public:
	...
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp,*(Qt::WFlags *)x[4].x_voidp);
	...
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QGrid(int, QWidget*)
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QGrid(int)
	x_QGrid* xret = new x_QGrid((int)x[1].x_int);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(Qt::Orientation)x[2].x_long,(QWidget*)x[3].x_voidp,(const char*)x[4].x_voidp,*(Qt::WFlags *)x[5].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(Qt::Orientation)x[2].x_long,(QWidget*)x[3].x_voidp,(const char*)x[4].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(Qt::Orientation)x[2].x_long,(QWidget*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QGrid* xret = new x_QGrid((int)x[1].x_int,(Qt::Orientation)x[2].x_long);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_8(xargs *x) {
	// setSpacing(int)
	this->QGrid::setSpacing((int)x[1].x_int);
    }
	...
	xargs x[1];
	if(call_method((void*)this, 3103, x)) return;
	this->QGrid::frameChanged();
    }
	...
	xargs x[1];
	if(call_method((void*)this, 3102, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QGrid(xargs *x, void *s, int xi) {
    x_QGrid *xself = (x_QGrid*)s;
    switch(xi) {
	case 0: x_QGrid::x_0(x);	break;
	case 1: x_QGrid::x_1(x);	break;
	case 2: x_QGrid::x_2(x);	break;
	case 3: x_QGrid::x_3(x);	break;
	case 4: x_QGrid::x_4(x);	break;
	case 5: x_QGrid::x_5(x);	break;
	case 6: x_QGrid::x_6(x);	break;
	case 7: x_QGrid::x_7(x);	break;
