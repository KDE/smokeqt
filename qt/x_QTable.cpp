...
public:
	...
	x[2].s_int = (int)x2;
	x[3].s_bool = (bool)x3;
	if(call_method((void*)this, 8350, x)) 	return (QWidget*)x[0].s_voidp;
	...
	x[2].s_int = (int)x2;
	x[3].s_bool = (bool)x3;
	if(call_method((void*)this, 8348, x)) 	return (QWidget*)x[0].s_voidp;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 8222, x)) 	return (QTableItem*)x[0].s_voidp;
