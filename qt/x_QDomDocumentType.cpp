...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2543, (void*)this, x)) {
	    QDomNamedNodeMap *xptr = (QDomNamedNodeMap *)x[0].s_class;
	    QDomNamedNodeMap xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2549, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QDomDocumentType() { qt_Smoke->binding->deleted(83, (void*)this); }
};
