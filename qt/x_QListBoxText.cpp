...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5590, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(5592, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(5591, (void*)this, x)) return (int)x[0].s_int;
	return this->QListBoxText::width(x1);
    }
    ~x_QListBoxText() { qt_Smoke->binding->deleted(189, (void*)this); }
};
