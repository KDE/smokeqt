...
public:
    ...
    virtual void clear() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8988, (void*)this, x)) return;
	this->QToolBar::clear();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(8985, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    virtual void hide() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8982, (void*)this, x)) return;
	this->QToolBar::hide();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8990, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(8993, (void*)this, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(8992, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(8991, (void*)this, x)) return;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8981, (void*)this, x)) return;
	this->QToolBar::show();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->callMethod(8994, (void*)this, x)) return;
