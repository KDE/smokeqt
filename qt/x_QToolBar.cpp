...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 8898, x)) return (bool)x[0].s_bool;
    ...
    virtual void hide() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8895, x)) return;
	this->QToolBar::hide();
    }
	...
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8903, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 8899, x)) return;
	...
	x[1].s_int = (int)x1;
	x[2].s_int = (int)x2;
	if(call_method((void*)this, 8905, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 8897, x)) return;
    ...
    virtual void show() {
	Smoke::StackItem x[1];
	if(call_method((void*)this, 8894, x)) return;
	this->QToolBar::show();
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(call_method((void*)this, 8907, x)) return;
