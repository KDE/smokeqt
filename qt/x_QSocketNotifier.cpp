...
public:
	...
	x[0].s_long = (long)QSocketNotifier::Read;
    }
    static void x_1(Smoke::Stack x) {
	x[0].s_long = (long)QSocketNotifier::Write;
    }
    static void x_2(Smoke::Stack x) {
	x[0].s_long = (long)QSocketNotifier::Exception;
    }
    static void x_3(Smoke::Stack x) {
	// QSocketNotifier(int, QSocketNotifier::Type, QObject*, const char*)
	x_QSocketNotifier* xret = new x_QSocketNotifier((int)x[1].s_int,*(QSocketNotifier::Type *)x[2].s_voidp,(QObject*)x[3].s_voidp,(const char*)x[4].s_voidp);
	...
	x_QSocketNotifier* xret = new x_QSocketNotifier((int)x[1].s_int,*(QSocketNotifier::Type *)x[2].s_voidp,(QObject*)x[3].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QSocketNotifier* xret = new x_QSocketNotifier((int)x[1].s_int,*(QSocketNotifier::Type *)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x[0].s_voidp = (void*)new QSocketNotifier::Type(xret);
    }
	...
	// event(QEvent*)
	bool xret = this->QSocketNotifier::event((QEvent*)x[1].s_voidp);
	x[0].s_bool = (bool)xret;
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(call_method((void*)this, 7071, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = (bool)x1;
	if(call_method((void*)this, 7069, x)) return;
