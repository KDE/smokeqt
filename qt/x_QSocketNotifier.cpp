...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(8833, (void*)this, x)) return (bool)x[0].s_bool;
    ...
    ~x_QSocketNotifier() { qt_Smoke->binding->deleted(276, (void*)this); }
};
