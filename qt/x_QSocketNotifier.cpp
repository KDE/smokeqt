...
public:
	...
	x_QSocketNotifier* xret = new x_QSocketNotifier((int)x[1].s_int,(QSocketNotifier::Type)x[2].s_enum,(QObject*)x[3].s_voidp,(const char*)x[4].s_voidp);
	...
	x_QSocketNotifier* xret = new x_QSocketNotifier((int)x[1].s_int,(QSocketNotifier::Type)x[2].s_enum,(QObject*)x[3].s_voidp);
	x[0].s_class = (void*)xret;
    }
