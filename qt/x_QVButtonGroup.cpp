...
public:
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QVButtonGroup(xargs *x, void *s, int xi) {
    x_QVButtonGroup *xself = (x_QVButtonGroup*)s;
    switch(xi) {
	case 0: x_QVButtonGroup::x_0(x);	break;
	case 1: x_QVButtonGroup::x_1(x);	break;
	case 2: x_QVButtonGroup::x_2(x);	break;
	case 3: x_QVButtonGroup::x_3(x);	break;
	case 4: x_QVButtonGroup::x_4(x);	break;
	case 5: x_QVButtonGroup::x_5(x);	break;
