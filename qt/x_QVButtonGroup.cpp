...
public:
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup((QWidget*)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup(*(const QString *)x[1].s_voidp,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	x_QVButtonGroup* xret = new x_QVButtonGroup(*(const QString *)x[1].s_voidp,(QWidget*)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
