...
public:
	...
	x_QDomCharacterData* xret = new x_QDomCharacterData(*(const QDomCharacterData *)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	QDomCharacterData& xret = this->QDomCharacterData::operator=(*(const QDomCharacterData *)x[1].s_voidp);
	x[0].s_voidp = (void*)&xret;
    }
    void x_3(Smoke::Stack x) {
	// substringData(unsigned long, unsigned long)
	QString xret = this->QDomCharacterData::substringData(*(unsigned long *)x[1].s_voidp,*(unsigned long *)x[2].s_voidp);
	...
	this->QDomCharacterData::insertData(*(unsigned long *)x[1].s_voidp,*(const QString *)x[2].s_voidp);
    }
    void x_6(Smoke::Stack x) {
	// deleteData(unsigned long, unsigned long)
	this->QDomCharacterData::deleteData(*(unsigned long *)x[1].s_voidp,*(unsigned long *)x[2].s_voidp);
    }
    void x_7(Smoke::Stack x) {
	// replaceData(unsigned long, unsigned long, const QString&)
	this->QDomCharacterData::replaceData(*(unsigned long *)x[1].s_voidp,*(unsigned long *)x[2].s_voidp,*(const QString *)x[3].s_voidp);
    }
