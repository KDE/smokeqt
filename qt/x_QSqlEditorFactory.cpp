...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(6451, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(8867, (void*)this, x)) return (QWidget*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->binding->callMethod(8866, (void*)this, x)) return (QWidget*)x[0].s_class;
	return this->QSqlEditorFactory::createEditor(x1, x2);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(6442, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(6444, (void*)this, x)) return (bool)x[0].s_bool;
