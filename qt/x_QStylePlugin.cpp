...
public:
	...
	QStyle* xret = this->QStylePlugin::create(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	xargs x[2];
	x[1].x_voidp = (void*)&x1;
	call_method_abstract((void*)this, 7944, x);
	return (QStyle*)x[0].x_voidp;
	// ABSTRACT
    }
	...
	xargs x[1];
	call_method_abstract((void*)this, 7943, x);
...
void xcall_QStylePlugin(xargs *x, void *s, int xi) {
    x_QStylePlugin *xself = (x_QStylePlugin*)s;
    switch(xi) {
	case 0: x_QStylePlugin::x_0(x);	break;
