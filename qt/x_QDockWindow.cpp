...
public:
	...
	// QDockWindow(QWidget*, const char*, Qt::WFlags)
	x_QDockWindow* xret = new x_QDockWindow((QWidget*)x[1].s_class,(const char*)x[2].s_voidp,(Qt::WFlags)x[3].s_int);
	x[0].s_class = (void*)xret;
    }
    x_QDockWindow(QWidget* x1, const char* x2, Qt::WFlags x3) : QDockWindow(x1, x2, x3) {
    }
    static void x_19(Smoke::Stack x) {
	// QDockWindow(QWidget*, const char*)
	x_QDockWindow* xret = new x_QDockWindow((QWidget*)x[1].s_class,(const char*)x[2].s_voidp);
	x[0].s_class = (void*)xret;
    }
    x_QDockWindow(QWidget* x1, const char* x2) : QDockWindow(x1, x2) {
    }
    static void x_20(Smoke::Stack x) {
	// QDockWindow(QWidget*)
	x_QDockWindow* xret = new x_QDockWindow((QWidget*)x[1].s_class);
	x[0].s_class = (void*)xret;
    }
    x_QDockWindow(QWidget* x1) : QDockWindow(x1) {
    }
	...
	this->QDockWindow::drawContents((QPainter*)x[1].s_class);
	(void)x; // noop (for compiler warning)
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2341, (void*)this, x)) return (const char*)x[0].s_class;
	...
	this->QDockWindow::drawContents(x1);
    }
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->binding->callMethod(2410, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_class = (void*)x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->binding->callMethod(2390, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2340, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2386, (void*)this, x)) {
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(2342, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(2344, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(2343, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(2345, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2360, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2379, (void*)this, x)) return;
	this->QDockWindow::setFixedExtentHeight(x1);
    }
    virtual void setFixedExtentWidth(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(2378, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(2367, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(2381, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_enum = x1;
	if(qt_Smoke->binding->callMethod(2394, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(2363, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(2384, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	switch(xtype) {
	  case 135: //QDockWindow::CloseMode
	    switch(xop) {
	      case Smoke::EnumNew:
    ...
    ~x_QDockWindow() { qt_Smoke->binding->deleted(75, (void*)this); }
};
...
void xcall_QDockWindow(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 18: x_QDockWindow::x_18(args);	break;
	case 19: x_QDockWindow::x_19(args);	break;
	case 20: x_QDockWindow::x_20(args);	break;
	...
	case 67: x_QDockWindow::x_67(args);	break;
	case 68: x_QDockWindow::x_68(args);	break;
	...
	case 76: delete (QDockWindow*)xself;	break;
    }
}
