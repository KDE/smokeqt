...
public:
	...
	Smoke::StackItem x[1];
	qt_Smoke->binding->callMethod(619, (void*)this, x, true /*pure virtual*/);
	...
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	qt_Smoke->binding->callMethod(624, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(622, (void*)this, x)) return (int)x[0].s_int;
