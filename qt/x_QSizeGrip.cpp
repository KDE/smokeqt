...
public:
	...
	x_QSizeGrip* xret = new x_QSizeGrip((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	// QSizeGrip(QWidget*)
	x_QSizeGrip* xret = new x_QSizeGrip((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	this->QSizeGrip::paintEvent((QPaintEvent*)x[1].x_voidp);
    }
    void x_4(xargs *x) {
	// mousePressEvent(QMouseEvent*)
	this->QSizeGrip::mousePressEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_5(xargs *x) {
	// mouseMoveEvent(QMouseEvent*)
	this->QSizeGrip::mouseMoveEvent((QMouseEvent*)x[1].x_voidp);
    }
    void x_6(xargs *x) {
	// eventFilter(QObject*, QEvent*)
	bool xret = this->QSizeGrip::eventFilter((QObject*)x[1].x_voidp,(QEvent*)x[2].x_voidp);
	...
	x[1].x_voidp = (void*)x1;
	x[2].x_voidp = (void*)x2;
	if(call_method((void*)this, 6855, x)) return (bool)x[0].x_bool;
	...
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 6854, x)) return;
	this->QSizeGrip::mouseMoveEvent(x1);
    }
    virtual void mousePressEvent(QMouseEvent* x1) {
	xargs x[2];
	x[1].x_voidp = (void*)x1;
	if(call_method((void*)this, 6853, x)) return;
	...
	xargs x[1];
	if(call_method((void*)this, 6851, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QSizeGrip(xargs *x, void *s, int xi) {
    x_QSizeGrip *xself = (x_QSizeGrip*)s;
    switch(xi) {
	case 0: x_QSizeGrip::x_0(x);	break;
	case 1: x_QSizeGrip::x_1(x);	break;
