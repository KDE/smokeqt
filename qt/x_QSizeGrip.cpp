...
public:
	...
	x_QSizeGrip* xret = new x_QSizeGrip((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	...
	// QSizeGrip(QWidget*)
	x_QSizeGrip* xret = new x_QSizeGrip((QWidget*)x[1].s_voidp);
	x[0].s_class = (void*)xret;
    }
	...
	this->QSizeGrip::paintEvent((QPaintEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_4(Smoke::Stack x) {
	// mousePressEvent(QMouseEvent*)
	this->QSizeGrip::mousePressEvent((QMouseEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_5(Smoke::Stack x) {
	// mouseMoveEvent(QMouseEvent*)
	this->QSizeGrip::mouseMoveEvent((QMouseEvent*)x[1].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_6(Smoke::Stack x) {
	// eventFilter(QObject*, QEvent*)
	bool xret = this->QSizeGrip::eventFilter((QObject*)x[1].s_voidp,(QEvent*)x[2].s_voidp);
	x[0].s_bool = xret;
    }
	...
	x[1].s_voidp = (void*)x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->callMethod(6890, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(6889, (void*)this, x)) return;
	this->QSizeGrip::mouseMoveEvent(x1);
    }
    virtual void mousePressEvent(QMouseEvent* x1) {
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(6888, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->callMethod(6887, (void*)this, x)) return;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(6886, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
