...
public:
	...
	x[1].s_voidp = (void*)&x1;
	x[2].s_voidp = (void*)&x2;
	if(qt_Smoke->binding->callMethod(11322, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11320, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(11321, (void*)this, x)) return (const char*)x[0].s_class;
    ...
    ~x_QTsciiCodec() { qt_Smoke->binding->deleted(345, (void*)this); }
};
