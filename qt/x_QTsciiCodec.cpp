...
public:
	...
	QCString xret = this->QTsciiCodec::fromUnicode(*(const QString *)x[1].s_class,*(int *)x[2].s_class);
	x[0].s_class = (void*)new QCString(xret);
    }
    void x_3(Smoke::Stack x) const {
	// toUnicode(const char*, int)
	QString xret = this->QTsciiCodec::toUnicode((const char*)x[1].s_class,(int)x[2].s_int);
	x[0].s_class = (void*)new QString(xret);
    }
    void x_4(Smoke::Stack x) const {
	// heuristicContentMatch(const char*, int)
	int xret = this->QTsciiCodec::heuristicContentMatch((const char*)x[1].s_class,(int)x[2].s_int);
	x[0].s_int = (int)xret;
    }
    void x_5(Smoke::Stack x) const {
	// heuristicNameMatch(const char*)
	int xret = this->QTsciiCodec::heuristicNameMatch((const char*)x[1].s_class);
	x[0].s_int = (int)xret;
    }
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)&x2;
	if(qt_Smoke->callMethod(9118, (void*)this, x)) {
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(9120, (void*)this, x)) return (int)x[0].s_int;
	return this->QTsciiCodec::heuristicContentMatch(x1, x2);
    }
    virtual int heuristicNameMatch(const char* x1) const {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)x1;
	if(qt_Smoke->callMethod(9121, (void*)this, x)) return (int)x[0].s_int;
	return this->QTsciiCodec::heuristicNameMatch(x1);
    }
    virtual QTextDecoder* makeDecoder() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(8528, (void*)this, x)) return (QTextDecoder*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9116, (void*)this, x)) return (int)x[0].s_int;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9117, (void*)this, x)) return (const char*)x[0].s_class;
	...
	x[1].s_class = (void*)x1;
	x[2].s_int = (int)x2;
	if(qt_Smoke->callMethod(9119, (void*)this, x)) {
...
void xcall_QTsciiCodec(Smoke::Index xi, void *obj, Smoke::Stack args) {
	...
	case 7: delete (QTsciiCodec*)xself;	break;
    }
}
