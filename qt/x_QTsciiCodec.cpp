...
public:
	...
	QCString xret = xthis->QTsciiCodec::fromUnicode(*(const QString *)x[1].s_voidp,*(int *)x[2].s_voidp);
	x[0].s_voidp = (void*)new QCString(xret);
    }
    void x_3(Smoke::Stack x) const {
	// toUnicode(const char*, int)
	QString xret = xthis->QTsciiCodec::toUnicode((const char*)x[1].s_voidp,(int)x[2].s_int);
	x[0].s_voidp = (void*)new QString(xret);
    }
    void x_4(Smoke::Stack x) const {
	// heuristicContentMatch(const char*, int)
	int xret = xthis->QTsciiCodec::heuristicContentMatch((const char*)x[1].s_voidp,(int)x[2].s_int);
	x[0].s_int = (int)xret;
    }
    void x_5(Smoke::Stack x) const {
	// heuristicNameMatch(const char*)
	int xret = xthis->QTsciiCodec::heuristicNameMatch((const char*)x[1].s_voidp);
	x[0].s_int = (int)xret;
    }
    ~x_QTsciiCodec() {}
};
