...
public:
	...
	x_QHButtonGroup* xret = new x_QHButtonGroup((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	...
	x_QHButtonGroup* xret = new x_QHButtonGroup((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHButtonGroup* xret = new x_QHButtonGroup(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHButtonGroup* xret = new x_QHButtonGroup(*(const QString *)x[1].x_voidp,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHButtonGroup* xret = new x_QHButtonGroup(*(const QString *)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
...
void xcall_QHButtonGroup(xargs *x, void *s, int xi) {
    x_QHButtonGroup *xself = (x_QHButtonGroup*)s;
    switch(xi) {
	case 0: x_QHButtonGroup::x_0(x);	break;
	case 1: x_QHButtonGroup::x_1(x);	break;
	case 2: x_QHButtonGroup::x_2(x);	break;
	case 3: x_QHButtonGroup::x_3(x);	break;
	case 4: x_QHButtonGroup::x_4(x);	break;
	case 5: x_QHButtonGroup::x_5(x);	break;
