...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9107, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(9111, (void*)this, x)) return;
	this->QSqlField::setReadOnly(x1);
    }
    virtual void setValue(const QVariant& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9105, (void*)this, x)) return;
	this->QSqlField::setValue(x1);
    }
    virtual QVariant value() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9106, (void*)this, x)) {
