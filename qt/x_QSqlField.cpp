...
public:
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9110, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_bool = x1;
	if(qt_Smoke->binding->callMethod(9114, (void*)this, x)) return;
	this->QSqlField::setReadOnly(x1);
    }
    virtual void setValue(const QVariant& x1) {
	Smoke::StackItem x[2];
	x[1].s_class = (void*)&x1;
	if(qt_Smoke->binding->callMethod(9108, (void*)this, x)) return;
	this->QSqlField::setValue(x1);
    }
    virtual QVariant value() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(9109, (void*)this, x)) {
    ...
    ~x_QSqlField() { qt_Smoke->binding->deleted(285, (void*)this); }
};
