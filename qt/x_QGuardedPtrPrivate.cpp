...
public:
	...
	x_QGuardedPtrPrivate* xret = new x_QGuardedPtrPrivate((QObject*)x[1].x_voidp);
    ...
    void x_2(xargs *x) {
	// reconnect(QObject*)
	this->QGuardedPtrPrivate::reconnect((QObject*)x[1].x_voidp);
    }
...
void xcall_QGuardedPtrPrivate(xargs *x, void *s, int xi) {
    x_QGuardedPtrPrivate *xself = (x_QGuardedPtrPrivate*)s;
    switch(xi) {
	case 0: x_QGuardedPtrPrivate::x_0(x);	break;
