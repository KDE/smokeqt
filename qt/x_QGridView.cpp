...
public:
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3919, (void*)this, x)) return (const char*)x[0].s_class;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->binding->callMethod(3918, (void*)this, x)) return (QMetaObject*)x[0].s_class;
	...
	x[2].s_int = x2;
	x[3].s_int = x3;
	qt_Smoke->binding->callMethod(3952, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	x[4].s_int = x4;
	x[5].s_int = x5;
	if(qt_Smoke->binding->callMethod(3953, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)x1;
	if(qt_Smoke->binding->callMethod(3920, (void*)this, x)) return (void*)x[0].s_voidp;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(3922, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[1].s_int = x1;
	x[2].s_voidp = (void*)x2;
	if(qt_Smoke->binding->callMethod(3921, (void*)this, x)) return (bool)x[0].s_bool;
	...
	x[2].s_int = x2;
	x[3].s_class = (void*)x3;
	if(qt_Smoke->binding->callMethod(3923, (void*)this, x)) return (bool)x[0].s_bool;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3937, (void*)this, x)) return;
	this->QGridView::setCellHeight(x1);
    }
    virtual void setCellWidth(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3935, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3933, (void*)this, x)) return;
    ...
    ~x_QGridView() { qt_Smoke->binding->deleted(137, (void*)this); }
};
