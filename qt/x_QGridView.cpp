...
public:
	...
	x_QGridView* xret = new x_QGridView((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,*(Qt::WFlags *)x[3].s_voidp);
	...
	x_QGridView* xret = new x_QGridView((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	// QGridView(QWidget*)
	x_QGridView* xret = new x_QGridView((QWidget*)x[1].s_voidp);
	x[0].s_voidp = (void*)xret;
    }
	...
	this->QGridView::paintCell((QPainter*)x[1].s_voidp,(int)x[2].s_int,(int)x[3].s_int);
    }
    void x_22(Smoke::Stack x) {
	// paintEmptyArea(QPainter*, int, int, int, int)
	this->QGridView::paintEmptyArea((QPainter*)x[1].s_voidp,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,(int)x[5].s_int);
    }
    void x_23(Smoke::Stack x) {
	// drawContents(QPainter*, int, int, int, int)
	this->QGridView::drawContents((QPainter*)x[1].s_voidp,(int)x[2].s_int,(int)x[3].s_int,(int)x[4].s_int,(int)x[5].s_int);
    }
	...
	x[4].s_int = (int)x4;
	x[5].s_int = (int)x5;
	if(call_method((void*)this, 3181, x)) return;
	...
	x[2].s_int = (int)x2;
	x[3].s_int = (int)x3;
	call_method_abstract((void*)this, 3179, x);
	return;
	// ABSTRACT
    }
	...
	x[4].s_int = (int)x4;
	x[5].s_int = (int)x5;
	if(call_method((void*)this, 3180, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = (int)x1;
	if(call_method((void*)this, 3163, x)) return;
