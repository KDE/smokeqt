...
public:
	...
	x[4].s_int = x4;
	x[5].s_int = x5;
	if(qt_Smoke->binding->callMethod(3934, (void*)this, x)) return;
	...
	x[2].s_int = x2;
	x[3].s_int = x3;
	qt_Smoke->binding->callMethod(3932, (void*)this, x, true /*pure virtual*/);
	return;
	// ABSTRACT
    }
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3917, (void*)this, x)) return;
	this->QGridView::setCellHeight(x1);
    }
    virtual void setCellWidth(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3915, (void*)this, x)) return;
	...
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3913, (void*)this, x)) return;
	this->QGridView::setNumCols(x1);
    }
    virtual void setNumRows(int x1) {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->binding->callMethod(3911, (void*)this, x)) return;
