...
public:
	...
	x_QHBox* xret = new x_QHBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp,*(Qt::WFlags *)x[3].x_voidp);
	...
	x_QHBox* xret = new x_QHBox((QWidget*)x[1].x_voidp,(const char*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QHBox(QWidget*)
	x_QHBox* xret = new x_QHBox((QWidget*)x[1].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
    ...
    void x_4(xargs *x) {
	// setSpacing(int)
	this->QHBox::setSpacing((int)x[1].x_int);
    }
    void x_5(xargs *x) {
	// setStretchFactor(QWidget*, int)
	bool xret = this->QHBox::setStretchFactor((QWidget*)x[1].x_voidp,(int)x[2].x_int);
	...
	x_QHBox* xret = new x_QHBox((bool)x[1].x_bool,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp,*(Qt::WFlags *)x[4].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	x_QHBox* xret = new x_QHBox((bool)x[1].x_bool,(QWidget*)x[2].x_voidp,(const char*)x[3].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QHBox(bool, QWidget*)
	x_QHBox* xret = new x_QHBox((bool)x[1].x_bool,(QWidget*)x[2].x_voidp);
	x[0].x_voidp = (void*)xret;
    }
	...
	// QHBox(bool)
	x_QHBox* xret = new x_QHBox((bool)x[1].x_bool);
	x[0].x_voidp = (void*)xret;
    }
	...
	xargs x[1];
	if(call_method((void*)this, 3233, x)) return;
	this->QHBox::frameChanged();
    }
	...
	xargs x[1];
	if(call_method((void*)this, 3228, x)) {
	    QSize *xptr = (QSize *)x[0].x_voidp;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
...
void xcall_QHBox(xargs *x, void *s, int xi) {
    x_QHBox *xself = (x_QHBox*)s;
    switch(xi) {
	case 0: x_QHBox::x_0(x);	break;
	case 1: x_QHBox::x_1(x);	break;
	case 2: x_QHBox::x_2(x);	break;
	case 3: x_QHBox::x_3(x);	break;
	case 4: xself->x_4(x);	break;
	case 5: xself->x_5(x);	break;
	case 6: xself->x_6(x);	break;
	case 7: x_QHBox::x_7(x);	break;
	case 8: x_QHBox::x_8(x);	break;
	case 9: x_QHBox::x_9(x);	break;
	case 10: x_QHBox::x_10(x);	break;
