...
public:
	...
	x_QHBox* xret = new x_QHBox((QWidget*)x[1].s_voidp,(const char*)x[2].s_voidp,(Qt::WFlags)x[3].s_int);
	...
	x_QHBox* xret = new x_QHBox((bool)x[1].s_bool,(QWidget*)x[2].s_voidp,(const char*)x[3].s_voidp,(Qt::WFlags)x[4].s_int);
	x[0].s_class = (void*)xret;
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3222, (void*)this, x)) return;
	this->QHBox::frameChanged();
    }
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(3217, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
