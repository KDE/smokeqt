...
public:
	...
	// QWidgetItem(QWidget*)
	x_QWidgetItem* xret = new x_QWidgetItem((QWidget*)x[1].s_voidp);
	...
	this->QWidgetItem::setGeometry(*(const QRect *)x[1].s_voidp);
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9839, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9842, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9844, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QWidgetItem::hasHeightForWidth();
    }
    virtual int heightForWidth(int x1) const {
	Smoke::StackItem x[2];
	x[1].s_int = x1;
	if(qt_Smoke->callMethod(9845, (void*)this, x)) return (int)x[0].s_int;
	return this->QWidgetItem::heightForWidth(x1);
    }
    virtual void invalidate() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4118, (void*)this, x)) return;
	this->QLayoutItem::invalidate();
    }
    virtual bool isEmpty() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9840, (void*)this, x)) return (bool)x[0].s_bool;
	return this->QWidgetItem::isEmpty();
    }
    virtual QLayoutIterator iterator() {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4120, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(4121, (void*)this, x)) return (QLayout*)x[0].s_class;
	return this->QLayoutItem::layout();
    }
    virtual QSize maximumSize() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9838, (void*)this, x)) {
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9837, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[2];
	x[1].s_voidp = (void*)&x1;
	if(qt_Smoke->callMethod(9841, (void*)this, x)) return;
	this->QWidgetItem::setGeometry(x1);
    }
    virtual QSize sizeHint() const {
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9836, (void*)this, x)) {
	    QSize *xptr = (QSize *)x[0].s_class;
	    QSize xret(*xptr);
	    delete xptr;
	    return xret;
	...
	Smoke::StackItem x[1];
	if(qt_Smoke->callMethod(9843, (void*)this, x)) return (QWidget*)x[0].s_class;
