...
public:
	...
	x[8].s_class = (void*)&x8;
	x[9].s_class = (void*)&x9;
	if(qt_Smoke->callMethod(5975, (void*)this, x)) return;
	...
	x[6].s_class = (void*)&x6;
	x[7].s_class = (void*)&x7;
	if(qt_Smoke->callMethod(5972, (void*)this, x)) return;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->callMethod(5982, (void*)this, x)) return (int)x[0].s_int;
	...
	x[3].s_class = (void*)&x3;
	x[4].s_class = (void*)&x4;
	if(qt_Smoke->callMethod(5980, (void*)this, x)) {
	    QRect *xptr = (QRect *)x[0].s_class;
	    QRect xret(*xptr);
	    delete xptr;
	    return xret;
	...
	x[1].s_class = (void*)&x1;
	x[2].s_class = (void*)x2;
	if(qt_Smoke->callMethod(5984, (void*)this, x)) {
	    QRect *xptr = (QRect *)x[0].s_class;
	    QRect xret(*xptr);
	    delete xptr;
	    return xret;
