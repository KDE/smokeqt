...
public:
	...
	this->QPlatinumStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].s_enum,(QPainter*)x[2].s_voidp,*(const QRect *)x[3].s_voidp,*(const QColorGroup *)x[4].s_voidp,(QStyle::SFlags)x[5].s_int,*(const QStyleOption *)x[6].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_2(Smoke::Stack x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QPlatinumStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].s_enum,(QPainter*)x[2].s_voidp,*(const QRect *)x[3].s_voidp,*(const QColorGroup *)x[4].s_voidp,(QStyle::SFlags)x[5].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_3(Smoke::Stack x) const {
	// drawPrimitive(QStyle::PrimitiveElement, QPainter*, const QRect&, const QColorGroup&)
	this->QPlatinumStyle::drawPrimitive((QStyle::PrimitiveElement)x[1].s_enum,(QPainter*)x[2].s_voidp,*(const QRect *)x[3].s_voidp,*(const QColorGroup *)x[4].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QPlatinumStyle::drawControl((QStyle::ControlElement)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,*(const QStyleOption *)x[7].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_5(Smoke::Stack x) const {
	// drawControl(QStyle::ControlElement, QPainter*, const QWidget*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QPlatinumStyle::drawControl((QStyle::ControlElement)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_6(Smoke::Stack x) const {
	// drawControl(QStyle::ControlElement, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QPlatinumStyle::drawControl((QStyle::ControlElement)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QPlatinumStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,(QStyle::SCFlags)x[7].s_int,(QStyle::SCFlags)x[8].s_int,*(const QStyleOption *)x[9].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QPlatinumStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,(QStyle::SCFlags)x[7].s_int,(QStyle::SCFlags)x[8].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
	...
	this->QPlatinumStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int,(QStyle::SCFlags)x[7].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_10(Smoke::Stack x) const {
	// drawComplexControl(QStyle::ComplexControl, QPainter*, const QWidget*, const QRect&, const QColorGroup&, QStyle::SFlags)
	this->QPlatinumStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp,(QStyle::SFlags)x[6].s_int);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_11(Smoke::Stack x) const {
	// drawComplexControl(QStyle::ComplexControl, QPainter*, const QWidget*, const QRect&, const QColorGroup&)
	this->QPlatinumStyle::drawComplexControl((QStyle::ComplexControl)x[1].s_enum,(QPainter*)x[2].s_voidp,(const QWidget*)x[3].s_voidp,*(const QRect *)x[4].s_voidp,*(const QColorGroup *)x[5].s_voidp);
	(void)x[0].s_int; // noop (for compiler warning)
    }
    void x_12(Smoke::Stack x) const {
	// querySubControlMetrics(QStyle::ComplexControl, const QWidget*, QStyle::SubControl, const QStyleOption&)
	QRect xret = this->QPlatinumStyle::querySubControlMetrics((QStyle::ComplexControl)x[1].s_enum,(const QWidget*)x[2].s_voidp,(QStyle::SubControl)x[3].s_enum,*(const QStyleOption *)x[4].s_voidp);
	x[0].s_class = (void*)new QRect(xret);
    }
    void x_13(Smoke::Stack x) const {
	// querySubControlMetrics(QStyle::ComplexControl, const QWidget*, QStyle::SubControl)
	QRect xret = this->QPlatinumStyle::querySubControlMetrics((QStyle::ComplexControl)x[1].s_enum,(const QWidget*)x[2].s_voidp,(QStyle::SubControl)x[3].s_enum);
	x[0].s_class = (void*)new QRect(xret);
    }
    void x_14(Smoke::Stack x) const {
	// pixelMetric(QStyle::PixelMetric, const QWidget*)
	int xret = this->QPlatinumStyle::pixelMetric((QStyle::PixelMetric)x[1].s_enum,(const QWidget*)x[2].s_voidp);
	x[0].s_int = xret;
    }
	...
	QRect xret = this->QPlatinumStyle::subRect((QStyle::SubRect)x[1].s_enum,(const QWidget*)x[2].s_voidp);
	x[0].s_class = (void*)new QRect(xret);
    }
