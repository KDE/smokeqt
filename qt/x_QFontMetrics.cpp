...
public:
	...
	// inFont(QChar)
	bool xret = this->QFontMetrics::inFont(*(QChar *)x[1].s_voidp);
	x[0].s_bool = (bool)xret;
    }
    void x_12(Smoke::Stack x) const {
	// leftBearing(QChar)
	int xret = this->QFontMetrics::leftBearing(*(QChar *)x[1].s_voidp);
	x[0].s_int = (int)xret;
    }
    void x_13(Smoke::Stack x) const {
	// rightBearing(QChar)
	int xret = this->QFontMetrics::rightBearing(*(QChar *)x[1].s_voidp);
	x[0].s_int = (int)xret;
    }
	...
	// width(QChar)
	int xret = this->QFontMetrics::width(*(QChar *)x[1].s_voidp);
	x[0].s_int = (int)xret;
    }
	...
	// boundingRect(QChar)
	QRect xret = this->QFontMetrics::boundingRect(*(QChar *)x[1].s_voidp);
	x[0].s_voidp = (void*)new QRect(xret);
    }
