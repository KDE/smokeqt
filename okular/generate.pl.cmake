...
my $okularheaderlist = "@CMAKE_CURRENT_SOURCE_DIR@/okular_header_list";
my $okularheaderlistpath = "$here/$kdeheaderlist";
...
$okularheaderlistpath = $okularheaderlist if $okularheaderlist =~ /^\//;
...
open(HEADERS, $okularheaderlistpath) or die "Couldn't open $okularheaderlistpath: $!\n";
map { chomp ; $kdeincludes{$_} = 1 unless /^\s*#/ } <HEADERS>;
close HEADERS;
...
# Launch kalyptus
chdir "../smoke/kde";
system "perl -I@kdebindings_SOURCE_DIR@/kalyptus @kdebindings_SOURCE_DIR@/kalyptus/kalyptus @ARGV --qt4 --globspace -fsmoke --name=okular --init-modules=qt,kde --classlist=@CMAKE_CURRENT_SOURCE_DIR@/classlist $macros --no-cache --outputdir=$outdir @headers @kdeheaders";
my $exit = $? >> 8;
exit $exit if ($exit);
chdir "$kalyptusdir";
