...
my $soprano_headerlist = "";
my $soprano_headerlistpath = "";

$soprano_headerlist = "@CMAKE_CURRENT_SOURCE_DIR@/soprano_header_list";
$soprano_headerlistpath = "$here/$soprano_headerlist";

## If srcdir != builddir, use headerlist from src
$headerlistpath = $headerlist if ($headerlist =~ /^\//);
$soprano_headerlistpath = $soprano_headerlist if ($soprano_headerlist =~ /^\//);
...
# Launch kalyptus
chdir "../smoke/soprano";
system "perl -I@kdebindings_SOURCE_DIR@/kalyptus @kdebindings_SOURCE_DIR@/kalyptus/kalyptus @ARGV --qt4 --globspace -fsmoke --name=soprano --classlist='@CMAKE_CURRENT_SOURCE_DIR@/classlist' --init-modules=qt $macros --no-cache --outputdir=$outdir @headers @sopranoheaders";
my $exit = $? >> 8;
exit $exit if ($exit);
chdir "$kalyptusdir";
